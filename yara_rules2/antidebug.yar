...
rule DebuggerCheck__PEB : AntiDebug DebuggerCheck {
	meta:
		...
		description = "AntiDebug DebuggerCheck__PEB"
		tag = "attack.defense_evasion"
	strings:
		$ ="IsDebugged"
	condition:
		check_antidebug_bool and any of them
}
...
rule DebuggerCheck__GlobalFlags : AntiDebug DebuggerCheck {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerCheck__GlobalFlags"
		tag = "attack.defense_evasion"
	strings:
		$ ="NtGlobalFlags"
	condition:
...
rule DebuggerCheck__QueryInfo : AntiDebug DebuggerCheck {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerCheck__QueryInfo"
		tag = "attack.defense_evasion"
	strings:
...
rule DebuggerCheck__RemoteAPI : AntiDebug DebuggerCheck {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerCheck__RemoteAPI"
		tag = "attack.defense_evasion"
	strings:
...
rule DebuggerHiding__Thread : AntiDebug DebuggerHiding {
	meta:
		...
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		weight = 1
		description = "AntiDebug DebuggerHiding__Thread"
		tag = "attack.defense_evasion"
	strings:
...
rule DebuggerHiding__Active : AntiDebug DebuggerHiding {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerHiding__Active"
		tag = "attack.defense_evasion"
	strings:
		$ ="DebugActiveProcess"
	condition:
...
rule DebuggerTiming__PerformanceCounter : AntiDebug DebuggerTiming {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerTiming__PerformanceCounter"
		tag = "attack.defense_evasion"
	strings:
...
rule DebuggerTiming__Ticks : AntiDebug DebuggerTiming {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerTiming__Ticks"
		tag = "attack.defense_evasion"
	strings:
		$ ="GetTickCount"
	condition:
...
rule DebuggerOutput__String : AntiDebug DebuggerOutput {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerOutput__String"
		tag = "attack.defense_evasion"
	strings:
		$ ="OutputDebugString"
	condition:
...
rule DebuggerException__UnhandledFilter : AntiDebug DebuggerException {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerException__UnhandledFilter"
		tag = "attack.defense_evasion"
	strings:
...
rule DebuggerException__ConsoleCtrl : AntiDebug DebuggerException {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerException__ConsoleCtrl"
		tag = "attack.defense_evasion"
	strings:
...
rule DebuggerException__SetConsoleCtrl : AntiDebug DebuggerException {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerException__SetConsoleCtrl"
		tag = "attack.defense_evasion"
	strings:
...
rule ThreadControl__Context : AntiDebug ThreadControl {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug ThreadControl__Context"
		tag = "attack.defense_evasion"
	strings:
		$ ="SetThreadContext"
	condition:
...
rule DebuggerCheck__DrWatson : AntiDebug DebuggerCheck {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerCheck__DrWatson"
		tag = "attack.defense_evasion"
	strings:
		$ ="__invoke__watson"
	condition:
...
rule SEH__vba : AntiDebug SEH {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug SEH__vba"
		tag = "attack.defense_evasion"
	strings:
		$ = "vbaExceptHandler"
	condition:
...
rule SEH__vectored : AntiDebug SEH {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug SEH__vectored"
		tag = "attack.defense_evasion"
	strings:
...
rule DebuggerPattern__RDTSC : AntiDebug DebuggerPattern {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerPattern__RDTSC"
		tag = "attack.defense_evasion"
	strings:
		$ = {0F 31}
	condition:
...
rule DebuggerPattern__CPUID : AntiDebug DebuggerPattern {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerPattern__CPUID"
		tag = "attack.defense_evasion"
	strings:
		$ = {0F A2}
	condition:
...
rule DebuggerPattern__SEH_Saves : AntiDebug DebuggerPattern {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerPattern__SEH_Saves"
		tag = "attack.defense_evasion"
	strings:
...
rule DebuggerPattern__SEH_Inits : AntiDebug DebuggerPattern {
	meta:
		...
		Author = "naxonez"
		reference = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug DebuggerPattern__SEH_Inits"
		tag = "attack.defense_evasion"
	strings:
...
rule SEH_Save : Tactic_DefensiveEvasion Technique_AntiDebugging SubTechnique_SEH
{
    meta:
		...
		description = "AntiDebug SEH_Save"
		weight = 1
		tag = "attack.defense_evasion"
    strings:
        $a = { 64 ff 35 00 00 00 00 }
    condition:
		check_antidebug_bool and $a
}
...
rule SEH_Init : Tactic_DefensiveEvasion Technique_AntiDebugging SubTechnique_SEH
{
    meta:
        ...
        original_author = "naxonez"
        source = "https://github.com/naxonez/yaraRules/blob/master/AntiDebugging.yara"
		description = "AntiDebug SEH_Init"
		weight = 1
		tag = "attack.defense_evasion"
    strings:
        $a = { 64 A3 00 00 00 00 }
    ...
    condition:
		check_antidebug_bool and ($a or $b)
}
...
rule Check_Dlls
{
	...
	condition:
		check_antidebug_bool and 2 of them
}
...
rule Check_Qemu_description
{
	...
	condition:
		check_antidebug_bool and all of them
}
...
rule Check_Debugger
{
	meta:
		...
		weight = 1
	condition:
		check_antidebug_bool and pe.imports("kernel32.dll","CheckRemoteDebuggerPresent") and
...
rule Check_DriveSize
{
	...
	condition:
		check_antidebug_bool and pe.imports("kernel32.dll","CreateFileA") and
...
rule Check_FilePaths
{
	...
	condition:
		check_antidebug_bool and all of ($path*) and pe.imports("kernel32.dll","GetModuleFileNameA")
}
...
rule Check_UserNames
{
	...
	condition:
		check_antidebug_bool and all of ($user*)  and pe.imports("advapi32.dll","GetUserNameA")
}
...
rule Check_OutputDebugStringA_iat
{
	...
	meta:
		...
		weight = 1
	condition:
		check_antidebug_bool and pe.imports("kernel32.dll","OutputDebugStringA")
}
...
rule Check_unhandledExceptionFiler_iat {
	...
	meta:
		...
		weight = 1
	condition:
		check_antidebug_bool and pe.imports("kernel32.dll","UnhandledExceptionFilter")
}
*/
...
rule check_RaiseException_iat {
	...
	meta:
		...
		weight = 1
	condition:
		check_antidebug_bool and pe.imports("kernel32.dll","RaiseException")
}
*/
...
rule Check_FindWindowA_iat {
	...
	condition:
		check_antidebug_bool and pe.imports("user32.dll","FindWindowA") and ($ollydbg or $windbg)
}
...
rule DebuggerCheck__MemoryWorkingSet : AntiDebug DebuggerCheck {
	meta:
		...
		weight = 1
	condition:
		check_antidebug_bool and pe.imports("kernel32.dll", "K32GetProcessMemoryInfo") and
...
rule WMI_VM_Detect : WMI_VM_Detect
{
	...
	condition:
		check_antidebug_bool and any of ($selstr*) and any of ($vm*)
...
rule anti_dbg {
    ...
    condition:
		check_antidebug_bool and $d1 and 1 of ($c*)
}
...
rule antisb_anubis {
    ...
    condition:
		check_antidebug_bool and $p1 and $c1 and 1 of ($s*)
}
...
rule antivm_bios {
    ...
    condition:
		check_antidebug_bool and 1 of ($p*) and 1 of ($c*) and 1 of ($r*)
}
...
rule disable_antivirus {
    ...
    condition:
		check_antidebug_bool and ($c1 and $p1 and 1 of ($f*)) or ($c1 and $p2) or 1 of ($r*) or $p3
}
...
rule disable_firewall {
    ...
    condition:
		check_antidebug_bool and (1 of ($p*) and $c1 and 1 of ($r*)) or $s1
}
...
rule disable_registry {
    ...
    strings:
        ...
        $r2 = "DisableRegedit"
    condition:
		check_antidebug_bool and 1 of ($p*) and $c1 and 1 of ($r*)
}
...
rule disable_taskmanager {
    ...
    strings:
        ...
        $r1 = "DisableTaskMgr"
    condition:
		check_antidebug_bool and 1 of ($p*) and 1 of ($r*)
}
...
rule win_hook {
    ...
    strings:
        ...
        $c3 = "CallNextHookEx"
    condition:
		check_antidebug_bool and $f1 and 1 of ($c*)
}
