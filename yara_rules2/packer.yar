...
rule emotet_packer {
   meta:
    ...
    condition:
		check_packer_bool and $pdb1 or $pdb2
}
...
rule silent_banker : banker
{
      meta:
		author="malware-lu"
		description = "Packer silent_banker"
		weight = 4
    strings:
    ...
    condition:
		check_packer_bool and $a or $b or $c
}
...
rule zbot : banker
{
     ...
     condition:
		check_packer_bool and ($a and $b) or ($c and $d and $e)
}
...
rule banbra : banker
{
    ...
    strings:
     ...
     condition:
		check_packer_bool and #a > 3 and #b > 3 and #c > 3 and #d > 3 and #e > 3
}
...
rule Borland
{
      meta:
		author="malware-lu"
		description = "Packer Borland"
		weight = 4
	strings:
		$patternBorland = "Borland" wide ascii
	condition:
		check_packer_bool and $patternBorland
}
...
rule java
{
      meta:
		author="malware-lu"
		description = "Packer java"
		weight = 4
	strings:
		$patternjava = "java" wide ascii
	condition:
		check_packer_bool and $patternjava
}
*/
rule MSLRHv032afakePCGuard4xxemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePCGuard4xxemadicius"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point
}
...
rule EnigmaProtector1XSukhovVladimirSergeNMarkin
{
      meta:
		author="malware-lu"
		description = "Packer EnigmaProtector1XSukhovVladimirSergeNMarkin"
		weight = 4
strings:
...
rule SPLayerv008
{
      meta:
		author="malware-lu"
		description = "Packer SPLayerv008"
		weight = 4
strings:
...
rule DxPackV086Dxd
{
      meta:
		author="malware-lu"
		description = "Packer DxPackV086Dxd"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMicrosoftVisualC60
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMicrosoftVisualC60"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point or $a1 at pe.entry_point or $a2 at pe.entry_point or $a3 at pe.entry_point or $a4 at pe.entry_point or $a5 at pe.entry_point or $a6 at pe.entry_point or $a7 at pe.entry_point or $a8 at pe.entry_point or $a9 at pe.entry_point
}
...
rule TPPpackclane
{
      meta:
		author="malware-lu"
		description = "Packer TPPpackclane"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMicrosoftVisualC6070
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMicrosoftVisualC6070"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point or $a1 at pe.entry_point or $a2 at pe.entry_point or $a3 at pe.entry_point or $a4 at pe.entry_point
}
...
rule Thinstall24x25xJititSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Thinstall24x25xJititSoftware"
		weight = 4
strings:
...
rule LocklessIntroPack
{
      meta:
		author="malware-lu"
		description = "Packer LocklessIntroPack"
		weight = 4
strings:
...
rule AHTeamEPProtector03faketElock061FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03faketElock061FEUERRADER"
		weight = 4
strings:
...
rule ExeStealth275aWebtoolMaster
{
      meta:
		author="malware-lu"
		description = "Packer ExeStealth275aWebtoolMaster"
		weight = 4
strings:
...
rule PEArmor046Hying
{
      meta:
		author="malware-lu"
		description = "Packer PEArmor046Hying"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point or $a1 at pe.entry_point
}
...
rule eXPressorv13CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressorv13CGSoftLabs"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 or $a1 at pe.entry_point
}
...
rule Upackv032BetaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv032BetaDwing"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 or $a1
}
...
rule MSLRHV031emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHV031emadicius"
		weight = 4
strings:
...
rule PECompactv184
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv184"
		weight = 4
strings:
...
rule PCGuardforWin32v500SofProBlagojeCeklic
{
      meta:
		author="malware-lu"
		description = "Packer PCGuardforWin32v500SofProBlagojeCeklic"
		weight = 4
strings:
...
rule WiseInstallerStub
{
      meta:
		author="malware-lu"
		description = "Packer WiseInstallerStub"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point or $a1 at pe.entry_point or $a2
}
...
rule AnskyaNTPackerGeneratorAnskya
{
      meta:
		author="malware-lu"
		description = "Packer AnskyaNTPackerGeneratorAnskya"
		weight = 4
strings:
...
rule ThinstallVirtualizationSuite30493080ThinstallCompany
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallVirtualizationSuite30493080ThinstallCompany"
		weight = 4
strings:
...
rule NsPack14byNorthStarLiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPack14byNorthStarLiuXingPing"
		weight = 4
strings:
...
rule FSGv110EngbartxtWatcomCCEXE
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngbartxtWatcomCCEXE"
		weight = 4
strings:
...
rule eXPressorv1451CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressorv1451CGSoftLabs"
		weight = 4
strings:
...
rule BeRoEXEPackerv100LZMABeRoFarbrausch
{
      meta:
		author="malware-lu"
		description = "Packer BeRoEXEPackerv100LZMABeRoFarbrausch"
		weight = 4
strings:
...
rule PackanoidArkanoid
{
      meta:
		author="malware-lu"
		description = "Packer PackanoidArkanoid"
		weight = 4
strings:
...
rule DAEMONProtectv067
{
      meta:
		author="malware-lu"
		description = "Packer DAEMONProtectv067"
		weight = 4
strings:
...
rule EmbedPEV100V124cyclotron
{
      meta:
		author="malware-lu"
		description = "Packer EmbedPEV100V124cyclotron"
		weight = 4
strings:
...
rule VProtectorV10Avcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtectorV10Avcasm"
		weight = 4
strings:
...
rule EncryptPE2200481022005314WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPE2200481022005314WFS"
		weight = 4
strings:
...
rule PseudoSigner02JDPack1xJDProtect09Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02JDPack1xJDProtect09Anorganix"
		weight = 4
strings:
...
rule EmbedPEV1Xcyclotron
{
      meta:
		author="malware-lu"
		description = "Packer EmbedPEV1Xcyclotron"
		weight = 4
strings:
...
rule EncryptPEV220070411WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPEV220070411WFS"
		weight = 4
strings:
...
rule PseudoSigner01MicrosoftVisualBasic60DLLAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MicrosoftVisualBasic60DLLAnorganix"
		weight = 4
strings:
...
rule NsPack14Liuxingping
{
      meta:
		author="malware-lu"
		description = "Packer NsPack14Liuxingping"
		weight = 4
strings:
...
rule VxTrivial46
{
      meta:
		author="malware-lu"
		description = "Packer VxTrivial46"
		weight = 4
strings:
...
rule STUDRC410JamieEditionScanTimeUnDetectablebyMarjinZ
{
      meta:
		author="malware-lu"
		description = "Packer STUDRC410JamieEditionScanTimeUnDetectablebyMarjinZ"
		weight = 4
strings:
...
rule VxSonikYouth
{
      meta:
		author="malware-lu"
		description = "Packer VxSonikYouth"
		weight = 4
strings:
...
rule PseudoSigner01Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01Anorganix"
		weight = 4
strings:
...
rule SetupFactoryv6003SetupLauncher
{
      meta:
		author="malware-lu"
		description = "Packer SetupFactoryv6003SetupLauncher"
		weight = 4
strings:
...
rule CrypKeyV61XDLLCrypKeyCanadaInc
{
      meta:
		author="malware-lu"
		description = "Packer CrypKeyV61XDLLCrypKeyCanadaInc"
		weight = 4
strings:
...
rule VcAsmProtectorVcAsm
{
      meta:
		author="malware-lu"
		description = "Packer VcAsmProtectorVcAsm"
		weight = 4
strings:
...
rule PECompact2xxSlimLoaderBitSumTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer PECompact2xxSlimLoaderBitSumTechnologies"
		weight = 4
strings:
...
rule ENIGMAProtectorV11V12SukhovVladimir
{
      meta:
		author="malware-lu"
		description = "Packer ENIGMAProtectorV11V12SukhovVladimir"
		weight = 4
strings:
...
rule yodasProtectorv10bAshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtectorv10bAshkbizDanehkar"
		weight = 4
strings:
...
rule PEDiminisherv01
{
      meta:
		author="malware-lu"
		description = "Packer PEDiminisherv01"
		weight = 4
strings:
...
rule SOFTWrapperforWin9xNTEvaluationVersion
{
      meta:
		author="malware-lu"
		description = "Packer SOFTWrapperforWin9xNTEvaluationVersion"
		weight = 4
strings:
...
rule Armadillov200
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov200"
		weight = 4
strings:
...
rule Armadillov201
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov201"
		weight = 4
strings:
...
rule FreeJoinerSmallbuild014021024027GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoinerSmallbuild014021024027GlOFF"
		weight = 4
strings:
...
rule SDProtector1xRandyLi
{
      meta:
		author="malware-lu"
		description = "Packer SDProtector1xRandyLi"
		weight = 4
strings:
...
rule NSISInstallerNullSoft
{
      meta:
		author="malware-lu"
		description = "Packer NSISInstallerNullSoft"
		weight = 4
strings:
...
rule IMPPacker10MahdiHezavehiIMPOSTER
{
      meta:
		author="malware-lu"
		description = "Packer IMPPacker10MahdiHezavehiIMPOSTER"
		weight = 4
strings:
...
rule PEProtectv09
{
      meta:
		author="malware-lu"
		description = "Packer PEProtectv09"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point or $a1
}
...
rule nbuildv10soft
{
      meta:
		author="malware-lu"
		description = "Packer nbuildv10soft"
		weight = 4
strings:
...
rule PseudoSigner01StelthPE101Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01StelthPE101Anorganix"
		weight = 4
strings:
...
rule IProtect10FxSubdllmodebyFuXdas
{
      meta:
		author="malware-lu"
		description = "Packer IProtect10FxSubdllmodebyFuXdas"
		weight = 4
strings:
...
rule MSVisualCv8DLLhsmallsig2
{
      meta:
		author="malware-lu"
		description = "Packer MSVisualCv8DLLhsmallsig2"
		weight = 4
strings:
...
rule MSVisualCv8DLLhsmallsig1
{
      meta:
		author="malware-lu"
		description = "Packer MSVisualCv8DLLhsmallsig1"
		weight = 4
strings:
...
rule RCryptorv16xVaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv16xVaska"
		weight = 4
strings:
...
rule UPXv20MarkusLaszloReiser
{
      meta:
		author="malware-lu"
		description = "Packer UPXv20MarkusLaszloReiser"
		weight = 4
strings:
...
rule BladeJoinerv15
{
      meta:
		author="malware-lu"
		description = "Packer BladeJoinerv15"
		weight = 4
strings:
...
rule FSGv133Engdulekxt
{
      meta:
		author="malware-lu"
		description = "Packer FSGv133Engdulekxt"
		weight = 4
strings:
...
rule FSGv120EngdulekxtMicrosoftVisualC6070
{
      meta:
		author="malware-lu"
		description = "Packer FSGv120EngdulekxtMicrosoftVisualC6070"
		weight = 4
strings:
...
rule PECompactv200alpha38
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv200alpha38"
		weight = 4
strings:
...
rule RCryptor16cVaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptor16cVaska"
		weight = 4
strings:
...
rule TheGuardLibrary
{
      meta:
		author="malware-lu"
		description = "Packer TheGuardLibrary"
		weight = 4
strings:
...
rule FreeCryptor01build001GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeCryptor01build001GlOFF"
		weight = 4
strings:
...
rule PseudoSigner02BJFNT12Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02BJFNT12Anorganix"
		weight = 4
strings:
...
rule DingBoysPElockPhantasmv08
{
      meta:
		author="malware-lu"
		description = "Packer DingBoysPElockPhantasmv08"
		weight = 4
strings:
...
rule Thinstall2736Jitit
{
      meta:
		author="malware-lu"
		description = "Packer Thinstall2736Jitit"
		weight = 4
strings:
...
rule UnnamedScrambler11Cp0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler11Cp0ke"
		weight = 4
strings:
...
rule y0dasCrypterv1xModified
{
      meta:
		author="malware-lu"
		description = "Packer y0dasCrypterv1xModified"
		weight = 4
strings:
...
rule Armadillov252b2
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov252b2"
		weight = 4
strings:
...
rule Upackv036betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv036betaDwing"
		weight = 4
strings:
...
rule VxNecropolis
{
      meta:
		author="malware-lu"
		description = "Packer VxNecropolis"
		weight = 4
strings:
...
rule WinUpackv039finalrelocatedimagebaseByDwingc2005h2
{
      meta:
		author="malware-lu"
		description = "Packer WinUpackv039finalrelocatedimagebaseByDwingc2005h2"
		weight = 4
strings:
...
rule ASPackv1061bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv1061bAlexeySolodovnikov"
		weight = 4
strings:
...
rule Ningishzida10CyberDoom
{
      meta:
		author="malware-lu"
		description = "Packer Ningishzida10CyberDoom"
		weight = 4
strings:
...
rule ASProtectSKE21xdllAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectSKE21xdllAlexeySolodovnikov"
		weight = 4
strings:
...
rule PAVCryptorPawningAntiVirusCryptormasha_dev
{
      meta:
		author="malware-lu"
		description = "Packer PAVCryptorPawningAntiVirusCryptormasha_dev"
		weight = 4
strings:
...
rule ExeShieldCryptor13RCTomCommander
{
      meta:
		author="malware-lu"
		description = "Packer ExeShieldCryptor13RCTomCommander"
		weight = 4
strings:
...
rule CrinklerV01V02RuneLHStubbeandAskeSimonChristensen
{
      meta:
		author="malware-lu"
		description = "Packer CrinklerV01V02RuneLHStubbeandAskeSimonChristensen"
		weight = 4
strings:
...
rule VxGRUNT4Family
{
      meta:
		author="malware-lu"
		description = "Packer VxGRUNT4Family"
		weight = 4
strings:
...
rule nPackV112002006BetaNEOxuinC
{
      meta:
		author="malware-lu"
		description = "Packer nPackV112002006BetaNEOxuinC"
		weight = 4
strings:
...
rule VxEddie1800
{
      meta:
		author="malware-lu"
		description = "Packer VxEddie1800"
		weight = 4
strings:
...
rule EncryptPEV22006115WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPEV22006115WFS"
		weight = 4
strings:
...
rule PrincessSandyv10eMiNENCEProcessPatcherPatch
{
      meta:
		author="malware-lu"
		description = "Packer PrincessSandyv10eMiNENCEProcessPatcherPatch"
		weight = 4
strings:
...
rule NJoiner01AsmVersionNEX
{
      meta:
		author="malware-lu"
		description = "Packer NJoiner01AsmVersionNEX"
		weight = 4
strings:
...
rule Obsiduim1304ObsiduimSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsiduim1304ObsiduimSoftware"
		weight = 4
strings:
...
rule PseudoSigner02FSG131Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02FSG131Anorganix"
		weight = 4
strings:
...
rule PseudoSigner01CodeSafe20Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01CodeSafe20Anorganix"
		weight = 4
strings:
...
rule PseudoSigner01NorthStarPEShrinker13Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01NorthStarPEShrinker13Anorganix"
		weight = 4
strings:
...
rule ocBat2Exe10OC
{
      meta:
		author="malware-lu"
		description = "Packer ocBat2Exe10OC"
		weight = 4
strings:
...
rule ASDPack20asd
{
      meta:
		author="malware-lu"
		description = "Packer ASDPack20asd"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 or $a1 or $a2 at pe.entry_point
}
...
rule EXECryptor2021protectedIAT
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor2021protectedIAT"
		weight = 4
strings:
...
rule ShrinkWrapv14
{
      meta:
		author="malware-lu"
		description = "Packer ShrinkWrapv14"
		weight = 4
strings:
...
rule UnknownbySMT
{
      meta:
		author="malware-lu"
		description = "Packer UnknownbySMT"
		weight = 4
strings:
...
rule PseudoSigner01VOBProtectCD5Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01VOBProtectCD5Anorganix"
		weight = 4
strings:
...
rule SimplePack10Xbagie
{
      meta:
		author="malware-lu"
		description = "Packer SimplePack10Xbagie"
		weight = 4
strings:
...
rule ThemidaWinLicenseV18XV19XOreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer ThemidaWinLicenseV18XV19XOreansTechnologies"
		weight = 4
strings:
...
rule EXEjoinerAmok
{
      meta:
		author="malware-lu"
		description = "Packer EXEjoinerAmok"
		weight = 4
strings:
...
rule EmbedPEv124cyclotron
{
      meta:
		author="malware-lu"
		description = "Packer EmbedPEv124cyclotron"
		weight = 4
strings:
...
rule tElockv04xv05x
{
      meta:
		author="malware-lu"
		description = "Packer tElockv04xv05x"
		weight = 4
strings:
...
rule Armadillov301v305
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov301v305"
		weight = 4
strings:
...
rule DingBoysPElockv007
{
      meta:
		author="malware-lu"
		description = "Packer DingBoysPElockv007"
		weight = 4
strings:
...
rule mPack003DeltaAziz
{
      meta:
		author="malware-lu"
		description = "Packer mPack003DeltaAziz"
		weight = 4
strings:
...
rule SixtoFourv10
{
      meta:
		author="malware-lu"
		description = "Packer SixtoFourv10"
		weight = 4
strings:
...
rule FreeJoinerSmallbuild029GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoinerSmallbuild029GlOFF"
		weight = 4
strings:
...
rule ThemidaWinLicenseV1XNoCompressionSecureEngineOreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer ThemidaWinLicenseV1XNoCompressionSecureEngineOreansTechnologies"
		weight = 4
strings:
...
rule WinUpackv030betaByDwing
{
      meta:
		author="malware-lu"
		description = "Packer WinUpackv030betaByDwing"
		weight = 4
strings:
...
rule Armadillov260b2
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov260b2"
		weight = 4
strings:
...
rule Armadillov260b1
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov260b1"
		weight = 4
strings:
...
rule ExeLockerv10IonIce
{
      meta:
		author="malware-lu"
		description = "Packer ExeLockerv10IonIce"
		weight = 4
strings:
...
rule RLPackV10betaap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV10betaap0x"
		weight = 4
strings:
...
rule PellesC300400450EXEX86CRTDLL
{
      meta:
		author="malware-lu"
		description = "Packer PellesC300400450EXEX86CRTDLL"
		weight = 4
strings:
...
rule BeRoEXEPackerv100LZBRRBeRoFarbrausch
{
      meta:
		author="malware-lu"
		description = "Packer BeRoEXEPackerv100LZBRRBeRoFarbrausch"
		weight = 4
strings:
...
rule Armadillov190a
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov190a"
		weight = 4
strings:
...
rule WWPACKv305c4Modified
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4Modified"
		weight = 4
strings:
...
rule APatchGUIv11
{
      meta:
		author="malware-lu"
		description = "Packer APatchGUIv11"
		weight = 4
strings:
...
rule ExeSafeguardv10simonzh
{
      meta:
		author="malware-lu"
		description = "Packer ExeSafeguardv10simonzh"
		weight = 4
strings:
...
rule PseudoSigner01CDCopsIIAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01CDCopsIIAnorganix"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeVIRUSIWormHybrisFEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeVIRUSIWormHybrisFEUERRADER"
		weight = 4
strings:
...
rule Obsidium1322ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1322ObsidiumSoftware"
		weight = 4
strings:
...
rule PrivateEXEProtector20SetiSoft
{
      meta:
		author="malware-lu"
		description = "Packer PrivateEXEProtector20SetiSoft"
		weight = 4
strings:
...
rule NTkrnlSecureSuite01015DLLNTkrnlSoftware
{
      meta:
		author="malware-lu"
		description = "Packer NTkrnlSecureSuite01015DLLNTkrnlSoftware"
		weight = 4
strings:
...
rule UPXHiTv001DJSiba
{
      meta:
		author="malware-lu"
		description = "Packer UPXHiTv001DJSiba"
		weight = 4
strings:
...
rule Vpackerttui
{
      meta:
		author="malware-lu"
		description = "Packer Vpackerttui"
		weight = 4
strings:
...
rule IProtect10FxlibdllmodebyFuXdas
{
      meta:
		author="malware-lu"
		description = "Packer IProtect10FxlibdllmodebyFuXdas"
		weight = 4
strings:
...
rule PseudoSigner02DxPack10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02DxPack10Anorganix"
		weight = 4
strings:
...
rule SecureEXE30ZipWorx
{
      meta:
		author="malware-lu"
		description = "Packer SecureEXE30ZipWorx"
		weight = 4
strings:
...
rule eXPressorv12CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressorv12CGSoftLabs"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 or $a1 at pe.entry_point or $a2 at pe.entry_point
}
...
rule NullsoftPIMPInstallSystemv13x
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftPIMPInstallSystemv13x"
		weight = 4
strings:
...
rule Enigmaprotector110111VladimirSukhov
{
      meta:
		author="malware-lu"
		description = "Packer Enigmaprotector110111VladimirSukhov"
		weight = 4
strings:
...
rule PECompactv140b5v140b6
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv140b5v140b6"
		weight = 4
strings:
...
rule VxExplosion1000
{
      meta:
		author="malware-lu"
		description = "Packer VxExplosion1000"
		weight = 4
strings:
...
rule PKZIPSFXv11198990
{
      meta:
		author="malware-lu"
		description = "Packer PKZIPSFXv11198990"
		weight = 4
strings:
...
rule PEBundlev20b5v23
{
      meta:
		author="malware-lu"
		description = "Packer PEBundlev20b5v23"
		weight = 4
strings:
...
rule PUNiSHERV15DemoFEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer PUNiSHERV15DemoFEUERRADER"
		weight = 4
strings:
...
rule HACKSTOPv110v111
{
      meta:
		author="malware-lu"
		description = "Packer HACKSTOPv110v111"
		weight = 4
strings:
...
rule Obsidium1336ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1336ObsidiumSoftware"
		weight = 4
strings:
...
rule DualseXeEncryptor10bDual
{
      meta:
		author="malware-lu"
		description = "Packer DualseXeEncryptor10bDual"
		weight = 4
strings:
...
rule MarjinZEXEScramblerSEbyMarjinZ
{
      meta:
		author="malware-lu"
		description = "Packer MarjinZEXEScramblerSEbyMarjinZ"
		weight = 4
strings:
...
rule nPack111502006BetaNEOx
{
      meta:
		author="malware-lu"
		description = "Packer nPack111502006BetaNEOx"
		weight = 4
strings:
...
rule DingBoysPElockPhantasmv15b3
{
      meta:
		author="malware-lu"
		description = "Packer DingBoysPElockPhantasmv15b3"
		weight = 4
strings:
...
rule ShellModify01pll621
{
      meta:
		author="malware-lu"
		description = "Packer ShellModify01pll621"
		weight = 4
strings:
...
rule PseudoSigner01MacromediaFlashProjector60Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MacromediaFlashProjector60Anorganix"
		weight = 4
strings:
...
rule Packman0001Bubbasoft
{
      meta:
		author="malware-lu"
		description = "Packer Packman0001Bubbasoft"
		weight = 4
strings:
...
rule aPackv098bDSESnotsaved
{
      meta:
		author="malware-lu"
		description = "Packer aPackv098bDSESnotsaved"
		weight = 4
strings:
...
rule ASProtectvIfyouknowthisversionpostonPEiDboardh2
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectvIfyouknowthisversionpostonPEiDboardh2"
		weight = 4
strings:
...
rule Aluwainv809
{
      meta:
		author="malware-lu"
		description = "Packer Aluwainv809"
		weight = 4
strings:
...
rule AntiDote12DLLDemoSISTeam
{
      meta:
		author="malware-lu"
		description = "Packer AntiDote12DLLDemoSISTeam"
		weight = 4
strings:
...
rule MSLRHv032afakeMicrosoftVisualCemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeMicrosoftVisualCemadicius"
		weight = 4
strings:
...
rule SoftwareCompressV12BGSoftwareProtectTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer SoftwareCompressV12BGSoftwareProtectTechnologies"
		weight = 4
strings:
...
rule Themida1201OreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer Themida1201OreansTechnologies"
		weight = 4
strings:
...
rule PECompactv126b1v126b2
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv126b1v126b2"
		weight = 4
strings:
...
rule Cruncherv10
{
      meta:
		author="malware-lu"
		description = "Packer Cruncherv10"
		weight = 4
strings:
...
rule AntiDote1214SEDLLSISTeam
{
      meta:
		author="malware-lu"
		description = "Packer AntiDote1214SEDLLSISTeam"
		weight = 4
strings:
...
rule ASProtectSKE21xexeAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectSKE21xexeAlexeySolodovnikov"
		weight = 4
strings:
...
rule DBPEv210DingBoy
{
      meta:
		author="malware-lu"
		description = "Packer DBPEv210DingBoy"
		weight = 4
strings:
...
rule NsPacKV37LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPacKV37LiuXingPing"
		weight = 4
strings:
...
rule tElock099tE
{
      meta:
		author="malware-lu"
		description = "Packer tElock099tE"
		weight = 4
strings:
...
rule WinZipSelfExtractor22personaleditionWinZipComputing
{
      meta:
		author="malware-lu"
		description = "Packer WinZipSelfExtractor22personaleditionWinZipComputing"
		weight = 4
strings:
...
rule ZipWorxSecureEXEv25ZipWORXTechnologiesLLC
{
      meta:
		author="malware-lu"
		description = "Packer ZipWorxSecureEXEv25ZipWORXTechnologiesLLC"
		weight = 4
strings:
...
rule RLPackFullEdition117iBoxaPLibAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEdition117iBoxaPLibAp0x"
		weight = 4
strings:
...
rule Alloyv1x2000
{
      meta:
		author="malware-lu"
		description = "Packer Alloyv1x2000"
		weight = 4
strings:
...
rule FreeJoiner153Stubengine171GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoiner153Stubengine171GlOFF"
		weight = 4
strings:
...
rule PseudoSigner02MicrosoftVisualC70DLLAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02MicrosoftVisualC70DLLAnorganix"
		weight = 4
strings:
...
rule EYouDiDaiYueHeiFengGao
{
      meta:
		author="malware-lu"
		description = "Packer EYouDiDaiYueHeiFengGao"
		weight = 4
strings:
...
rule EXECryptorV21Xsoftcompletecom
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptorV21Xsoftcompletecom"
		weight = 4
strings:
...
rule PCShrinkerv045
{
      meta:
		author="malware-lu"
		description = "Packer PCShrinkerv045"
		weight = 4
strings:
...
rule yodasProtectorV1033AshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtectorV1033AshkbizDanehkar"
		weight = 4
strings:
...
rule SoftSentryv211
{
      meta:
		author="malware-lu"
		description = "Packer SoftSentryv211"
		weight = 4
strings:
...
rule FSGv120EngdulekxtBorlandDelphiBorlandC
{
      meta:
		author="malware-lu"
		description = "Packer FSGv120EngdulekxtBorlandDelphiBorlandC"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeStonesPEEncryptor20FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeStonesPEEncryptor20FEUERRADER"
		weight = 4
strings:
...
rule Armadillov300
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov300"
		weight = 4
strings:
...
rule RCryptorv11Vaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv11Vaska"
		weight = 4
strings:
...
rule Fusion10jaNooNi
{
      meta:
		author="malware-lu"
		description = "Packer Fusion10jaNooNi"
		weight = 4
strings:
...
rule UpxLock1012CyberDoomTeamXBoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer UpxLock1012CyberDoomTeamXBoBBobSoft"
		weight = 4
strings:
...
rule PCPEEncryptorAlphapreview
{
      meta:
		author="malware-lu"
		description = "Packer PCPEEncryptorAlphapreview"
		weight = 4
strings:
...
rule VxKeypress1212
{
      meta:
		author="malware-lu"
		description = "Packer VxKeypress1212"
		weight = 4
strings:
...
rule NsPackV14LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPackV14LiuXingPing"
		weight = 4
strings:
...
rule VProtectorV11Avcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtectorV11Avcasm"
		weight = 4
strings:
...
rule Obsidium1300ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1300ObsidiumSoftware"
		weight = 4
strings:
...
rule XXPack01bagie
{
      meta:
		author="malware-lu"
		description = "Packer XXPack01bagie"
		weight = 4
strings:
...
rule ExeLocker10IonIce
{
      meta:
		author="malware-lu"
		description = "Packer ExeLocker10IonIce"
		weight = 4
strings:
...
rule yodasProtectorV101AshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtectorV101AshkbizDanehkar"
		weight = 4
strings:
...
rule ASPackv2001AlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv2001AlexeySolodovnikov"
		weight = 4
strings:
...
rule USERNAMEv300
{
      meta:
		author="malware-lu"
		description = "Packer USERNAMEv300"
		weight = 4
strings:
...
rule nSpackV2xLiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer nSpackV2xLiuXingPing"
		weight = 4
strings:
...
rule GameGuardv20065xxdllsignbyhot_UNP
{
      meta:
		author="malware-lu"
		description = "Packer GameGuardv20065xxdllsignbyhot_UNP"
		weight = 4
strings:
...
rule Upack_PatchoranyVersionDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack_PatchoranyVersionDwing"
		weight = 4
strings:
...
rule WWPACKv305c4Unextractable
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4Unextractable"
		weight = 4
strings:
...
rule Escargot01finalMeat
{
      meta:
		author="malware-lu"
		description = "Packer Escargot01finalMeat"
		weight = 4
strings:
...
rule MetrowerksCodeWarriorv20GUI
{
      meta:
		author="malware-lu"
		description = "Packer MetrowerksCodeWarriorv20GUI"
		weight = 4
strings:
...
rule UnnamedScrambler21Beta211p0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler21Beta211p0ke"
		weight = 4
strings:
...
rule NoodleCryptv20
{
      meta:
		author="malware-lu"
		description = "Packer NoodleCryptv20"
		weight = 4
strings:
...
rule PoPa001PackeronPascalbagie
{
      meta:
		author="malware-lu"
		description = "Packer PoPa001PackeronPascalbagie"
		weight = 4
strings:
...
rule BlindSpot10s134k
{
      meta:
		author="malware-lu"
		description = "Packer BlindSpot10s134k"
		weight = 4
strings:
...
rule GamehouseMediaProtectorVersionUnknown
{
      meta:
		author="malware-lu"
		description = "Packer GamehouseMediaProtectorVersionUnknown"
		weight = 4
strings:
...
rule EXEStealthv274WebToolMaster
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv274WebToolMaster"
		weight = 4
strings:
...
rule EXEManagerVersion301994cSolarDesigner
{
      meta:
		author="malware-lu"
		description = "Packer EXEManagerVersion301994cSolarDesigner"
		weight = 4
strings:
...
rule Upackv02BetaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv02BetaDwing"
		weight = 4
strings:
...
rule DEFv100Engbartxt
{
      meta:
		author="malware-lu"
		description = "Packer DEFv100Engbartxt"
		weight = 4
strings:
...
rule AnslymCrypter
{
      meta:
		author="malware-lu"
		description = "Packer AnslymCrypter"
		weight = 4
strings:
...
rule ARMProtectorv02SMoKE
{
      meta:
		author="malware-lu"
		description = "Packer ARMProtectorv02SMoKE"
		weight = 4
strings:
...
rule CrypKeyV56XDLLKenonicControlsLtd
{
      meta:
		author="malware-lu"
		description = "Packer CrypKeyV56XDLLKenonicControlsLtd"
		weight = 4
strings:
...
rule PEiDBundlev102v104BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PEiDBundlev102v104BoBBobSoft"
		weight = 4
strings:
...
rule VxHeloween1172
{
      meta:
		author="malware-lu"
		description = "Packer VxHeloween1172"
		weight = 4
strings:
...
rule PackedwithPKLITEv150withCRCcheck1
{
      meta:
		author="malware-lu"
		description = "Packer PackedwithPKLITEv150withCRCcheck1"
		weight = 4
strings:
...
rule Pe123v2006412
{
      meta:
		author="malware-lu"
		description = "Packer Pe123v2006412"
		weight = 4
strings:
...
rule DropperCreatorV01Conflict
{
      meta:
		author="malware-lu"
		description = "Packer DropperCreatorV01Conflict"
		weight = 4
strings:
...
rule InnoSetupModulev129
{
      meta:
		author="malware-lu"
		description = "Packer InnoSetupModulev129"
		weight = 4
strings:
...
rule Armadillov3xx
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov3xx"
		weight = 4
strings:
...
rule dUP2xPatcherwwwdiablo2oo2cjbnet
{
      meta:
		author="malware-lu"
		description = "Packer dUP2xPatcherwwwdiablo2oo2cjbnet"
		weight = 4
strings:
...
rule PseudoSigner02PEProtect09Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02PEProtect09Anorganix"
		weight = 4
strings:
...
rule pscrambler12byp0ke
{
      meta:
		author="malware-lu"
		description = "Packer pscrambler12byp0ke"
		weight = 4
strings:
...
rule EXECryptor2223compressedcodewwwstrongbitcom
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor2223compressedcodewwwstrongbitcom"
		weight = 4
strings:
...
rule Armadillov265b1
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov265b1"
		weight = 4
strings:
...
rule RLPackFullEdition117aPLibAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEdition117aPLibAp0x"
		weight = 4
strings:
...
rule PolyCryptPE214b215JLabSoftwareCreationshoep
{
      meta:
		author="malware-lu"
		description = "Packer PolyCryptPE214b215JLabSoftwareCreationshoep"
		weight = 4
strings:
...
rule yodasProtector10xAshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtector10xAshkbizDanehkar"
		weight = 4
strings:
...
rule Upack_UnknownDLLDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack_UnknownDLLDwing"
		weight = 4
strings:
...
rule AppProtectorSilentTeam
{
      meta:
		author="malware-lu"
		description = "Packer AppProtectorSilentTeam"
		weight = 4
strings:
...
rule RODHighTECHAyman
{
      meta:
		author="malware-lu"
		description = "Packer RODHighTECHAyman"
		weight = 4
strings:
...
rule ICrypt10byBuGGz
{
      meta:
		author="malware-lu"
		description = "Packer ICrypt10byBuGGz"
		weight = 4
strings:
...
rule RLPackV115V117LZMA430ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV115V117LZMA430ap0x"
		weight = 4
strings:
...
rule WWPACKv305c4UnextractableVirusShield
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4UnextractableVirusShield"
		weight = 4
strings:
...
rule Obsidium13013ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium13013ObsidiumSoftware"
		weight = 4
strings:
...
rule ObsidiumV130XObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV130XObsidiumSoftware"
		weight = 4
strings:
...
rule MetrowerksCodeWarriorv20Console
{
      meta:
		author="malware-lu"
		description = "Packer MetrowerksCodeWarriorv20Console"
		weight = 4
strings:
...
rule PESpinv07Cyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESpinv07Cyberbob"
		weight = 4
strings:
...
rule SimpleUPXCryptorV3042005MANtiCORE
{
      meta:
		author="malware-lu"
		description = "Packer SimpleUPXCryptorV3042005MANtiCORE"
		weight = 4
strings:
...
rule WinRAR32bitSFXModule
{
      meta:
		author="malware-lu"
		description = "Packer WinRAR32bitSFXModule"
		weight = 4
strings:
...
rule iPBProtect013017forgot
{
      meta:
		author="malware-lu"
		description = "Packer iPBProtect013017forgot"
		weight = 4
strings:
...
rule MSLRHv032afakeASPack211demadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeASPack211demadicius"
		weight = 4
strings:
...
rule Upackv036alphaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv036alphaDwing"
		weight = 4
strings:
...
rule CrinklerV03V04RuneLHStubbeandAskeSimonChristensen
{
      meta:
		author="malware-lu"
		description = "Packer CrinklerV03V04RuneLHStubbeandAskeSimonChristensen"
		weight = 4
strings:
...
rule DingBoysPElockPhantasmv10v11
{
      meta:
		author="malware-lu"
		description = "Packer DingBoysPElockPhantasmv10v11"
		weight = 4
strings:
...
rule PECompactV2XBitsumTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer PECompactV2XBitsumTechnologies"
		weight = 4
strings:
...
rule CRYPTVersion17cDismember
{
      meta:
		author="malware-lu"
		description = "Packer CRYPTVersion17cDismember"
		weight = 4
strings:
...
rule PECrypt32v102
{
      meta:
		author="malware-lu"
		description = "Packer PECrypt32v102"
		weight = 4
strings:
...
rule PseudoSigner01PESHiELD025Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PESHiELD025Anorganix"
		weight = 4
strings:
...
rule NETDLLMicrosoft
{
      meta:
		author="malware-lu"
		description = "Packer NETDLLMicrosoft"
		weight = 4
strings:
...
condition:
		check_packer_bool and for any of ($*) : ( $ at pe.entry_point )
}
...
rule BeRoEXEPackerv100DLLLZMABeRoFarbrausch
{
      meta:
		author="malware-lu"
		description = "Packer BeRoEXEPackerv100DLLLZMABeRoFarbrausch"
		weight = 4
strings:
...
rule PseudoSigner02ExeSmasherAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02ExeSmasherAnorganix"
		weight = 4
strings:
...
rule ObsidiumV125ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV125ObsidiumSoftware"
		weight = 4
strings:
...
rule ASPackv107bDLLAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv107bDLLAlexeySolodovnikov"
		weight = 4
strings:
...
rule MicroJoiner17coban2k
{
      meta:
		author="malware-lu"
		description = "Packer MicroJoiner17coban2k"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeVOBProtectCDFEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeVOBProtectCDFEUERRADER"
		weight = 4
strings:
...
rule CelsiusCrypt21Z3r0
{
      meta:
		author="malware-lu"
		description = "Packer CelsiusCrypt21Z3r0"
		weight = 4
strings:
...
rule Armadillov260
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov260"
		weight = 4
strings:
...
rule Armadillov261
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov261"
		weight = 4
strings:
...
rule MSLRHv032afakeASPack212emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeASPack212emadicius"
		weight = 4
strings:
...
rule RatPackerGluestub
{
      meta:
		author="malware-lu"
		description = "Packer RatPackerGluestub"
		weight = 4
strings:
...
rule CreateInstallv200335
{
      meta:
		author="malware-lu"
		description = "Packer CreateInstallv200335"
		weight = 4
strings:
...
rule UPXV200V290MarkusOberhumerLaszloMolnarJohnReiser
{
      meta:
		author="malware-lu"
		description = "Packer UPXV200V290MarkusOberhumerLaszloMolnarJohnReiser"
		weight = 4
strings:
...
rule PseudoSigner01MicrosoftVisualBasic5060Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MicrosoftVisualBasic5060Anorganix"
		weight = 4
strings:
...
rule UPXModifiedStubbFarbrauschConsumerConsulting
{
      meta:
		author="malware-lu"
		description = "Packer UPXModifiedStubbFarbrauschConsumerConsulting"
		weight = 4
strings:
...
rule SVKProtectorv111
{
      meta:
		author="malware-lu"
		description = "Packer SVKProtectorv111"
		weight = 4
strings:
...
rule PCShrinkerv071
{
      meta:
		author="malware-lu"
		description = "Packer PCShrinkerv071"
		weight = 4
strings:
...
rule BeRoEXEPackerv100DLLLZBRRBeRoFarbrausch
{
      meta:
		author="malware-lu"
		description = "Packer BeRoEXEPackerv100DLLLZBRRBeRoFarbrausch"
		weight = 4
strings:
...
rule hmimysPackerV12hmimys
{
      meta:
		author="malware-lu"
		description = "Packer hmimysPackerV12hmimys"
		weight = 4
strings:
...
rule EnigmaProtector131Build20070615DllSukhovVladimirSergeNMarkin
{
      meta:
		author="malware-lu"
		description = "Packer EnigmaProtector131Build20070615DllSukhovVladimirSergeNMarkin"
		weight = 4
strings:
...
rule PureBasicDLLNeilHodgson
{
      meta:
		author="malware-lu"
		description = "Packer PureBasicDLLNeilHodgson"
		weight = 4
strings:
...
rule Armadillov310
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov310"
		weight = 4
strings:
...
rule Upack012betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack012betaDwing"
		weight = 4
strings:
...
rule VxNcuLi1688
{
      meta:
		author="malware-lu"
		description = "Packer VxNcuLi1688"
		weight = 4
strings:
...
rule VProtectorvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtectorvcasm"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 or $a1 or $a2
}
...
rule W32JeefoPEFileInfector
{
      meta:
		author="malware-lu"
		description = "Packer W32JeefoPEFileInfector"
		weight = 4
strings:
...
rule ExeSplitter13SplitCryptMethodBillPrisonerTPOC
{
      meta:
		author="malware-lu"
		description = "Packer ExeSplitter13SplitCryptMethodBillPrisonerTPOC"
		weight = 4
strings:
...
rule AntiDote12BetaDemoSISTeam
{
      meta:
		author="malware-lu"
		description = "Packer AntiDote12BetaDemoSISTeam"
		weight = 4
strings:
...
rule ASPackv211bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv211bAlexeySolodovnikov"
		weight = 4
strings:
...
rule EXECryptor224StrongbitSoftCompleteDevelopmenth1
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor224StrongbitSoftCompleteDevelopmenth1"
		weight = 4
strings:
...
rule EXECryptor224StrongbitSoftCompleteDevelopmenth2
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor224StrongbitSoftCompleteDevelopmenth2"
		weight = 4
strings:
...
rule EXECryptor224StrongbitSoftCompleteDevelopmenth3
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor224StrongbitSoftCompleteDevelopmenth3"
		weight = 4
strings:
...
rule ProActivateV10XTurboPowerSoftwareCompany
{
      meta:
		author="malware-lu"
		description = "Packer ProActivateV10XTurboPowerSoftwareCompany"
		weight = 4
strings:
...
rule PackMasterv10
{
      meta:
		author="malware-lu"
		description = "Packer PackMasterv10"
		weight = 4
strings:
...
rule FreeJoiner152Stubengine16GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoiner152Stubengine16GlOFF"
		weight = 4
strings:
...
rule ASProtectv12AlexeySolodovnikovh1
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv12AlexeySolodovnikovh1"
		weight = 4
strings:
...
rule FSGv110EngdulekxtBorlandDelphiMicrosoftVisualCx
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtBorlandDelphiMicrosoftVisualCx"
		weight = 4
strings:
...
rule PENightMare2Beta
{
      meta:
		author="malware-lu"
		description = "Packer PENightMare2Beta"
		weight = 4
strings:
...
rule Reg2Exe224byJanVorel
{
      meta:
		author="malware-lu"
		description = "Packer Reg2Exe224byJanVorel"
		weight = 4
strings:
...
rule SVKProtectorv13xEngPavolCerven
{
      meta:
		author="malware-lu"
		description = "Packer SVKProtectorv13xEngPavolCerven"
		weight = 4
strings:
...
rule ThinstallEmbedded2609Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded2609Jitit"
		weight = 4
strings:
...
rule UPXcrypterarchphaseNWC
{
      meta:
		author="malware-lu"
		description = "Packer UPXcrypterarchphaseNWC"
		weight = 4
strings:
...
rule StarForceProtectionDriverProtectionTechnology
{
      meta:
		author="malware-lu"
		description = "Packer StarForceProtectionDriverProtectionTechnology"
		weight = 4
strings:
...
rule FishPEV10Xhellfish
{
      meta:
		author="malware-lu"
		description = "Packer FishPEV10Xhellfish"
		weight = 4
strings:
...
rule LY_WGKXwwwszleyucom
{
      meta:
		author="malware-lu"
		description = "Packer LY_WGKXwwwszleyucom"
		weight = 4
strings:
...
rule ASProtect13321RegisteredAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASProtect13321RegisteredAlexeySolodovnikov"
		weight = 4
strings:
...
rule RLPackV111ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV111ap0x"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMicrosoftVisualC4xLCCWin321x
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMicrosoftVisualC4xLCCWin321x"
		weight = 4
strings:
...
rule dePACKdeNULL
{
      meta:
		author="malware-lu"
		description = "Packer dePACKdeNULL"
		weight = 4
strings:
...
rule EXECryptorv1401
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptorv1401"
		weight = 4
strings:
...
rule MSLRHv032afakePELockNT204emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePELockNT204emadicius"
		weight = 4
strings:
...
rule PELockNTv203
{
      meta:
		author="malware-lu"
		description = "Packer PELockNTv203"
		weight = 4
strings:
...
rule Reg2Exe220221byJanVorel
{
      meta:
		author="malware-lu"
		description = "Packer Reg2Exe220221byJanVorel"
		weight = 4
strings:
...
rule PELockNTv201
{
      meta:
		author="malware-lu"
		description = "Packer PELockNTv201"
		weight = 4
strings:
...
rule PELockNTv204
{
      meta:
		author="malware-lu"
		description = "Packer PELockNTv204"
		weight = 4
strings:
...
rule UPXFreakv01BorlandDelphiHMX0101
{
      meta:
		author="malware-lu"
		description = "Packer UPXFreakv01BorlandDelphiHMX0101"
		weight = 4
strings:
...
rule Obsidium13017Obsidiumsoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium13017Obsidiumsoftware"
		weight = 4
strings:
...
rule Petite22c199899IanLuck
{
      meta:
		author="malware-lu"
		description = "Packer Petite22c199899IanLuck"
		weight = 4
strings:
...
rule PluginToExev101BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PluginToExev101BoBBobSoft"
		weight = 4
strings:
...
rule Enigmaprotector110unregistered
{
      meta:
		author="malware-lu"
		description = "Packer Enigmaprotector110unregistered"
		weight = 4
strings:
...
rule Obsidium1341ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1341ObsidiumSoftware"
		weight = 4
strings:
...
rule WebCopsDLLLINKDataSecurity
{
      meta:
		author="malware-lu"
		description = "Packer WebCopsDLLLINKDataSecurity"
		weight = 4
strings:
...
rule PseudoSigner01PackMaster10PEXCloneAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PackMaster10PEXCloneAnorganix"
		weight = 4
strings:
...
rule Upackv037v038BetaStripbaserelocationtableOptionDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv037v038BetaStripbaserelocationtableOptionDwing"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeSVKP13xFEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeSVKP13xFEUERRADER"
		weight = 4
strings:
...
rule InstallShieldCustom
{
      meta:
		author="malware-lu"
		description = "Packer InstallShieldCustom"
		weight = 4
strings:
...
rule Petitevafterv14
{
      meta:
		author="malware-lu"
		description = "Packer Petitevafterv14"
		weight = 4
strings:
...
rule ExeToolsv21EncruptorbyDISMEMBER
{
      meta:
		author="malware-lu"
		description = "Packer ExeToolsv21EncruptorbyDISMEMBER"
		weight = 4
strings:
...
rule NTkrnlSecureSuiteNTkrnlteam
{
      meta:
		author="malware-lu"
		description = "Packer NTkrnlSecureSuiteNTkrnlteam"
		weight = 4
strings:
...
rule VXTibsZhelatinStormWormvariant
{
      meta:
		author="malware-lu"
		description = "Packer VXTibsZhelatinStormWormvariant"
		weight = 4
strings:
...
rule MSLRHv032afakePEX099emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePEX099emadicius"
		weight = 4
strings:
...
rule NSPack3xLiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NSPack3xLiuXingPing"
		weight = 4
strings:
...
rule PECompactv25RetailBitsumTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv25RetailBitsumTechnologies"
		weight = 4
strings:
...
rule WARNINGTROJANXiaoHui
{
      meta:
		author="malware-lu"
		description = "Packer WARNINGTROJANXiaoHui"
		weight = 4
strings:
...
rule PMODEWv112116121133DOSextender
{
      meta:
		author="malware-lu"
		description = "Packer PMODEWv112116121133DOSextender"
		weight = 4
strings:
...
rule AaseCrypterbysantasdad
{
      meta:
		author="malware-lu"
		description = "Packer AaseCrypterbysantasdad"
		weight = 4
strings:
...
rule aPackv098bJibz
{
      meta:
		author="malware-lu"
		description = "Packer aPackv098bJibz"
		weight = 4
strings:
...
rule UPackv011Dwing
{
      meta:
		author="malware-lu"
		description = "Packer UPackv011Dwing"
		weight = 4
strings:
...
rule NsPacKNetLiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPacKNetLiuXingPing"
		weight = 4
strings:
...
rule PseudoSigner02PENightMare2BetaAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02PENightMare2BetaAnorganix"
		weight = 4
strings:
...
rule PseudoSigner01MicrosoftVisualC60DebugVersionAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MicrosoftVisualC60DebugVersionAnorganix"
		weight = 4
strings:
...
rule DJoinv07publicRC4encryptiondrmist
{
      meta:
		author="malware-lu"
		description = "Packer DJoinv07publicRC4encryptiondrmist"
		weight = 4
strings:
...
rule UPXv103v104
{
      meta:
		author="malware-lu"
		description = "Packer UPXv103v104"
		weight = 4
strings:
...
rule PEDiminisherV01Teraphy
{
      meta:
		author="malware-lu"
		description = "Packer PEDiminisherV01Teraphy"
		weight = 4
strings:
...
rule WWPACKv305c4ExtrPasswcheckVirshield
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4ExtrPasswcheckVirshield"
		weight = 4
strings:
...
rule ExeGuarderv18Exeiconcom
{
      meta:
		author="malware-lu"
		description = "Packer ExeGuarderv18Exeiconcom"
		weight = 4
strings:
...
rule codeCrypter031Tibbar
{
      meta:
		author="malware-lu"
		description = "Packer codeCrypter031Tibbar"
		weight = 4
strings:
...
rule RLPv073betaap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPv073betaap0x"
		weight = 4
strings:
...
rule PEnguinCryptv10
{
      meta:
		author="malware-lu"
		description = "Packer PEnguinCryptv10"
		weight = 4
strings:
...
rule MetrowerksCodeWarriorDLLv20
{
      meta:
		author="malware-lu"
		description = "Packer MetrowerksCodeWarriorDLLv20"
		weight = 4
strings:
...
rule PECrc32088ZhouJinYu
{
      meta:
		author="malware-lu"
		description = "Packer PECrc32088ZhouJinYu"
		weight = 4
strings:
...
rule PECompactv123b3v1241
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv123b3v1241"
		weight = 4
strings:
...
rule Noodlecrypt2rsc
{
      meta:
		author="malware-lu"
		description = "Packer Noodlecrypt2rsc"
		weight = 4
strings:
...
rule RLPack120BasicEditionLZMAAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPack120BasicEditionLZMAAp0x"
		weight = 4
strings:
...
rule PseudoSigner01PENightMare2BetaAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PENightMare2BetaAnorganix"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeXtremeProtector105FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeXtremeProtector105FEUERRADER"
		weight = 4
strings:
...
rule RLPackv118BasicDLLLZMAAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackv118BasicDLLLZMAAp0x"
		weight = 4
strings:
...
rule CrypKeyv5v6
{
      meta:
		author="malware-lu"
		description = "Packer CrypKeyv5v6"
		weight = 4
strings:
...
rule InnoSetupModulev109a
{
      meta:
		author="malware-lu"
		description = "Packer InnoSetupModulev109a"
		weight = 4
strings:
...
rule ObsidiumV1300ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV1300ObsidiumSoftware"
		weight = 4
strings:
...
rule ThinstallEmbedded2312Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded2312Jitit"
		weight = 4
strings:
...
rule WWPACKv305c4Extractable
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4Extractable"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point or $a1 at pe.entry_point or $a2 at pe.entry_point or $a3 at pe.entry_point or $a4 at pe.entry_point or $a5 at pe.entry_point
}
...
rule PseudoSigner02VOBProtectCD5Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02VOBProtectCD5Anorganix"
		weight = 4
strings:
...
rule PseudoSigner02WatcomCCDLLAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02WatcomCCDLLAnorganix"
		weight = 4
strings:
...
rule yodasCrypter13AshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasCrypter13AshkbizDanehkar"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMicrosoftVisualC6070ASM
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMicrosoftVisualC6070ASM"
		weight = 4
strings:
...
rule ASPackv102aAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv102aAlexeySolodovnikov"
		weight = 4
strings:
...
rule PseudoSigner01MinGWGCC2xAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MinGWGCC2xAnorganix"
		weight = 4
strings:
...
rule Armadillov253
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov253"
		weight = 4
strings:
...
rule Armadillov252
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov252"
		weight = 4
strings:
...
rule Armadillov251
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov251"
		weight = 4
strings:
...
rule Armadillov250
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov250"
		weight = 4
strings:
...
rule Obsidium1331ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1331ObsidiumSoftware"
		weight = 4
strings:
...
rule DIETv144v145f
{
      meta:
		author="malware-lu"
		description = "Packer DIETv144v145f"
		weight = 4
strings:
...
rule PECompactv098
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv098"
		weight = 4
strings:
...
rule PECompactv099
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv099"
		weight = 4
strings:
...
rule NsPacKV30LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPacKV30LiuXingPing"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMicrosoftVisualBasic5060
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMicrosoftVisualBasic5060"
		weight = 4
strings:
...
rule PECompactv090
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv090"
		weight = 4
strings:
...
rule PECompactv092
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv092"
		weight = 4
strings:
...
rule PECompactv094
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv094"
		weight = 4
strings:
...
rule PeX099bartCrackPl
{
      meta:
		author="malware-lu"
		description = "Packer PeX099bartCrackPl"
		weight = 4
strings:
...
rule ObsidiumV1304ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV1304ObsidiumSoftware"
		weight = 4
strings:
...
rule SoftwareCompressv14LITEBGSoftwareProtectTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer SoftwareCompressv14LITEBGSoftwareProtectTechnologies"
		weight = 4
strings:
...
rule FixupPakv120
{
      meta:
		author="malware-lu"
		description = "Packer FixupPakv120"
		weight = 4
strings:
...
rule ARCSFXArchive
{
      meta:
		author="malware-lu"
		description = "Packer ARCSFXArchive"
		weight = 4
strings:
...
rule MoleBoxv230Teggo
{
      meta:
		author="malware-lu"
		description = "Packer MoleBoxv230Teggo"
		weight = 4
strings:
...
rule PseudoSigner01WATCOMCCEXEAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01WATCOMCCEXEAnorganix"
		weight = 4
strings:
...
rule RLPackV115V117aPlib043ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV115V117aPlib043ap0x"
		weight = 4
strings:
...
rule EmbedPEv113cyclotron
{
      meta:
		author="malware-lu"
		description = "Packer EmbedPEv113cyclotron"
		weight = 4
strings:
...
rule eXcaliburv103forgotus
{
      meta:
		author="malware-lu"
		description = "Packer eXcaliburv103forgotus"
		weight = 4
strings:
...
rule Upack021betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack021betaDwing"
		weight = 4
strings:
...
rule WebCopsEXELINKDataSecurity
{
      meta:
		author="malware-lu"
		description = "Packer WebCopsEXELINKDataSecurity"
		weight = 4
strings:
...
rule PseudoSigner02FSG10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02FSG10Anorganix"
		weight = 4
strings:
...
rule ThemidaOreansTechnologies2004
{
      meta:
		author="malware-lu"
		description = "Packer ThemidaOreansTechnologies2004"
		weight = 4
strings:
...
rule VxNumberOne
{
      meta:
		author="malware-lu"
		description = "Packer VxNumberOne"
		weight = 4
strings:
...
rule WinKriptv10MrCrimson
{
      meta:
		author="malware-lu"
		description = "Packer WinKriptv10MrCrimson"
		weight = 4
strings:
...
rule tElockv085f
{
      meta:
		author="malware-lu"
		description = "Packer tElockv085f"
		weight = 4
strings:
...
rule RosAsm2050aBetov
{
      meta:
		author="malware-lu"
		description = "Packer RosAsm2050aBetov"
		weight = 4
strings:
...
rule Obsidium13021ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium13021ObsidiumSoftware"
		weight = 4
strings:
...
rule ASPackv211dAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv211dAlexeySolodovnikov"
		weight = 4
strings:
...
rule ASPackv211cAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv211cAlexeySolodovnikov"
		weight = 4
strings:
...
rule ACProtect14xRISCOsoft
{
      meta:
		author="malware-lu"
		description = "Packer ACProtect14xRISCOsoft"
		weight = 4
strings:
...
rule SplashBitmapv100BoBBobsoft
{
      meta:
		author="malware-lu"
		description = "Packer SplashBitmapv100BoBBobsoft"
		weight = 4
strings:
...
rule PEZipv10byBaGIE
{
      meta:
		author="malware-lu"
		description = "Packer PEZipv10byBaGIE"
		weight = 4
strings:
...
rule LamerStopv10ccStefanEsser
{
      meta:
		author="malware-lu"
		description = "Packer LamerStopv10ccStefanEsser"
		weight = 4
strings:
...
rule ACProtectV14Xrisco
{
      meta:
		author="malware-lu"
		description = "Packer ACProtectV14Xrisco"
		weight = 4
strings:
...
rule VxGRUNT2Family
{
      meta:
		author="malware-lu"
		description = "Packer VxGRUNT2Family"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeMicrosoftVisualC70FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeMicrosoftVisualC70FEUERRADER"
		weight = 4
strings:
...
rule InstallStub32bit
{
      meta:
		author="malware-lu"
		description = "Packer InstallStub32bit"
		weight = 4
strings:
...
rule VcasmProtector10evcasm
{
      meta:
		author="malware-lu"
		description = "Packer VcasmProtector10evcasm"
		weight = 4
strings:
...
rule MSLRHv032afakePEBundle20x24xemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePEBundle20x24xemadicius"
		weight = 4
strings:
...
rule Armadillov190b4
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov190b4"
		weight = 4
strings:
...
rule UPXv103v104Modified
{
      meta:
		author="malware-lu"
		description = "Packer UPXv103v104Modified"
		weight = 4
strings:
...
rule ThemidaWinLicenseV1000V1800OreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer ThemidaWinLicenseV1000V1800OreansTechnologies"
		weight = 4
strings:
...
rule PACKWINv101p
{
      meta:
		author="malware-lu"
		description = "Packer PACKWINv101p"
		weight = 4
strings:
...
rule PECompactv110b1
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv110b1"
		weight = 4
strings:
...
rule MicroJoiner15coban2k
{
      meta:
		author="malware-lu"
		description = "Packer MicroJoiner15coban2k"
		weight = 4
strings:
...
rule ANDpakk2018byDmitryANDAndreev
{
      meta:
		author="malware-lu"
		description = "Packer ANDpakk2018byDmitryANDAndreev"
		weight = 4
strings:
...
rule PECompactv110b2
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv110b2"
		weight = 4
strings:
...
rule PECompactv110b5
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv110b5"
		weight = 4
strings:
...
rule PECompactv110b7
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv110b7"
		weight = 4
strings:
...
rule PECompactv110b6
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv110b6"
		weight = 4
strings:
...
rule KBysPacker028BetaShoooo
{
      meta:
		author="malware-lu"
		description = "Packer KBysPacker028BetaShoooo"
		weight = 4
strings:
...
rule nPack113002006BetaNEOx
{
      meta:
		author="malware-lu"
		description = "Packer nPack113002006BetaNEOx"
		weight = 4
strings:
...
rule PseudoSigner02BorlandC1999Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02BorlandC1999Anorganix"
		weight = 4
strings:
...
rule ASPackv100bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv100bAlexeySolodovnikov"
		weight = 4
strings:
...
rule PureBasic4xDLLNeilHodgson
{
      meta:
		author="malware-lu"
		description = "Packer PureBasic4xDLLNeilHodgson"
		weight = 4
strings:
...
rule EXEPackerv70byTurboPowerSoftware
{
      meta:
		author="malware-lu"
		description = "Packer EXEPackerv70byTurboPowerSoftware"
		weight = 4
strings:
...
rule kkrunchy023alphaRyd
{
      meta:
		author="malware-lu"
		description = "Packer kkrunchy023alphaRyd"
		weight = 4
strings:
...
rule AntiDote12DemoSISTeam
{
      meta:
		author="malware-lu"
		description = "Packer AntiDote12DemoSISTeam"
		weight = 4
strings:
...
rule EXE32Packv137
{
      meta:
		author="malware-lu"
		description = "Packer EXE32Packv137"
		weight = 4
strings:
...
rule EXE32Packv136
{
      meta:
		author="malware-lu"
		description = "Packer EXE32Packv136"
		weight = 4
strings:
...
rule ThinstallEmbedded20XJitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded20XJitit"
		weight = 4
strings:
...
rule EXECryptorv151x
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptorv151x"
		weight = 4
strings:
...
rule CopyProtectorv20
{
      meta:
		author="malware-lu"
		description = "Packer CopyProtectorv20"
		weight = 4
strings:
...
rule EXE32Packv139
{
      meta:
		author="malware-lu"
		description = "Packer EXE32Packv139"
		weight = 4
strings:
...
rule EXE32Packv138
{
      meta:
		author="malware-lu"
		description = "Packer EXE32Packv138"
		weight = 4
strings:
...
rule FSGv110EngdulekxtBorlandC1999
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtBorlandC1999"
		weight = 4
strings:
...
rule ThinstallEmbedded2547V2600Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded2547V2600Jitit"
		weight = 4
strings:
...
rule FSGv131Engdulekxt
{
      meta:
		author="malware-lu"
		description = "Packer FSGv131Engdulekxt"
		weight = 4
strings:
...
rule SDProtectorBasicProEdition110RandyLi
{
      meta:
		author="malware-lu"
		description = "Packer SDProtectorBasicProEdition110RandyLi"
		weight = 4
strings:
...
rule Petite12c1998IanLuck
{
      meta:
		author="malware-lu"
		description = "Packer Petite12c1998IanLuck"
		weight = 4
strings:
...
rule VProtector0X12Xvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtector0X12Xvcasm"
		weight = 4
strings:
...
rule SoftDefenderV11xRandyLi
{
      meta:
		author="malware-lu"
		description = "Packer SoftDefenderV11xRandyLi"
		weight = 4
strings:
...
rule RLPack11BasicEditionap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPack11BasicEditionap0x"
		weight = 4
strings:
...
rule EXE32Packv13x
{
      meta:
		author="malware-lu"
		description = "Packer EXE32Packv13x"
		weight = 4
strings:
...
rule VxInvoluntary1349
{
      meta:
		author="malware-lu"
		description = "Packer VxInvoluntary1349"
		weight = 4
strings:
...
rule WinZip32bit6x
{
      meta:
		author="malware-lu"
		description = "Packer WinZip32bit6x"
		weight = 4
strings:
...
rule NsPacKV36LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPacKV36LiuXingPing"
		weight = 4
strings:
...
rule PseudoSigner02LCCWin321xAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02LCCWin321xAnorganix"
		weight = 4
strings:
...
rule EXECrypt10ReBirth
{
      meta:
		author="malware-lu"
		description = "Packer EXECrypt10ReBirth"
		weight = 4
strings:
...
rule PEcryptbyarchphase
{
      meta:
		author="malware-lu"
		description = "Packer PEcryptbyarchphase"
		weight = 4
strings:
...
rule CrunchPEv30xx
{
      meta:
		author="malware-lu"
		description = "Packer CrunchPEv30xx"
		weight = 4
strings:
...
rule LameCryptLaZaRus
{
      meta:
		author="malware-lu"
		description = "Packer LameCryptLaZaRus"
		weight = 4
strings:
...
rule NsPack29NorthStar
{
      meta:
		author="malware-lu"
		description = "Packer NsPack29NorthStar"
		weight = 4
strings:
...
rule BeRoEXEPackerv100LZBRSBeRoFarbrausch
{
      meta:
		author="malware-lu"
		description = "Packer BeRoEXEPackerv100LZBRSBeRoFarbrausch"
		weight = 4
strings:
...
rule FSGv110EngdulekxtBorlandC
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtBorlandC"
		weight = 4
strings:
...
rule VIRUSIWormKLEZ
{
      meta:
		author="malware-lu"
		description = "Packer VIRUSIWormKLEZ"
		weight = 4
strings:
...
rule YZPack12UsAr
{
      meta:
		author="malware-lu"
		description = "Packer YZPack12UsAr"
		weight = 4
strings:
...
rule PseudoSigner02LocklessIntroPackAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02LocklessIntroPackAnorganix"
		weight = 4
strings:
...
rule FSGv20bartxt
{
      meta:
		author="malware-lu"
		description = "Packer FSGv20bartxt"
		weight = 4
strings:
...
rule MSLRHv032afakeSVKP111emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeSVKP111emadicius"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMASM32TASM32MicrosoftVisualBasic
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMASM32TASM32MicrosoftVisualBasic"
		weight = 4
strings:
...
rule EXECryptor239DLLminimumprotection
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor239DLLminimumprotection"
		weight = 4
strings:
...
rule Frusionbiff
{
      meta:
		author="malware-lu"
		description = "Packer Frusionbiff"
		weight = 4
strings:
...
rule OpenSourceCodeCrypterp0ke
{
      meta:
		author="malware-lu"
		description = "Packer OpenSourceCodeCrypterp0ke"
		weight = 4
strings:
...
rule QrYPt0rbyNuTraL
{
      meta:
		author="malware-lu"
		description = "Packer QrYPt0rbyNuTraL"
		weight = 4
strings:
...
rule EXECryptor2xxmaxcompressedresources
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor2xxmaxcompressedresources"
		weight = 4
strings:
...
rule Upackv024v028AlphaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv024v028AlphaDwing"
		weight = 4
strings:
...
rule ThinstallEmbedded24222428Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded24222428Jitit"
		weight = 4
strings:
...
rule SVKProtectorv1051
{
      meta:
		author="malware-lu"
		description = "Packer SVKProtectorv1051"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeZCode101FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeZCode101FEUERRADER"
		weight = 4
strings:
...
rule ProgramProtectorXPv10
{
      meta:
		author="malware-lu"
		description = "Packer ProgramProtectorXPv10"
		weight = 4
strings:
...
rule SimplePack111Method2NTbagieTMX
{
      meta:
		author="malware-lu"
		description = "Packer SimplePack111Method2NTbagieTMX"
		weight = 4
strings:
...
rule MSLRHv032aemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032aemadicius"
		weight = 4
strings:
...
rule VxHafen1641
{
      meta:
		author="malware-lu"
		description = "Packer VxHafen1641"
		weight = 4
strings:
...
rule NativeUDPacker11ModdedPoisonIvyShellcodeokkixot
{
      meta:
		author="malware-lu"
		description = "Packer NativeUDPacker11ModdedPoisonIvyShellcodeokkixot"
		weight = 4
strings:
...
rule EXECryptor2xxcompressedresources
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor2xxcompressedresources"
		weight = 4
strings:
...
rule NXPEPackerv10
{
      meta:
		author="malware-lu"
		description = "Packer NXPEPackerv10"
		weight = 4
strings:
...
rule PolyBoxCAnskya
{
      meta:
		author="malware-lu"
		description = "Packer PolyBoxCAnskya"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 or $a1 or $a2 or $a3 or $a4 or $a5
}
...
rule beriav007publicWIPsymbiont
{
      meta:
		author="malware-lu"
		description = "Packer beriav007publicWIPsymbiont"
		weight = 4
strings:
...
rule PCGuardv405dv410dv415d
{
      meta:
		author="malware-lu"
		description = "Packer PCGuardv405dv410dv415d"
		weight = 4
strings:
...
rule asscrypterbysantasdad
{
      meta:
		author="malware-lu"
		description = "Packer asscrypterbysantasdad"
		weight = 4
strings:
...
rule CopyControlv303
{
      meta:
		author="malware-lu"
		description = "Packer CopyControlv303"
		weight = 4
strings:
...
rule FSGv110Engbartxt
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110Engbartxt"
		weight = 4
strings:
...
rule EXELOCK66615
{
      meta:
		author="malware-lu"
		description = "Packer EXELOCK66615"
		weight = 4
strings:
...
rule AdysGluev010
{
      meta:
		author="malware-lu"
		description = "Packer AdysGluev010"
		weight = 4
strings:
...
rule SVKProtectorv132
{
      meta:
		author="malware-lu"
		description = "Packer SVKProtectorv132"
		weight = 4
strings:
...
rule PKLITEv114v115v1203
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv114v115v1203"
		weight = 4
strings:
...
rule SafeGuardV10Xsimonzh2000
{
      meta:
		author="malware-lu"
		description = "Packer SafeGuardV10Xsimonzh2000"
		weight = 4
strings:
...
rule PEiDBundlev102v103DLLBoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PEiDBundlev102v103DLLBoBBobSoft"
		weight = 4
strings:
...
rule FreeJoinerSmallbuild023GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoinerSmallbuild023GlOFF"
		weight = 4
strings:
...
rule PrivatePersonalPackerPPP102ConquestOfTroycom
{
      meta:
		author="malware-lu"
		description = "Packer PrivatePersonalPackerPPP102ConquestOfTroycom"
		weight = 4
strings:
...
rule DIETv102bv110av120
{
      meta:
		author="malware-lu"
		description = "Packer DIETv102bv110av120"
		weight = 4
strings:
...
rule UPXECLiPSElayer
{
      meta:
		author="malware-lu"
		description = "Packer UPXECLiPSElayer"
		weight = 4
strings:
...
rule Obsidium1334ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1334ObsidiumSoftware"
		weight = 4
strings:
...
rule PKLITEv150Devicedrivercompression
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv150Devicedrivercompression"
		weight = 4
strings:
...
rule VxGrazie883
{
      meta:
		author="malware-lu"
		description = "Packer VxGrazie883"
		weight = 4
strings:
...
rule PROTECTEXECOMv60
{
      meta:
		author="malware-lu"
		description = "Packer PROTECTEXECOMv60"
		weight = 4
strings:
...
rule ENIGMAProtectorSukhovVladimir
{
      meta:
		author="malware-lu"
		description = "Packer ENIGMAProtectorSukhovVladimir"
		weight = 4
strings:
...
rule CRYPToCRACksPEProtectorV093LukasFleischer
{
      meta:
		author="malware-lu"
		description = "Packer CRYPToCRACksPEProtectorV093LukasFleischer"
		weight = 4
strings:
...
rule PECompactv147v150
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv147v150"
		weight = 4
strings:
...
rule PocketPCMIB
{
      meta:
		author="malware-lu"
		description = "Packer PocketPCMIB"
		weight = 4
strings:
...
rule WWPACKv305c4ExtractableVirusShield
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4ExtractableVirusShield"
		weight = 4
strings:
...
rule PuNkMoD1xPuNkDuDe
{
      meta:
		author="malware-lu"
		description = "Packer PuNkMoD1xPuNkDuDe"
		weight = 4
strings:
...
rule PECrypt32Consolev10v101v102
{
      meta:
		author="malware-lu"
		description = "Packer PECrypt32Consolev10v101v102"
		weight = 4
strings:
...
rule InnoSetupModulev2018
{
      meta:
		author="malware-lu"
		description = "Packer InnoSetupModulev2018"
		weight = 4
strings:
...
rule Nakedbind10nakedcrew
{
      meta:
		author="malware-lu"
		description = "Packer Nakedbind10nakedcrew"
		weight = 4
strings:
...
rule NsPacKV31LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPacKV31LiuXingPing"
		weight = 4
strings:
...
rule AntiVirusVaccinev103
{
      meta:
		author="malware-lu"
		description = "Packer AntiVirusVaccinev103"
		weight = 4
strings:
...
rule ASProtectv12xNewStrain
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv12xNewStrain"
		weight = 4
strings:
...
rule SimpleUPXCryptorv3042005OnelayerencryptionMANtiCORE
{
      meta:
		author="malware-lu"
		description = "Packer SimpleUPXCryptorv3042005OnelayerencryptionMANtiCORE"
		weight = 4
strings:
...
rule AntiDote10Demo12SISTeam
{
      meta:
		author="malware-lu"
		description = "Packer AntiDote10Demo12SISTeam"
		weight = 4
strings:
...
rule FSGv110EngbartxtWinRARSFX
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngbartxtWinRARSFX"
		weight = 4
strings:
...
rule ThinstallEmbedded26202623Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded26202623Jitit"
		weight = 4
strings:
...
rule SLVc0deProtector11xSLVICU
{
      meta:
		author="malware-lu"
		description = "Packer SLVc0deProtector11xSLVICU"
		weight = 4
strings:
...
rule RJoinerbyVaskaSignfrompinch250320071700
{
      meta:
		author="malware-lu"
		description = "Packer RJoinerbyVaskaSignfrompinch250320071700"
		weight = 4
strings:
...
rule AverCryptor10os1r1s
{
      meta:
		author="malware-lu"
		description = "Packer AverCryptor10os1r1s"
		weight = 4
strings:
...
rule nSpackV23LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer nSpackV23LiuXingPing"
		weight = 4
strings:
...
rule SENDebugProtector
{
      meta:
		author="malware-lu"
		description = "Packer SENDebugProtector"
		weight = 4
strings:
...
rule xPEP03xxIkUg
{
      meta:
		author="malware-lu"
		description = "Packer xPEP03xxIkUg"
		weight = 4
strings:
...
rule AntiDote14SESISTeam
{
      meta:
		author="malware-lu"
		description = "Packer AntiDote14SESISTeam"
		weight = 4
strings:
...
rule NsPack30NorthStar
{
      meta:
		author="malware-lu"
		description = "Packer NsPack30NorthStar"
		weight = 4
strings:
...
rule ORiENV212FisunAV
{
      meta:
		author="malware-lu"
		description = "Packer ORiENV212FisunAV"
		weight = 4
strings:
...
rule NsPackv23NorthStar
{
      meta:
		author="malware-lu"
		description = "Packer NsPackv23NorthStar"
		weight = 4
strings:
...
rule ObsidiumV1342ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV1342ObsidiumSoftware"
		weight = 4
strings:
...
rule SplashBitmapv100WithUnpackCodeBoBBobsoft
{
      meta:
		author="malware-lu"
		description = "Packer SplashBitmapv100WithUnpackCodeBoBBobsoft"
		weight = 4
strings:
...
rule KBySV028shoooo
{
      meta:
		author="malware-lu"
		description = "Packer KBySV028shoooo"
		weight = 4
strings:
...
rule ObsidiumV12XObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV12XObsidiumSoftware"
		weight = 4
strings:
...
rule NsPackV13LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPackV13LiuXingPing"
		weight = 4
strings:
...
rule PseudoSigner01PENinja131Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PENinja131Anorganix"
		weight = 4
strings:
...
rule NTkrnlSecureSuite01015NTkrnlSoftware
{
      meta:
		author="malware-lu"
		description = "Packer NTkrnlSecureSuite01015NTkrnlSoftware"
		weight = 4
strings:
...
rule PEPROTECT09
{
      meta:
		author="malware-lu"
		description = "Packer PEPROTECT09"
		weight = 4
strings:
...
rule EXERefactorV01random
{
      meta:
		author="malware-lu"
		description = "Packer EXERefactorV01random"
		weight = 4
strings:
...
rule CrunchPEv40
{
      meta:
		author="malware-lu"
		description = "Packer CrunchPEv40"
		weight = 4
strings:
...
rule NullsoftPIMPInstallSystemv1x
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftPIMPInstallSystemv1x"
		weight = 4
strings:
...
rule Pohernah100byKas
{
      meta:
		author="malware-lu"
		description = "Packer Pohernah100byKas"
		weight = 4
strings:
...
rule dUP2diablo2oo2
{
      meta:
		author="malware-lu"
		description = "Packer dUP2diablo2oo2"
		weight = 4
strings:
...
rule PseudoSigner01ASPack2xxHeuristicAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01ASPack2xxHeuristicAnorganix"
		weight = 4
strings:
...
rule eXpressorv145CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXpressorv145CGSoftLabs"
		weight = 4
strings:
...
rule hmimysProtectv10
{
      meta:
		author="malware-lu"
		description = "Packer hmimysProtectv10"
		weight = 4
strings:
...
rule VProtectorV10Evcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtectorV10Evcasm"
		weight = 4
strings:
...
rule PseudoSigner01LCCWin32DLLAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01LCCWin32DLLAnorganix"
		weight = 4
strings:
...
rule CodeCryptv014b
{
      meta:
		author="malware-lu"
		description = "Packer CodeCryptv014b"
		weight = 4
strings:
...
rule PellesC450DLLX86CRTLIB
{
      meta:
		author="malware-lu"
		description = "Packer PellesC450DLLX86CRTLIB"
		weight = 4
strings:
...
rule EEXEVersion112
{
      meta:
		author="malware-lu"
		description = "Packer EEXEVersion112"
		weight = 4
strings:
...
rule FSGv120EngdulekxtMASM32TASM32
{
      meta:
		author="malware-lu"
		description = "Packer FSGv120EngdulekxtMASM32TASM32"
		weight = 4
strings:
...
rule PseudoSigner02VBOX43MTEAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02VBOX43MTEAnorganix"
		weight = 4
strings:
...
rule UpackV010V011Dwing
{
      meta:
		author="malware-lu"
		description = "Packer UpackV010V011Dwing"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakePCGuard403415FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakePCGuard403415FEUERRADER"
		weight = 4
strings:
...
rule SimplePack111Method1bagieTMX
{
      meta:
		author="malware-lu"
		description = "Packer SimplePack111Method1bagieTMX"
		weight = 4
strings:
...
rule SoftDefenderv10v11
{
      meta:
		author="malware-lu"
		description = "Packer SoftDefenderv10v11"
		weight = 4
strings:
...
rule XtremeProtectorv106
{
      meta:
		author="malware-lu"
		description = "Packer XtremeProtectorv106"
		weight = 4
strings:
...
rule VcasmProtector1112vcasm
{
      meta:
		author="malware-lu"
		description = "Packer VcasmProtector1112vcasm"
		weight = 4
strings:
...
rule Obsidiumv1111
{
      meta:
		author="malware-lu"
		description = "Packer Obsidiumv1111"
		weight = 4
strings:
...
rule VxEddie1530
{
      meta:
		author="malware-lu"
		description = "Packer VxEddie1530"
		weight = 4
strings:
...
rule KBySV028DLLshoooo
{
      meta:
		author="malware-lu"
		description = "Packer KBySV028DLLshoooo"
		weight = 4
strings:
...
rule PEncrypt10JunkCode
{
      meta:
		author="malware-lu"
		description = "Packer PEncrypt10JunkCode"
		weight = 4
strings:
...
rule PEPasswordv02SMTSMF
{
      meta:
		author="malware-lu"
		description = "Packer PEPasswordv02SMTSMF"
		weight = 4
strings:
...
rule EncryptPE22006710220061025WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPE22006710220061025WFS"
		weight = 4
strings:
...
rule RCryptorv16Vaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv16Vaska"
		weight = 4
strings:
		$a0 = { 33 D0 68 [4] FF D2 }
...
rule PEPaCKv10CCopyright1998byANAKiN
{
      meta:
		author="malware-lu"
		description = "Packer PEPaCKv10CCopyright1998byANAKiN"
		weight = 4
strings:
...
rule YodasProtectorv1032Beta2AshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer YodasProtectorv1032Beta2AshkbizDanehkar"
		weight = 4
strings:
...
rule VxMTEnonencrypted
{
      meta:
		author="malware-lu"
		description = "Packer VxMTEnonencrypted"
		weight = 4
strings:
...
rule PseudoSigner01FSG131Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01FSG131Anorganix"
		weight = 4
strings:
...
rule ASPackv212AlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv212AlexeySolodovnikov"
		weight = 4
strings:
...
rule Upack022023betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack022023betaDwing"
		weight = 4
strings:
...
rule PseudoSigner01CodeLockAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01CodeLockAnorganix"
		weight = 4
strings:
...
rule PKLITEv100c1
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv100c1"
		weight = 4
strings:
...
rule MSLRHv032afakenSPack13emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakenSPack13emadicius"
		weight = 4
strings:
...
rule PKLITEv100c2
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv100c2"
		weight = 4
strings:
...
rule kkrunchyv017FGiesen
{
      meta:
		author="malware-lu"
		description = "Packer kkrunchyv017FGiesen"
		weight = 4
strings:
...
rule ACProtectv190gRiscosoftwareInc
{
      meta:
		author="malware-lu"
		description = "Packer ACProtectv190gRiscosoftwareInc"
		weight = 4
strings:
...
rule UPX293300LZMAMarkusOberhumerLaszloMolnarJohnReiser
{
      meta:
		author="malware-lu"
		description = "Packer UPX293300LZMAMarkusOberhumerLaszloMolnarJohnReiser"
		weight = 4
strings:
...
rule Obsidium133720070623ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium133720070623ObsidiumSoftware"
		weight = 4
strings:
...
rule ASPackv2000AlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv2000AlexeySolodovnikov"
		weight = 4
strings:
...
rule Armadillov4000053SiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov4000053SiliconRealmsToolworks"
		weight = 4
strings:
...
rule Armadillov160a
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov160a"
		weight = 4
strings:
...
rule ACProtectUltraProtect10X20XRiSco
{
      meta:
		author="malware-lu"
		description = "Packer ACProtectUltraProtect10X20XRiSco"
		weight = 4
strings:
...
rule Thinstall3035Jtit
{
      meta:
		author="malware-lu"
		description = "Packer Thinstall3035Jtit"
		weight = 4
strings:
...
rule PENinjav10DzAkRAkerTNT
{
      meta:
		author="malware-lu"
		description = "Packer PENinjav10DzAkRAkerTNT"
		weight = 4
strings:
...
rule ThinstallEmbedded19XJitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded19XJitit"
		weight = 4
strings:
...
rule EXECryptorv13045
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptorv13045"
		weight = 4
strings:
...
rule Obsidium1338ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1338ObsidiumSoftware"
		weight = 4
strings:
...
rule yCv13byAshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yCv13byAshkbizDanehkar"
		weight = 4
strings:
...
rule PCPECalphapreview
{
      meta:
		author="malware-lu"
		description = "Packer PCPECalphapreview"
		weight = 4
strings:
...
rule AlexProtectorv10Alex
{
      meta:
		author="malware-lu"
		description = "Packer AlexProtectorv10Alex"
		weight = 4
strings:
...
rule AHPack01FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHPack01FEUERRADER"
		weight = 4
strings:
...
rule SentinelSuperProAutomaticProtectionv640Safenet
{
      meta:
		author="malware-lu"
		description = "Packer SentinelSuperProAutomaticProtectionv640Safenet"
		weight = 4
strings:
...
rule Pohernah103byKas
{
      meta:
		author="malware-lu"
		description = "Packer Pohernah103byKas"
		weight = 4
strings:
...
rule ObsidiumV1258ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV1258ObsidiumSoftware"
		weight = 4
strings:
...
rule nPackv11150200BetaNEOx
{
      meta:
		author="malware-lu"
		description = "Packer nPackv11150200BetaNEOx"
		weight = 4
strings:
...
rule PerlApp602ActiveState
{
      meta:
		author="malware-lu"
		description = "Packer PerlApp602ActiveState"
		weight = 4
strings:
...
rule UPXProtectorv10x2
{
      meta:
		author="malware-lu"
		description = "Packer UPXProtectorv10x2"
		weight = 4
strings:
...
rule ThinstallEmbedded2501Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded2501Jitit"
		weight = 4
strings:
...
rule CodeVirtualizer1310OreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer CodeVirtualizer1310OreansTechnologies"
		weight = 4
strings:
...
rule VProtector13Xvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtector13Xvcasm"
		weight = 4
strings:
...
rule Packman0001bubba
{
      meta:
		author="malware-lu"
		description = "Packer Packman0001bubba"
		weight = 4
strings:
...
rule SimplePackV11XV12XMethod1bagie
{
      meta:
		author="malware-lu"
		description = "Packer SimplePackV11XV12XMethod1bagie"
		weight = 4
strings:
...
rule PEEncryptv40bJunkCode
{
      meta:
		author="malware-lu"
		description = "Packer PEEncryptv40bJunkCode"
		weight = 4
strings:
		$a0 = { 66 [2] 00 66 83 ?? 00 }
...
rule PEQuake006forgat
{
      meta:
		author="malware-lu"
		description = "Packer PEQuake006forgat"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakePELockNT204FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakePELockNT204FEUERRADER"
		weight = 4
strings:
...
rule eXPressorPacK150XCGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressorPacK150XCGSoftLabs"
		weight = 4
strings:
...
rule D1S1Gv11BetaScrambledEXED1N
{
      meta:
		author="malware-lu"
		description = "Packer D1S1Gv11BetaScrambledEXED1N"
		weight = 4
strings:
...
rule ReversingLabsProtector074betaAp0x
{
      meta:
		author="malware-lu"
		description = "Packer ReversingLabsProtector074betaAp0x"
		weight = 4
strings:
...
rule ACProtect109gRiscosoftwareInc
{
      meta:
		author="malware-lu"
		description = "Packer ACProtect109gRiscosoftwareInc"
		weight = 4
strings:
...
rule NorthStarPEShrinker13Liuxingping
{
      meta:
		author="malware-lu"
		description = "Packer NorthStarPEShrinker13Liuxingping"
		weight = 4
strings:
...
rule FreeJoinerSmallbuild035GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoinerSmallbuild035GlOFF"
		weight = 4
strings:
...
rule Upack020betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack020betaDwing"
		weight = 4
strings:
...
rule UPX20030XMarkusOberhumerLaszloMolnarJohnReiser
{
      meta:
		author="malware-lu"
		description = "Packer UPX20030XMarkusOberhumerLaszloMolnarJohnReiser"
		weight = 4
strings:
...
rule WinUpackv039finalByDwingc2005h1
{
      meta:
		author="malware-lu"
		description = "Packer WinUpackv039finalByDwingc2005h1"
		weight = 4
strings:
...
rule UnnamedScrambler12Bp0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler12Bp0ke"
		weight = 4
strings:
...
rule Upack010012betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack010012betaDwing"
		weight = 4
strings:
...
rule PEArmorV07Xhying
{
      meta:
		author="malware-lu"
		description = "Packer PEArmorV07Xhying"
		weight = 4
strings:
...
rule LauncherGeneratorv103
{
      meta:
		author="malware-lu"
		description = "Packer LauncherGeneratorv103"
		weight = 4
strings:
...
rule yodasProtector102103AshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtector102103AshkbizDanehkar"
		weight = 4
strings:
...
rule NakedPacker10byBigBoote
{
      meta:
		author="malware-lu"
		description = "Packer NakedPacker10byBigBoote"
		weight = 4
strings:
...
rule PseudoSigner01YodasProtector102Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01YodasProtector102Anorganix"
		weight = 4
strings:
...
rule VProtector11Xvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtector11Xvcasm"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMASM32
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMASM32"
		weight = 4
strings:
...
rule Pohernah102byKas
{
      meta:
		author="malware-lu"
		description = "Packer Pohernah102byKas"
		weight = 4
strings:
...
rule ActiveMARK5xTrymediaSystemsInc
{
      meta:
		author="malware-lu"
		description = "Packer ActiveMARK5xTrymediaSystemsInc"
		weight = 4
strings:
...
rule RCryptorv20HideEPVaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv20HideEPVaska"
		weight = 4
strings:
...
rule Armadillov172v173
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov172v173"
		weight = 4
strings:
...
rule AsCryptv01SToRM2
{
      meta:
		author="malware-lu"
		description = "Packer AsCryptv01SToRM2"
		weight = 4
strings:
...
rule AsCryptv01SToRM3
{
      meta:
		author="malware-lu"
		description = "Packer AsCryptv01SToRM3"
		weight = 4
strings:
...
rule ASProtectV2XDLLAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectV2XDLLAlexeySolodovnikov"
		weight = 4
strings:
...
rule AsCryptv01SToRM4
{
      meta:
		author="malware-lu"
		description = "Packer AsCryptv01SToRM4"
		weight = 4
strings:
...
rule yzpack20UsAr
{
      meta:
		author="malware-lu"
		description = "Packer yzpack20UsAr"
		weight = 4
strings:
...
rule PasswordprotectormySMT
{
      meta:
		author="malware-lu"
		description = "Packer PasswordprotectormySMT"
		weight = 4
strings:
...
rule ObsidiumV1258V133XObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV1258V133XObsidiumSoftware"
		weight = 4
strings:
...
rule ReflexiveArcadeWrapper
{
      meta:
		author="malware-lu"
		description = "Packer ReflexiveArcadeWrapper"
		weight = 4
strings:
...
rule VxTrojanTelefoon
{
      meta:
		author="malware-lu"
		description = "Packer VxTrojanTelefoon"
		weight = 4
strings:
...
rule Upackv030betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv030betaDwing"
		weight = 4
strings:
...
rule VxACMEClonewarMutant
{
      meta:
		author="malware-lu"
		description = "Packer VxACMEClonewarMutant"
		weight = 4
strings:
...
rule Armadillov2xxCopyMemII
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov2xxCopyMemII"
		weight = 4
strings:
...
rule TPACKv05cm1
{
      meta:
		author="malware-lu"
		description = "Packer TPACKv05cm1"
		weight = 4
strings:
...
rule EXEStealthv271
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv271"
		weight = 4
strings:
...
rule TPACKv05cm2
{
      meta:
		author="malware-lu"
		description = "Packer TPACKv05cm2"
		weight = 4
strings:
...
rule ExeJoiner10Yodaf2f
{
      meta:
		author="malware-lu"
		description = "Packer ExeJoiner10Yodaf2f"
		weight = 4
strings:
...
rule ASPackv101bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv101bAlexeySolodovnikov"
		weight = 4
strings:
...
rule MacromediaWindowsFlashProjectorPlayerv30
{
      meta:
		author="malware-lu"
		description = "Packer MacromediaWindowsFlashProjectorPlayerv30"
		weight = 4
strings:
...
rule PESpinV11cyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESpinV11cyberbob"
		weight = 4
strings:
...
rule RLPack118aPlib043ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPack118aPlib043ap0x"
		weight = 4
strings:
...
rule DotFixNiceProtectvna
{
      meta:
		author="malware-lu"
		description = "Packer DotFixNiceProtectvna"
		weight = 4
strings:
...
rule PackItBitch10archphase
{
      meta:
		author="malware-lu"
		description = "Packer PackItBitch10archphase"
		weight = 4
strings:
...
rule JDPack2xJDPack
{
      meta:
		author="malware-lu"
		description = "Packer JDPack2xJDPack"
		weight = 4
strings:
...
rule RPolyCryptv10personalpolycryptorsignfrompinch
{
      meta:
		author="malware-lu"
		description = "Packer RPolyCryptv10personalpolycryptorsignfrompinch"
		weight = 4
strings:
...
rule Upackv031betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv031betaDwing"
		weight = 4
strings:
...
rule Packmanv0001
{
      meta:
		author="malware-lu"
		description = "Packer Packmanv0001"
		weight = 4
strings:
...
rule PseudoSigner01PEPack099Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PEPack099Anorganix"
		weight = 4
strings:
...
rule EXECryptor239minimumprotection
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor239minimumprotection"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMicrosoftVisualC60ASM
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMicrosoftVisualC60ASM"
		weight = 4
strings:
...
rule HaspdongleAlladin
{
      meta:
		author="malware-lu"
		description = "Packer HaspdongleAlladin"
		weight = 4
strings:
...
rule PKLITEv112v115v1201
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv112v115v1201"
		weight = 4
strings:
...
rule PKLITEv112v115v1202
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv112v115v1202"
		weight = 4
strings:
...
rule EXECryptorv153
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptorv153"
		weight = 4
strings:
...
rule MSLRHv032afakeEXE32Pack13xemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeEXE32Pack13xemadicius"
		weight = 4
strings:
...
rule eXpressorv11CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXpressorv11CGSoftLabs"
		weight = 4
strings:
...
rule NsPackV11LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPackV11LiuXingPing"
		weight = 4
strings:
...
rule PrivatePersonalPackerPPPv102ConquestOfTroycom
{
      meta:
		author="malware-lu"
		description = "Packer PrivatePersonalPackerPPPv102ConquestOfTroycom"
		weight = 4
strings:
...
rule VxHorse1776
{
      meta:
		author="malware-lu"
		description = "Packer VxHorse1776"
		weight = 4
strings:
...
rule DrWebVirusFindingEngineInSoftEDVSysteme
{
      meta:
		author="malware-lu"
		description = "Packer DrWebVirusFindingEngineInSoftEDVSysteme"
		weight = 4
strings:
...
rule PluginToExev100BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PluginToExev100BoBBobSoft"
		weight = 4
strings:
...
rule RCryptorv15PrivateVaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv15PrivateVaska"
		weight = 4
strings:
...
rule NeoLitev200
{
      meta:
		author="malware-lu"
		description = "Packer NeoLitev200"
		weight = 4
strings:
...
rule PKLITEv200bextra
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv200bextra"
		weight = 4
strings:
...
rule Crunch5Fusion4
{
      meta:
		author="malware-lu"
		description = "Packer Crunch5Fusion4"
		weight = 4
strings:
...
rule MSLRHv032afakePEBundle023xemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePEBundle023xemadicius"
		weight = 4
strings:
...
rule WWPACKv302v302av304Relocationspack
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv302v302av304Relocationspack"
		weight = 4
strings:
...
rule UPXProtectorv10x
{
      meta:
		author="malware-lu"
		description = "Packer UPXProtectorv10x"
		weight = 4
strings:
...
rule NorthStarPEShrinkerv13byLiuxingping
{
      meta:
		author="malware-lu"
		description = "Packer NorthStarPEShrinkerv13byLiuxingping"
		weight = 4
strings:
...
rule CodeCryptv015b
{
      meta:
		author="malware-lu"
		description = "Packer CodeCryptv015b"
		weight = 4
strings:
...
rule RLPackFullEdition117Ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEdition117Ap0x"
		weight = 4
strings:
...
rule PECompactv100
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv100"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeASProtect10FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeASProtect10FEUERRADER"
		weight = 4
strings:
...
rule VxKBDflags1024
{
      meta:
		author="malware-lu"
		description = "Packer VxKBDflags1024"
		weight = 4
strings:
...
rule yodasProtectorV102AshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtectorV102AshkbizDanehkar"
		weight = 4
strings:
...
rule Obsidium1311ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1311ObsidiumSoftware"
		weight = 4
strings:
...
rule PseudoSigner01MicrosoftVisualC620Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MicrosoftVisualC620Anorganix"
		weight = 4
strings:
...
rule MEGALITEv120a
{
      meta:
		author="malware-lu"
		description = "Packer MEGALITEv120a"
		weight = 4
strings:
...
rule GoatsMutilatorV16Goat_e0f
{
      meta:
		author="malware-lu"
		description = "Packer GoatsMutilatorV16Goat_e0f"
		weight = 4
strings:
...
rule Armadillo430aSiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillo430aSiliconRealmsToolworks"
		weight = 4
strings:
...
rule Upackv038betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv038betaDwing"
		weight = 4
strings:
...
rule DCryptPrivate09bdrmist
{
      meta:
		author="malware-lu"
		description = "Packer DCryptPrivate09bdrmist"
		weight = 4
strings:
...
rule kkrunchyV02XRyd
{
      meta:
		author="malware-lu"
		description = "Packer kkrunchyV02XRyd"
		weight = 4
strings:
...
rule SkDUndetectabler3NoFSG2MethodSkD
{
      meta:
		author="malware-lu"
		description = "Packer SkDUndetectabler3NoFSG2MethodSkD"
		weight = 4
strings:
...
rule NTPacker10ErazerZ
{
      meta:
		author="malware-lu"
		description = "Packer NTPacker10ErazerZ"
		weight = 4
strings:
...
rule SexeCrypter11bysantasdad
{
      meta:
		author="malware-lu"
		description = "Packer SexeCrypter11bysantasdad"
		weight = 4
strings:
...
rule VxGotcha879
{
      meta:
		author="malware-lu"
		description = "Packer VxGotcha879"
		weight = 4
strings:
...
rule MZ0oPE106bTaskFall
{
      meta:
		author="malware-lu"
		description = "Packer MZ0oPE106bTaskFall"
		weight = 4
strings:
...
rule Upackv010v012BetaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv010v012BetaDwing"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeBorlandDelphi6070FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeBorlandDelphi6070FEUERRADER"
		weight = 4
strings:
...
rule STProtectorV15SilentSoftware
{
      meta:
		author="malware-lu"
		description = "Packer STProtectorV15SilentSoftware"
		weight = 4
strings:
...
rule ASPackv105bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv105bAlexeySolodovnikov"
		weight = 4
strings:
...
rule EXECryptor226minimumprotection
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor226minimumprotection"
		weight = 4
strings:
...
rule PEProtector093CRYPToCRACk
{
      meta:
		author="malware-lu"
		description = "Packer PEProtector093CRYPToCRACk"
		weight = 4
strings:
...
rule PellesC300400450EXEX86CRTLIB
{
      meta:
		author="malware-lu"
		description = "Packer PellesC300400450EXEX86CRTLIB"
		weight = 4
strings:
...
rule RLPackv118BasicaPLibAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackv118BasicaPLibAp0x"
		weight = 4
strings:
...
rule vfpexeNcV500WangJianGuo
{
      meta:
		author="malware-lu"
		description = "Packer vfpexeNcV500WangJianGuo"
		weight = 4
strings:
...
rule FreeJoiner153Stubengine17GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoiner153Stubengine17GlOFF"
		weight = 4
strings:
...
rule TheHypersprotectorTheHyper
{
      meta:
		author="malware-lu"
		description = "Packer TheHypersprotectorTheHyper"
		weight = 4
strings:
...
rule ANDpakk2006DmitryAndreev
{
      meta:
		author="malware-lu"
		description = "Packer ANDpakk2006DmitryAndreev"
		weight = 4
strings:
...
rule Thinstall2628Jtit
{
      meta:
		author="malware-lu"
		description = "Packer Thinstall2628Jtit"
		weight = 4
strings:
...
rule UPXModifierv01x
{
      meta:
		author="malware-lu"
		description = "Packer UPXModifierv01x"
		weight = 4
strings:
...
rule Obsidium1333ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1333ObsidiumSoftware"
		weight = 4
strings:
...
rule PureBasic4xNeilHodgson
{
      meta:
		author="malware-lu"
		description = "Packer PureBasic4xNeilHodgson"
		weight = 4
strings:
...
rule VxAugust16thIronMaiden
{
      meta:
		author="malware-lu"
		description = "Packer VxAugust16thIronMaiden"
		weight = 4
strings:
...
rule VProtector10Xvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtector10Xvcasm"
		weight = 4
strings:
...
rule Freshbindv20gFresh
{
      meta:
		author="malware-lu"
		description = "Packer Freshbindv20gFresh"
		weight = 4
strings:
...
rule UPXSCRAMBLER306OnToL
{
      meta:
		author="malware-lu"
		description = "Packer UPXSCRAMBLER306OnToL"
		weight = 4
strings:
...
rule PECompact2xxBitSumTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer PECompact2xxBitSumTechnologies"
		weight = 4
strings:
...
rule PESpinv01Cyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESpinv01Cyberbob"
		weight = 4
strings:
...
rule VxEddie2100
{
      meta:
		author="malware-lu"
		description = "Packer VxEddie2100"
		weight = 4
strings:
...
rule NETexecutableMicrosoft
{
      meta:
		author="malware-lu"
		description = "Packer NETexecutableMicrosoft"
		weight = 4
strings:
...
rule AZProtect0001byAlexZakaAZCRC
{
      meta:
		author="malware-lu"
		description = "Packer AZProtect0001byAlexZakaAZCRC"
		weight = 4
strings:
...
rule UPX290LZMAMarkusOberhumerLaszloMolnarJohnReiser
{
      meta:
		author="malware-lu"
		description = "Packer UPX290LZMAMarkusOberhumerLaszloMolnarJohnReiser"
		weight = 4
strings:
...
rule MEW510Northfox
{
      meta:
		author="malware-lu"
		description = "Packer MEW510Northfox"
		weight = 4
strings:
...
rule Obsidium1258ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1258ObsidiumSoftware"
		weight = 4
strings:
...
rule SVKProtectorv132EngPavolCerven
{
      meta:
		author="malware-lu"
		description = "Packer SVKProtectorv132EngPavolCerven"
		weight = 4
strings:
...
rule ExeSplitter12BillPrisonerTPOC
{
      meta:
		author="malware-lu"
		description = "Packer ExeSplitter12BillPrisonerTPOC"
		weight = 4
strings:
...
rule COPv10c1988
{
      meta:
		author="malware-lu"
		description = "Packer COPv10c1988"
		weight = 4
strings:
...
rule PECompactv25RetailSlimLoaderBitsumTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv25RetailSlimLoaderBitsumTechnologies"
		weight = 4
strings:
...
rule Morphinev27Holy_FatherRatter29A
{
      meta:
		author="malware-lu"
		description = "Packer Morphinev27Holy_FatherRatter29A"
		weight = 4
strings:
...
rule diPackerV1XdiProtectorSoftware
{
      meta:
		author="malware-lu"
		description = "Packer diPackerV1XdiProtectorSoftware"
		weight = 4
strings:
...
rule PseudoSigner01REALBasicAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01REALBasicAnorganix"
		weight = 4
strings:
...
rule PPCPROTECT11XAlexeyGorchakov
{
      meta:
		author="malware-lu"
		description = "Packer PPCPROTECT11XAlexeyGorchakov"
		weight = 4
strings:
...
rule nPackV111502006BetaNEOxuinC
{
      meta:
		author="malware-lu"
		description = "Packer nPackV111502006BetaNEOxuinC"
		weight = 4
strings:
...
rule EnigmaProtector11X13XSukhovVladimirSergeNMarkin
{
      meta:
		author="malware-lu"
		description = "Packer EnigmaProtector11X13XSukhovVladimirSergeNMarkin"
		weight = 4
strings:
...
rule HardlockdongleAlladin
{
      meta:
		author="malware-lu"
		description = "Packer HardlockdongleAlladin"
		weight = 4
strings:
...
rule Armadillov190c
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov190c"
		weight = 4
strings:
...
rule Upack_PatchDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack_PatchDwing"
		weight = 4
strings:
...
rule ExeJoinerV10Yodaf2f
{
      meta:
		author="malware-lu"
		description = "Packer ExeJoinerV10Yodaf2f"
		weight = 4
strings:
...
rule PCShrink071beta
{
      meta:
		author="malware-lu"
		description = "Packer PCShrink071beta"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMASM32TASM32
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMASM32TASM32"
		weight = 4
strings:
...
rule PEiDBundlev101BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PEiDBundlev101BoBBobSoft"
		weight = 4
strings:
...
rule RLPack120BasicEditionaPLibAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPack120BasicEditionaPLibAp0x"
		weight = 4
strings:
...
rule AsCryptv01SToRM1
{
      meta:
		author="malware-lu"
		description = "Packer AsCryptv01SToRM1"
		weight = 4
strings:
...
rule SmartEMicrosoft
{
      meta:
		author="malware-lu"
		description = "Packer SmartEMicrosoft"
		weight = 4
strings:
...
rule PE_Admin10EncryptPE12003518SoldFlyingCat
{
      meta:
		author="malware-lu"
		description = "Packer PE_Admin10EncryptPE12003518SoldFlyingCat"
		weight = 4
strings:
...
rule MacromediaWindowsFlashProjectorPlayerv40
{
      meta:
		author="malware-lu"
		description = "Packer MacromediaWindowsFlashProjectorPlayerv40"
		weight = 4
strings:
...
rule WWPack32v100v111v112v120
{
      meta:
		author="malware-lu"
		description = "Packer WWPack32v100v111v112v120"
		weight = 4
strings:
...
rule VProtectorV11vcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtectorV11vcasm"
		weight = 4
strings:
...
rule MaskPE16yzkzero
{
      meta:
		author="malware-lu"
		description = "Packer MaskPE16yzkzero"
		weight = 4
strings:
...
rule bambam001bedrock
{
      meta:
		author="malware-lu"
		description = "Packer bambam001bedrock"
		weight = 4
strings:
...
rule PseudoSigner01MEW11SE10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MEW11SE10Anorganix"
		weight = 4
strings:
...
rule ASProtectv20
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv20"
		weight = 4
strings:
...
rule PseudoSigner01BorlandDelphi6070Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01BorlandDelphi6070Anorganix"
		weight = 4
strings:
...
rule ObsidiumV12ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV12ObsidiumSoftware"
		weight = 4
strings:
...
rule PseudoSigner01PEProtect09Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PEProtect09Anorganix"
		weight = 4
strings:
...
rule WWPack32v1x
{
      meta:
		author="malware-lu"
		description = "Packer WWPack32v1x"
		weight = 4
strings:
...
rule ChSfxsmallv11
{
      meta:
		author="malware-lu"
		description = "Packer ChSfxsmallv11"
		weight = 4
strings:
...
rule UPXModifiedStubcFarbrauschConsumerConsulting
{
      meta:
		author="malware-lu"
		description = "Packer UPXModifiedStubcFarbrauschConsumerConsulting"
		weight = 4
strings:
...
rule PseudoSigner02NorthStarPEShrinker13Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02NorthStarPEShrinker13Anorganix"
		weight = 4
strings:
...
rule tElockv098tE
{
      meta:
		author="malware-lu"
		description = "Packer tElockv098tE"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMicrosoftVisualBasicMASM32
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMicrosoftVisualBasicMASM32"
		weight = 4
strings:
...
rule Upackv022v023BetaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv022v023BetaDwing"
		weight = 4
strings:
...
rule VxVirusConstructorbased
{
      meta:
		author="malware-lu"
		description = "Packer VxVirusConstructorbased"
		weight = 4
strings:
...
rule PseudoSigner02Gleam100Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02Gleam100Anorganix"
		weight = 4
strings:
...
rule DBPEv233DingBoy
{
      meta:
		author="malware-lu"
		description = "Packer DBPEv233DingBoy"
		weight = 4
strings:
...
rule PseudoSigner01PEtite2xlevel0Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PEtite2xlevel0Anorganix"
		weight = 4
strings:
...
rule EPack14litefinalby6aHguT
{
      meta:
		author="malware-lu"
		description = "Packer EPack14litefinalby6aHguT"
		weight = 4
strings:
...
rule tElock098tE
{
      meta:
		author="malware-lu"
		description = "Packer tElock098tE"
		weight = 4
strings:
...
rule UnnamedScrambler10p0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler10p0ke"
		weight = 4
strings:
...
rule WARNINGTROJANADinjector
{
      meta:
		author="malware-lu"
		description = "Packer WARNINGTROJANADinjector"
		weight = 4
strings:
...
rule TopSpeedv3011989
{
      meta:
		author="malware-lu"
		description = "Packer TopSpeedv3011989"
		weight = 4
strings:
...
rule CodeCryptv0164
{
      meta:
		author="malware-lu"
		description = "Packer CodeCryptv0164"
		weight = 4
strings:
...
rule UPXHiT001DJSiba
{
      meta:
		author="malware-lu"
		description = "Packer UPXHiT001DJSiba"
		weight = 4
strings:
...
rule PseudoSigner01ASProtectAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01ASProtectAnorganix"
		weight = 4
strings:
...
rule PocketPCARM
{
      meta:
		author="malware-lu"
		description = "Packer PocketPCARM"
		weight = 4
strings:
...
rule AnskyaBinderv11Anskya
{
      meta:
		author="malware-lu"
		description = "Packer AnskyaBinderv11Anskya"
		weight = 4
strings:
...
rule VProtectorV10Bvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtectorV10Bvcasm"
		weight = 4
strings:
...
rule SecurePE1Xwwwdeepzoneorg
{
      meta:
		author="malware-lu"
		description = "Packer SecurePE1Xwwwdeepzoneorg"
		weight = 4
strings:
...
rule yPv10bbyAshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yPv10bbyAshkbizDanehkar"
		weight = 4
strings:
...
rule Upackv039finalDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv039finalDwing"
		weight = 4
strings:
...
rule vprotector12vcasm
{
      meta:
		author="malware-lu"
		description = "Packer vprotector12vcasm"
		weight = 4
strings:
...
rule FakeNinjav28Spirit
{
      meta:
		author="malware-lu"
		description = "Packer FakeNinjav28Spirit"
		weight = 4
strings:
...
rule PECompactv133
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv133"
		weight = 4
strings:
...
rule DragonArmorOrient
{
      meta:
		author="malware-lu"
		description = "Packer DragonArmorOrient"
		weight = 4
strings:
...
rule ThemidaWinLicenseV1802OreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer ThemidaWinLicenseV1802OreansTechnologies"
		weight = 4
strings:
...
rule SoftDefender1xRandyLi
{
      meta:
		author="malware-lu"
		description = "Packer SoftDefender1xRandyLi"
		weight = 4
strings:
...
rule PellesC2x4xDLLPelleOrinius
{
      meta:
		author="malware-lu"
		description = "Packer PellesC2x4xDLLPelleOrinius"
		weight = 4
strings:
...
rule UPX290LZMADelphistubMarkusOberhumerLaszloMolnarJohnReiser
{
      meta:
		author="malware-lu"
		description = "Packer UPX290LZMADelphistubMarkusOberhumerLaszloMolnarJohnReiser"
		weight = 4
strings:
...
rule RLPackV119aPlib043ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV119aPlib043ap0x"
		weight = 4
strings:
...
rule VirogensPEShrinkerv014
{
      meta:
		author="malware-lu"
		description = "Packer VirogensPEShrinkerv014"
		weight = 4
strings:
...
rule FSGv110EngdulekxtBorlandDelphiBorlandC
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtBorlandDelphiBorlandC"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point or $a1 at pe.entry_point or $a2 at pe.entry_point
}
...
rule PseudoSigner01ACProtect109Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01ACProtect109Anorganix"
		weight = 4
strings:
...
rule RCryptorV16dVaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorV16dVaska"
		weight = 4
strings:
...
rule Upackv032BetaPatchDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv032BetaPatchDwing"
		weight = 4
strings:
...
rule Apex30alpha500mhz
{
      meta:
		author="malware-lu"
		description = "Packer Apex30alpha500mhz"
		weight = 4
strings:
...
rule SimbiOZPoly21Extranger
{
      meta:
		author="malware-lu"
		description = "Packer SimbiOZPoly21Extranger"
		weight = 4
strings:
...
rule Armadillov184
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov184"
		weight = 4
strings:
...
rule Armadillov183
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov183"
		weight = 4
strings:
...
rule Armadillov182
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov182"
		weight = 4
strings:
...
rule Armadillov180
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov180"
		weight = 4
strings:
...
rule ExeSplitter13SplitMethodBillPrisonerTPOC
{
      meta:
		author="malware-lu"
		description = "Packer ExeSplitter13SplitMethodBillPrisonerTPOC"
		weight = 4
strings:
...
rule RJoiner12aVaska
{
      meta:
		author="malware-lu"
		description = "Packer RJoiner12aVaska"
		weight = 4
strings:
...
rule VxVirusConstructorIVPbased
{
      meta:
		author="malware-lu"
		description = "Packer VxVirusConstructorIVPbased"
		weight = 4
strings:
...
rule EncryptPE12003518WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPE12003518WFS"
		weight = 4
strings:
...
rule PECompactv168v184
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv168v184"
		weight = 4
strings:
...
rule SDProtectorProEdition116RandyLi
{
      meta:
		author="malware-lu"
		description = "Packer SDProtectorProEdition116RandyLi"
		weight = 4
strings:
...
rule Reg2Exe222223byJanVorel
{
      meta:
		author="malware-lu"
		description = "Packer Reg2Exe222223byJanVorel"
		weight = 4
strings:
...
rule FSGv120EngdulekxtBorlandDelphiMicrosoftVisualC
{
      meta:
		author="malware-lu"
		description = "Packer FSGv120EngdulekxtBorlandDelphiMicrosoftVisualC"
		weight = 4
strings:
...
rule CICompressv10
{
      meta:
		author="malware-lu"
		description = "Packer CICompressv10"
		weight = 4
strings:
...
rule ExeShieldv27b
{
      meta:
		author="malware-lu"
		description = "Packer ExeShieldv27b"
		weight = 4
strings:
...
rule UPXInlinerv10byGPcH
{
      meta:
		author="malware-lu"
		description = "Packer UPXInlinerv10byGPcH"
		weight = 4
strings:
...
rule PKLITEv114v120
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv114v120"
		weight = 4
strings:
...
rule ExeToolsCOM2EXE
{
      meta:
		author="malware-lu"
		description = "Packer ExeToolsCOM2EXE"
		weight = 4
strings:
...
rule ThinstallEmbedded2545Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded2545Jitit"
		weight = 4
strings:
...
rule Armadillo3X5XSiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillo3X5XSiliconRealmsToolworks"
		weight = 4
strings:
...
rule MSLRHv032afakePESHiELD025emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePESHiELD025emadicius"
		weight = 4
strings:
...
rule Armadillov252beta2
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov252beta2"
		weight = 4
strings:
...
rule CipherWallSelfExtratorDecryptorConsolev15
{
      meta:
		author="malware-lu"
		description = "Packer CipherWallSelfExtratorDecryptorConsolev15"
		weight = 4
strings:
...
rule PCShrinkerv029
{
      meta:
		author="malware-lu"
		description = "Packer PCShrinkerv029"
		weight = 4
strings:
...
rule NsPacKV33LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPacKV33LiuXingPing"
		weight = 4
strings:
...
rule CopyMinderMicrocosmLtd
{
      meta:
		author="malware-lu"
		description = "Packer CopyMinderMicrocosmLtd"
		weight = 4
strings:
...
rule Crunchv5BitArts
{
      meta:
		author="malware-lu"
		description = "Packer Crunchv5BitArts"
		weight = 4
strings:
...
rule PCShrinkerv020
{
      meta:
		author="malware-lu"
		description = "Packer PCShrinkerv020"
		weight = 4
strings:
...
rule Armadillo500SiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillo500SiliconRealmsToolworks"
		weight = 4
strings:
...
rule SLVc0deProtector060SLVICU
{
      meta:
		author="malware-lu"
		description = "Packer SLVc0deProtector060SLVICU"
		weight = 4
strings:
...
rule CrackStopv101cStefanEsser1997
{
      meta:
		author="malware-lu"
		description = "Packer CrackStopv101cStefanEsser1997"
		weight = 4
strings:
...
rule PassLock2000v10EngMoonlightSoftware
{
      meta:
		author="malware-lu"
		description = "Packer PassLock2000v10EngMoonlightSoftware"
		weight = 4
strings:
...
rule Upackv029Betav031BetaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv029Betav031BetaDwing"
		weight = 4
strings:
...
rule AlexProtector10beta2byAlex
{
      meta:
		author="malware-lu"
		description = "Packer AlexProtector10beta2byAlex"
		weight = 4
strings:
...
rule MoleBoxv254Teggo
{
      meta:
		author="malware-lu"
		description = "Packer MoleBoxv254Teggo"
		weight = 4
strings:
...
rule Obsidium1337ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1337ObsidiumSoftware"
		weight = 4
strings:
...
rule PESpinv03Engcyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESpinv03Engcyberbob"
		weight = 4
strings:
...
rule PseudoSigner02PEPack099Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02PEPack099Anorganix"
		weight = 4
strings:
...
rule VterminalV10XLeiPeng
{
      meta:
		author="malware-lu"
		description = "Packer VterminalV10XLeiPeng"
		weight = 4
strings:
...
rule PEEncrypt10Liwuyue
{
      meta:
		author="malware-lu"
		description = "Packer PEEncrypt10Liwuyue"
		weight = 4
strings:
...
rule InstallAnywhere61ZeroGSoftwareInc
{
      meta:
		author="malware-lu"
		description = "Packer InstallAnywhere61ZeroGSoftwareInc"
		weight = 4
strings:
...
rule iLUCRYPTv4018exe
{
      meta:
		author="malware-lu"
		description = "Packer iLUCRYPTv4018exe"
		weight = 4
strings:
...
rule PseudoSigner02ASProtectAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02ASProtectAnorganix"
		weight = 4
strings:
...
rule EncryptPEV22006710WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPEV22006710WFS"
		weight = 4
strings:
...
rule Themida10xx18xxnocompressionOreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer Themida10xx18xxnocompressionOreansTechnologies"
		weight = 4
strings:
...
rule StonesPEEncryptorv10
{
      meta:
		author="malware-lu"
		description = "Packer StonesPEEncryptorv10"
		weight = 4
strings:
...
rule PolyBoxDAnskya
{
      meta:
		author="malware-lu"
		description = "Packer PolyBoxDAnskya"
		weight = 4
strings:
...
rule Mew10execoder10NorthfoxHCC
{
      meta:
		author="malware-lu"
		description = "Packer Mew10execoder10NorthfoxHCC"
		weight = 4
strings:
...
rule RLPackV119LZMA430ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV119LZMA430ap0x"
		weight = 4
strings:
...
rule ENIGMAProtectorV112SukhovVladimir
{
      meta:
		author="malware-lu"
		description = "Packer ENIGMAProtectorV112SukhovVladimir"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeASPack212FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeASPack212FEUERRADER"
		weight = 4
strings:
...
rule MacromediaWindowsFlashProjectorPlayerv50
{
      meta:
		author="malware-lu"
		description = "Packer MacromediaWindowsFlashProjectorPlayerv50"
		weight = 4
strings:
...
rule IDApplicationProtector12IDSecuritySuite
{
      meta:
		author="malware-lu"
		description = "Packer IDApplicationProtector12IDSecuritySuite"
		weight = 4
strings:
...
rule WWPACKv305c4ExtractablePasswordchecking
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4ExtractablePasswordchecking"
		weight = 4
strings:
...
rule HASPHLProtectionV1XAladdin
{
      meta:
		author="malware-lu"
		description = "Packer HASPHLProtectionV1XAladdin"
		weight = 4
strings:
...
rule ASProtectv10
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv10"
		weight = 4
strings:
...
rule ASProtectv11
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv11"
		weight = 4
strings:
...
rule Armadillov275a
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov275a"
		weight = 4
strings:
...
rule PseudoSigner0132Lite003Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner0132Lite003Anorganix"
		weight = 4
strings:
...
rule BeRoEXEPackerv100DLLLZBRSBeRoFarbrausch
{
      meta:
		author="malware-lu"
		description = "Packer BeRoEXEPackerv100DLLLZBRSBeRoFarbrausch"
		weight = 4
strings:
...
rule LaunchAnywherev4001
{
      meta:
		author="malware-lu"
		description = "Packer LaunchAnywherev4001"
		weight = 4
strings:
...
rule Upackv033v034BetaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv033v034BetaDwing"
		weight = 4
strings:
...
rule GameGuardnProtect
{
      meta:
		author="malware-lu"
		description = "Packer GameGuardnProtect"
		weight = 4
strings:
...
rule yodasProtectorV1032AshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtectorV1032AshkbizDanehkar"
		weight = 4
strings:
...
rule AnslymFUDCrypter
{
      meta:
		author="malware-lu"
		description = "Packer AnslymFUDCrypter"
		weight = 4
strings:
...
rule EPExEPackV10EliteCodingGroup
{
      meta:
		author="malware-lu"
		description = "Packer EPExEPackV10EliteCodingGroup"
		weight = 4
strings:
...
rule SimplePack12build3009Method2bagie
{
      meta:
		author="malware-lu"
		description = "Packer SimplePack12build3009Method2bagie"
		weight = 4
strings:
...
rule WinZip32bitSFXv6xmodule
{
      meta:
		author="malware-lu"
		description = "Packer WinZip32bitSFXv6xmodule"
		weight = 4
strings:
...
rule VideoLanClient
{
      meta:
		author="malware-lu"
		description = "Packer VideoLanClient"
		weight = 4
strings:
...
rule CrunchPEv10xx
{
      meta:
		author="malware-lu"
		description = "Packer CrunchPEv10xx"
		weight = 4
strings:
...
rule VxTravJack883
{
      meta:
		author="malware-lu"
		description = "Packer VxTravJack883"
		weight = 4
strings:
...
rule RSCsProcessPatcherv151
{
      meta:
		author="malware-lu"
		description = "Packer RSCsProcessPatcherv151"
		weight = 4
strings:
...
rule SecuPackv15
{
      meta:
		author="malware-lu"
		description = "Packer SecuPackv15"
		weight = 4
strings:
...
rule ACProtectV13Xrisco
{
      meta:
		author="malware-lu"
		description = "Packer ACProtectV13Xrisco"
		weight = 4
strings:
...
rule PELockNTv202c
{
      meta:
		author="malware-lu"
		description = "Packer PELockNTv202c"
		weight = 4
strings:
...
rule PseudoSigner02MinGWGCC2xAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02MinGWGCC2xAnorganix"
		weight = 4
strings:
...
rule FreeBASIC016b
{
      meta:
		author="malware-lu"
		description = "Packer FreeBASIC016b"
		weight = 4
strings:
...
rule RCryptorv16bv16cVaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv16bv16cVaska"
		weight = 4
strings:
...
rule SDC12SelfDecryptingBinaryGeneratorbyClaesMNyberg
{
      meta:
		author="malware-lu"
		description = "Packer SDC12SelfDecryptingBinaryGeneratorbyClaesMNyberg"
		weight = 4
strings:
...
rule PKLITEv1501
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv1501"
		weight = 4
strings:
...
rule Inbuildv10hard
{
      meta:
		author="malware-lu"
		description = "Packer Inbuildv10hard"
		weight = 4
strings:
...
rule ExeShieldvxx
{
      meta:
		author="malware-lu"
		description = "Packer ExeShieldvxx"
		weight = 4
strings:
...
rule RCryptorv20Vaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv20Vaska"
		weight = 4
strings:
...
rule PECompactv125
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv125"
		weight = 4
strings:
...
rule RCryptorv1Vaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv1Vaska"
		weight = 4
strings:
...
rule PECompactv122
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv122"
		weight = 4
strings:
...
rule Packmanv10BrandonLaCombe
{
      meta:
		author="malware-lu"
		description = "Packer Packmanv10BrandonLaCombe"
		weight = 4
strings:
...
rule SpecialEXEPaswordProtectorV101EngPavolCerven
{
      meta:
		author="malware-lu"
		description = "Packer SpecialEXEPaswordProtectorV101EngPavolCerven"
		weight = 4
strings:
...
rule ExeSmashervxx
{
      meta:
		author="malware-lu"
		description = "Packer ExeSmashervxx"
		weight = 4
strings:
...
rule PEArmor046ChinaCrackingGroup
{
      meta:
		author="malware-lu"
		description = "Packer PEArmor046ChinaCrackingGroup"
		weight = 4
strings:
...
rule VMProtect106107PolyTech
{
      meta:
		author="malware-lu"
		description = "Packer VMProtect106107PolyTech"
		weight = 4
strings:
...
rule USSR031bySpirit
{
      meta:
		author="malware-lu"
		description = "Packer USSR031bySpirit"
		weight = 4
strings:
...
rule PeCompact253DLLSlimLoaderBitSumTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer PeCompact253DLLSlimLoaderBitSumTechnologies"
		weight = 4
strings:
...
rule LameCryptv10
{
      meta:
		author="malware-lu"
		description = "Packer LameCryptv10"
		weight = 4
strings:
...
rule ASProtectv123RC4build0807exeAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv123RC4build0807exeAlexeySolodovnikov"
		weight = 4
strings:
...
rule Armadillov210b2
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov210b2"
		weight = 4
strings:
...
rule Armadillov190
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov190"
		weight = 4
strings:
...
rule eXPressorProtection150XCGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressorProtection150XCGSoftLabs"
		weight = 4
strings:
...
rule VxNecropolis1963
{
      meta:
		author="malware-lu"
		description = "Packer VxNecropolis1963"
		weight = 4
strings:
...
rule PseudoSigner02UPX06Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02UPX06Anorganix"
		weight = 4
strings:
...
rule PESpinV071cyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESpinV071cyberbob"
		weight = 4
strings:
...
rule XHider10GlobaL
{
      meta:
		author="malware-lu"
		description = "Packer XHider10GlobaL"
		weight = 4
strings:
...
rule PseudoSigner01MicrosoftVisualC70DLLAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MicrosoftVisualC70DLLAnorganix"
		weight = 4
strings:
...
rule EXEShieldV05Smoke
{
      meta:
		author="malware-lu"
		description = "Packer EXEShieldV05Smoke"
		weight = 4
strings:
...
rule UnnamedScrambler25Ap0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler25Ap0ke"
		weight = 4
strings:
...
rule Armadillov177
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov177"
		weight = 4
strings:
...
rule VxTrivial25
{
      meta:
		author="malware-lu"
		description = "Packer VxTrivial25"
		weight = 4
strings:
...
rule Armadillov171
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov171"
		weight = 4
strings:
...
rule KBySV022shoooo
{
      meta:
		author="malware-lu"
		description = "Packer KBySV022shoooo"
		weight = 4
strings:
...
rule InnoSetupModule
{
      meta:
		author="malware-lu"
		description = "Packer InnoSetupModule"
		weight = 4
strings:
...
rule SoftSentryv30
{
      meta:
		author="malware-lu"
		description = "Packer SoftSentryv30"
		weight = 4
strings:
...
rule EncryptPEV22007411WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPEV22007411WFS"
		weight = 4
strings:
...
rule Armadillov19x
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov19x"
		weight = 4
strings:
...
rule Armadillov285
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov285"
		weight = 4
strings:
...
rule ASProtectvxx
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectvxx"
		weight = 4
strings:
...
rule ExeShieldv17
{
      meta:
		author="malware-lu"
		description = "Packer ExeShieldv17"
		weight = 4
strings:
...
rule Splasherv10v30
{
      meta:
		author="malware-lu"
		description = "Packer Splasherv10v30"
		weight = 4
strings:
...
rule FreeCryptor01build002GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeCryptor01build002GlOFF"
		weight = 4
strings:
...
rule EXEShieldV06SMoKE
{
      meta:
		author="malware-lu"
		description = "Packer EXEShieldV06SMoKE"
		weight = 4
strings:
...
rule PseudoSigner02MicrosoftVisualBasic5060Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02MicrosoftVisualBasic5060Anorganix"
		weight = 4
strings:
...
rule RLPack118DllLZMA430ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPack118DllLZMA430ap0x"
		weight = 4
strings:
...
rule PKLITEv100v103
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv100v103"
		weight = 4
strings:
...
rule Shrinkerv34
{
      meta:
		author="malware-lu"
		description = "Packer Shrinkerv34"
		weight = 4
strings:
...
rule Shrinkerv32
{
      meta:
		author="malware-lu"
		description = "Packer Shrinkerv32"
		weight = 4
strings:
...
rule Shrinkerv33
{
      meta:
		author="malware-lu"
		description = "Packer Shrinkerv33"
		weight = 4
strings:
...
rule PseudoSigner01JDPack1xJDProtect09Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01JDPack1xJDProtect09Anorganix"
		weight = 4
strings:
...
rule Upack024027beta028alphaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upack024027beta028alphaDwing"
		weight = 4
strings:
...
rule PseudoSigner01LocklessIntroPackAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01LocklessIntroPackAnorganix"
		weight = 4
strings:
...
rule Armadillov250b3
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov250b3"
		weight = 4
strings:
...
rule PEBundlev02v20x
{
      meta:
		author="malware-lu"
		description = "Packer PEBundlev02v20x"
		weight = 4
strings:
...
rule SoftProtectwwwsoftprotectbyru
{
      meta:
		author="malware-lu"
		description = "Packer SoftProtectwwwsoftprotectbyru"
		weight = 4
strings:
...
rule NTPackerV2XErazerZ
{
      meta:
		author="malware-lu"
		description = "Packer NTPackerV2XErazerZ"
		weight = 4
strings:
...
rule SiliconRealmsInstallStub
{
      meta:
		author="malware-lu"
		description = "Packer SiliconRealmsInstallStub"
		weight = 4
strings:
...
rule Armadillov430v440SiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov430v440SiliconRealmsToolworks"
		weight = 4
strings:
...
rule FucknJoyv10cUsAr
{
      meta:
		author="malware-lu"
		description = "Packer FucknJoyv10cUsAr"
		weight = 4
strings:
...
rule PseudoSigner02VideoLanClientAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02VideoLanClientAnorganix"
		weight = 4
strings:
...
rule AI1Creator1Beta2byMZ
{
      meta:
		author="malware-lu"
		description = "Packer AI1Creator1Beta2byMZ"
		weight = 4
strings:
...
rule PECompactv0978
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv0978"
		weight = 4
strings:
...
rule Setup2GoInstallerStub
{
      meta:
		author="malware-lu"
		description = "Packer Setup2GoInstallerStub"
		weight = 4
strings:
...
rule themida1005httpwwworeanscom
{
      meta:
		author="malware-lu"
		description = "Packer themida1005httpwwworeanscom"
		weight = 4
strings:
...
rule yodasProtectorv1033exescrcomAshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtectorv1033exescrcomAshkbizDanehkar"
		weight = 4
strings:
...
rule ORiENv211DEMO
{
      meta:
		author="malware-lu"
		description = "Packer ORiENv211DEMO"
		weight = 4
strings:
...
rule PECompactv0977
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv0977"
		weight = 4
strings:
...
rule PESpinv13betaCyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESpinv13betaCyberbob"
		weight = 4
strings:
...
rule RCryptorv13bVaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv13bVaska"
		weight = 4
strings:
...
rule mkfpackllydd
{
      meta:
		author="malware-lu"
		description = "Packer mkfpackllydd"
		weight = 4
strings:
...
rule PESpinV03cyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESpinV03cyberbob"
		weight = 4
strings:
...
rule PseudoSigner02BorlandDelphiSetupModuleAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02BorlandDelphiSetupModuleAnorganix"
		weight = 4
strings:
...
rule PELOCKnt204
{
      meta:
		author="malware-lu"
		description = "Packer PELOCKnt204"
		weight = 4
strings:
...
rule MacromediaWindowsFlashProjectorPlayerv60
{
      meta:
		author="malware-lu"
		description = "Packer MacromediaWindowsFlashProjectorPlayerv60"
		weight = 4
strings:
...
rule IMPostorPack10MahdiHezavehi
{
      meta:
		author="malware-lu"
		description = "Packer IMPostorPack10MahdiHezavehi"
		weight = 4
strings:
...
rule PluginToExev102BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PluginToExev102BoBBobSoft"
		weight = 4
strings:
...
rule PrivateexeProtectorV18SetiSoftTeam
{
      meta:
		author="malware-lu"
		description = "Packer PrivateexeProtectorV18SetiSoftTeam"
		weight = 4
strings:
...
rule PENinjamodified
{
      meta:
		author="malware-lu"
		description = "Packer PENinjamodified"
		weight = 4
strings:
...
rule DotFixNiceProtect21GPcHSoft
{
      meta:
		author="malware-lu"
		description = "Packer DotFixNiceProtect21GPcHSoft"
		weight = 4
strings:
...
rule EXEStealthv276WebToolMaster
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv276WebToolMaster"
		weight = 4
strings:
...
rule EXECryptor239DLLcompressedresources
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor239DLLcompressedresources"
		weight = 4
strings:
...
rule UnoPiX103110BaGiE
{
      meta:
		author="malware-lu"
		description = "Packer UnoPiX103110BaGiE"
		weight = 4
strings:
...
rule PECompactv110b3
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv110b3"
		weight = 4
strings:
...
rule IonicWindSoftware
{
      meta:
		author="malware-lu"
		description = "Packer IonicWindSoftware"
		weight = 4
strings:
...
rule SimplePackV11XMethod2bagie
{
      meta:
		author="malware-lu"
		description = "Packer SimplePackV11XMethod2bagie"
		weight = 4
strings:
...
rule PCGuardv500d
{
      meta:
		author="malware-lu"
		description = "Packer PCGuardv500d"
		weight = 4
strings:
...
rule PESHiELDv0251
{
      meta:
		author="malware-lu"
		description = "Packer PESHiELDv0251"
		weight = 4
strings:
...
rule RLPackFullEdition117DLLaPLibAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEdition117DLLaPLibAp0x"
		weight = 4
strings:
...
rule PECompactv110b4
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv110b4"
		weight = 4
strings:
...
rule PseudoSigner02PEX099Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02PEX099Anorganix"
		weight = 4
strings:
...
rule ThinstallVirtualizationSuite30XThinstallCompany
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallVirtualizationSuite30XThinstallCompany"
		weight = 4
strings:
...
rule NullsoftInstallSystemv20
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftInstallSystemv20"
		weight = 4
strings:
...
rule SLVc0deProtectorv11SLV
{
      meta:
		author="malware-lu"
		description = "Packer SLVc0deProtectorv11SLV"
		weight = 4
strings:
...
rule FreeJoinerSmallbuild031032GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoinerSmallbuild031032GlOFF"
		weight = 4
strings:
...
rule SLVc0deProtectorv06SLV
{
      meta:
		author="malware-lu"
		description = "Packer SLVc0deProtectorv06SLV"
		weight = 4
strings:
...
rule PEArmor04600759hying
{
      meta:
		author="malware-lu"
		description = "Packer PEArmor04600759hying"
		weight = 4
strings:
...
rule RpolycryptbyVaska2003071841
{
      meta:
		author="malware-lu"
		description = "Packer RpolycryptbyVaska2003071841"
		weight = 4
strings:
...
rule DBPEvxxxDingBoy
{
      meta:
		author="malware-lu"
		description = "Packer DBPEvxxxDingBoy"
		weight = 4
strings:
...
rule SoftwareCompressBGSoftware
{
      meta:
		author="malware-lu"
		description = "Packer SoftwareCompressBGSoftware"
		weight = 4
strings:
...
rule WWPACKv305c4UnextrPasswcheckVirshield
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4UnextrPasswcheckVirshield"
		weight = 4
strings:
...
rule Upackv0399Dwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv0399Dwing"
		weight = 4
strings:
...
rule UPXModifiedstub
{
      meta:
		author="malware-lu"
		description = "Packer UPXModifiedstub"
		weight = 4
strings:
...
rule Cryptic20Tughack
{
      meta:
		author="malware-lu"
		description = "Packer Cryptic20Tughack"
		weight = 4
strings:
...
rule PECompactv20betaJeremyCollake
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv20betaJeremyCollake"
		weight = 4
strings:
...
rule CRYPToCRACksPEProtectorV092LukasFleischer
{
      meta:
		author="malware-lu"
		description = "Packer CRYPToCRACksPEProtectorV092LukasFleischer"
		weight = 4
strings:
...
rule UpackV037Dwing
{
      meta:
		author="malware-lu"
		description = "Packer UpackV037Dwing"
		weight = 4
strings:
...
rule Obsidiumv13037ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidiumv13037ObsidiumSoftware"
		weight = 4
strings:
...
rule MSLRHv032afakePEtite21emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePEtite21emadicius"
		weight = 4
strings:
...
rule UPXShitv01500mhz
{
      meta:
		author="malware-lu"
		description = "Packer UPXShitv01500mhz"
		weight = 4
strings:
...
rule PackmanV0001Bubbasoft
{
      meta:
		author="malware-lu"
		description = "Packer PackmanV0001Bubbasoft"
		weight = 4
strings:
...
rule DJoinv07publicxorencryptiondrmist
{
      meta:
		author="malware-lu"
		description = "Packer DJoinv07publicxorencryptiondrmist"
		weight = 4
strings:
...
rule FreeJoinerSmallbuild033GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoinerSmallbuild033GlOFF"
		weight = 4
strings:
...
rule AnticrackSoftwareProtectorv109ACProtect
{
      meta:
		author="malware-lu"
		description = "Packer AnticrackSoftwareProtectorv109ACProtect"
		weight = 4
strings:
...
rule UnderGroundCrypterbyBooster2000
{
      meta:
		author="malware-lu"
		description = "Packer UnderGroundCrypterbyBooster2000"
		weight = 4
strings:
...
rule MicroJoiner16coban2k
{
      meta:
		author="malware-lu"
		description = "Packer MicroJoiner16coban2k"
		weight = 4
strings:
...
rule WiseInstallerStubv11010291
{
      meta:
		author="malware-lu"
		description = "Packer WiseInstallerStubv11010291"
		weight = 4
strings:
...
rule PrivateEXEProtector18
{
      meta:
		author="malware-lu"
		description = "Packer PrivateEXEProtector18"
		weight = 4
strings:
...
rule SimpleUPXCryptorv3042005multilayerencryptionMANtiCORE
{
      meta:
		author="malware-lu"
		description = "Packer SimpleUPXCryptorv3042005multilayerencryptionMANtiCORE"
		weight = 4
strings:
...
rule Themida1201compressedOreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer Themida1201compressedOreansTechnologies"
		weight = 4
strings:
...
rule PECompactv155
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv155"
		weight = 4
strings:
...
rule PolyCryptPE214b215JLabSoftwareCreationshsigned
{
      meta:
		author="malware-lu"
		description = "Packer PolyCryptPE214b215JLabSoftwareCreationshsigned"
		weight = 4
strings:
...
rule PECompactv156
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv156"
		weight = 4
strings:
...
rule PGMPACKv013
{
      meta:
		author="malware-lu"
		description = "Packer PGMPACKv013"
		weight = 4
strings:
...
rule PGMPACKv014
{
      meta:
		author="malware-lu"
		description = "Packer PGMPACKv014"
		weight = 4
strings:
...
rule PseudoSigner0232Lite003Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner0232Lite003Anorganix"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakePEtite22FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakePEtite22FEUERRADER"
		weight = 4
strings:
...
rule MEW10byNorthfox
{
      meta:
		author="malware-lu"
		description = "Packer MEW10byNorthfox"
		weight = 4
strings:
...
rule theWRAPbyTronDoc
{
      meta:
		author="malware-lu"
		description = "Packer theWRAPbyTronDoc"
		weight = 4
strings:
...
rule MaskPEV20yzkzero
{
      meta:
		author="malware-lu"
		description = "Packer MaskPEV20yzkzero"
		weight = 4
strings:
...
rule PseudoSigner01Morphine12Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01Morphine12Anorganix"
		weight = 4
strings:
...
rule y0dasCrypterv12
{
      meta:
		author="malware-lu"
		description = "Packer y0dasCrypterv12"
		weight = 4
strings:
...
rule ChinaProtectdummy
{
      meta:
		author="malware-lu"
		description = "Packer ChinaProtectdummy"
		weight = 4
strings:
...
rule BopCryptv10
{
      meta:
		author="malware-lu"
		description = "Packer BopCryptv10"
		weight = 4
strings:
...
rule MinkeV101Codius
{
      meta:
		author="malware-lu"
		description = "Packer MinkeV101Codius"
		weight = 4
strings:
...
rule PseudoSigner02BorlandDelphiDLLAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02BorlandDelphiDLLAnorganix"
		weight = 4
strings:
...
rule bambam004bedrock
{
      meta:
		author="malware-lu"
		description = "Packer bambam004bedrock"
		weight = 4
strings:
...
rule RLPackFullEdition117DLLLZMAAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEdition117DLLLZMAAp0x"
		weight = 4
strings:
...
rule ElicenseSystemV4000ViaTechInc
{
      meta:
		author="malware-lu"
		description = "Packer ElicenseSystemV4000ViaTechInc"
		weight = 4
strings:
...
rule VProtectorV10Build20041213testvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtectorV10Build20041213testvcasm"
		weight = 4
strings:
...
rule Themida18xxOreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer Themida18xxOreansTechnologies"
		weight = 4
strings:
...
rule EXEJoinerv10
{
      meta:
		author="malware-lu"
		description = "Packer EXEJoinerv10"
		weight = 4
strings:
...
rule MicroJoiner11coban2k
{
      meta:
		author="malware-lu"
		description = "Packer MicroJoiner11coban2k"
		weight = 4
strings:
...
rule PseudoSigner01FSG10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01FSG10Anorganix"
		weight = 4
strings:
...
rule Armadillov200b2200b3
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov200b2200b3"
		weight = 4
strings:
...
rule RAZOR1911encruptor
{
      meta:
		author="malware-lu"
		description = "Packer RAZOR1911encruptor"
		weight = 4
strings:
...
rule tElock051tE
{
      meta:
		author="malware-lu"
		description = "Packer tElock051tE"
		weight = 4
strings:
...
rule SDProtectorBasicProEdition112RandyLi
{
      meta:
		author="malware-lu"
		description = "Packer SDProtectorBasicProEdition112RandyLi"
		weight = 4
strings:
...
rule VxFaxFreeTopo
{
      meta:
		author="malware-lu"
		description = "Packer VxFaxFreeTopo"
		weight = 4
strings:
...
rule PseudoSigner02MEW11SE10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02MEW11SE10Anorganix"
		weight = 4
strings:
...
rule Joinersignfrompinch250320072010
{
      meta:
		author="malware-lu"
		description = "Packer Joinersignfrompinch250320072010"
		weight = 4
strings:
...
rule PEStubOEPv1x
{
      meta:
		author="malware-lu"
		description = "Packer PEStubOEPv1x"
		weight = 4
strings:
...
rule MoleBoxV23XMoleStudiocom
{
      meta:
		author="malware-lu"
		description = "Packer MoleBoxV23XMoleStudiocom"
		weight = 4
strings:
...
rule kkrunchyRyd
{
      meta:
		author="malware-lu"
		description = "Packer kkrunchyRyd"
		weight = 4
strings:
...
rule PECryptv100v101
{
      meta:
		author="malware-lu"
		description = "Packer PECryptv100v101"
		weight = 4
strings:
...
rule CERBERUSv20
{
      meta:
		author="malware-lu"
		description = "Packer CERBERUSv20"
		weight = 4
strings:
...
rule EXECryptor2117StrongbitSoftCompleteDevelopment
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor2117StrongbitSoftCompleteDevelopment"
		weight = 4
strings:
...
rule GHFProtectorpackonlyGPcH
{
      meta:
		author="malware-lu"
		description = "Packer GHFProtectorpackonlyGPcH"
		weight = 4
strings:
...
rule yzpackV11UsAr
{
      meta:
		author="malware-lu"
		description = "Packer yzpackV11UsAr"
		weight = 4
strings:
...
rule VxDanishtiny
{
      meta:
		author="malware-lu"
		description = "Packer VxDanishtiny"
		weight = 4
strings:
...
rule UPXV194MarkusOberhumerLaszloMolnarJohnReiser
{
      meta:
		author="malware-lu"
		description = "Packer UPXV194MarkusOberhumerLaszloMolnarJohnReiser"
		weight = 4
strings:
...
rule yzpack112UsAr
{
      meta:
		author="malware-lu"
		description = "Packer yzpack112UsAr"
		weight = 4
strings:
...
rule PseudoSigner02YodasProtector102Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02YodasProtector102Anorganix"
		weight = 4
strings:
...
rule PseudoSigner02PESHiELD025Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02PESHiELD025Anorganix"
		weight = 4
strings:
...
rule NsPacKV34V35LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer NsPacKV34V35LiuXingPing"
		weight = 4
strings:
...
rule NoodleCryptv200EngNoodleSpa
{
      meta:
		author="malware-lu"
		description = "Packer NoodleCryptv200EngNoodleSpa"
		weight = 4
strings:
...
rule SoftComp1xBGSoftPT
{
      meta:
		author="malware-lu"
		description = "Packer SoftComp1xBGSoftPT"
		weight = 4
strings:
...
rule Petite13c1998IanLuck
{
      meta:
		author="malware-lu"
		description = "Packer Petite13c1998IanLuck"
		weight = 4
strings:
...
rule PENightMarev13
{
      meta:
		author="malware-lu"
		description = "Packer PENightMarev13"
		weight = 4
strings:
...
rule Armadillo50DllSiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillo50DllSiliconRealmsToolworks"
		weight = 4
strings:
...
rule ObsidiumV1350ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ObsidiumV1350ObsidiumSoftware"
		weight = 4
strings:
...
rule ASProtectv123RC1
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv123RC1"
		weight = 4
strings:
...
rule PUNiSHERv15DEMOFEUERRADERAHTeam
{
      meta:
		author="malware-lu"
		description = "Packer PUNiSHERv15DEMOFEUERRADERAHTeam"
		weight = 4
strings:
...
rule PECompactv140b2v140b4
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv140b2v140b4"
		weight = 4
strings:
...
rule NullsoftInstallSystemv198
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftInstallSystemv198"
		weight = 4
strings:
...
rule CryptoLockv202EngRyanThian
{
      meta:
		author="malware-lu"
		description = "Packer CryptoLockv202EngRyanThian"
		weight = 4
strings:
...
rule vfpexeNcv600WangJianGuo
{
      meta:
		author="malware-lu"
		description = "Packer vfpexeNcv600WangJianGuo"
		weight = 4
strings:
...
rule PEiDBundlev100BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PEiDBundlev100BoBBobSoft"
		weight = 4
strings:
...
rule PeCompact2253276BitSumTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer PeCompact2253276BitSumTechnologies"
		weight = 4
strings:
...
rule PseudoSigner02CodeLockAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02CodeLockAnorganix"
		weight = 4
strings:
...
rule FSGv100Engdulekxt
{
      meta:
		author="malware-lu"
		description = "Packer FSGv100Engdulekxt"
		weight = 4
strings:
...
rule PseudoSigner01BorlandDelphi50KOLMCKAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01BorlandDelphi50KOLMCKAnorganix"
		weight = 4
strings:
...
rule FlyCrypter10ut1lz
{
      meta:
		author="malware-lu"
		description = "Packer FlyCrypter10ut1lz"
		weight = 4
strings:
...
rule MSLRHv032afakePECompact14xemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePECompact14xemadicius"
		weight = 4
strings:
...
rule muckisprotectorIImucki
{
      meta:
		author="malware-lu"
		description = "Packer muckisprotectorIImucki"
		weight = 4
strings:
...
rule VcasmProtector10
{
      meta:
		author="malware-lu"
		description = "Packer VcasmProtector10"
		weight = 4
strings:
...
rule NullsoftInstallSystemv20b2v20b3
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftInstallSystemv20b2v20b3"
		weight = 4
strings:
...
rule VProtectorV10Dvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtectorV10Dvcasm"
		weight = 4
strings:
...
rule GardianAngel10
{
      meta:
		author="malware-lu"
		description = "Packer GardianAngel10"
		weight = 4
strings:
...
rule RSCsProcessPatcherv14
{
      meta:
		author="malware-lu"
		description = "Packer RSCsProcessPatcherv14"
		weight = 4
strings:
...
rule Armadillov190b1
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov190b1"
		weight = 4
strings:
...
rule Armadillov190b2
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov190b2"
		weight = 4
strings:
...
rule Armadillov190b3
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov190b3"
		weight = 4
strings:
...
rule FSGv110EngdulekxtBorlandDelphiMicrosoftVisualCASM
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtBorlandDelphiMicrosoftVisualCASM"
		weight = 4
strings:
...
rule Thinstall25xxJtit
{
      meta:
		author="malware-lu"
		description = "Packer Thinstall25xxJtit"
		weight = 4
strings:
...
rule hmimysPacker10hmimys
{
      meta:
		author="malware-lu"
		description = "Packer hmimysPacker10hmimys"
		weight = 4
strings:
...
rule ACProtectV20risco
{
      meta:
		author="malware-lu"
		description = "Packer ACProtectV20risco"
		weight = 4
strings:
		$a0 = { 68 [4] 68 [4] C3 C3 }
...
rule RLPackV112V114LZMA430ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV112V114LZMA430ap0x"
		weight = 4
strings:
...
rule PESpinv1304Cyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESpinv1304Cyberbob"
		weight = 4
strings:
...
rule ScObfuscatorSuperCRacker
{
      meta:
		author="malware-lu"
		description = "Packer ScObfuscatorSuperCRacker"
		weight = 4
strings:
...
rule tElock098SpecialBuildforgotheXer
{
      meta:
		author="malware-lu"
		description = "Packer tElock098SpecialBuildforgotheXer"
		weight = 4
strings:
...
rule PseudoSigner01DEF10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01DEF10Anorganix"
		weight = 4
strings:
...
rule PseudoSigner02REALBasicAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02REALBasicAnorganix"
		weight = 4
strings:
...
rule Armadillov260c
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov260c"
		weight = 4
strings:
...
rule Armadillov260a
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov260a"
		weight = 4
strings:
...
rule ThemidaWinLicenseV10XV17XDLLOreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer ThemidaWinLicenseV10XV17XDLLOreansTechnologies"
		weight = 4
strings:
...
rule eXPressor12CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressor12CGSoftLabs"
		weight = 4
strings:
...
rule ExeBundlev30standardloader
{
      meta:
		author="malware-lu"
		description = "Packer ExeBundlev30standardloader"
		weight = 4
strings:
...
rule ProtectionPlusvxx
{
      meta:
		author="malware-lu"
		description = "Packer ProtectionPlusvxx"
		weight = 4
strings:
...
rule EXECryptorV22Xsoftcompletecom
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptorV22Xsoftcompletecom"
		weight = 4
strings:
...
rule ThinstallVirtualizationSuite30353043ThinstallCompany
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallVirtualizationSuite30353043ThinstallCompany"
		weight = 4
strings:
...
rule PseudoSigner01CrunchPEHeuristicAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01CrunchPEHeuristicAnorganix"
		weight = 4
strings:
...
rule FSGv120EngdulekxtBorlandC
{
      meta:
		author="malware-lu"
		description = "Packer FSGv120EngdulekxtBorlandC"
		weight = 4
strings:
...
rule EXEPACKv405v406
{
      meta:
		author="malware-lu"
		description = "Packer EXEPACKv405v406"
		weight = 4
strings:
...
rule EXEShieldv01bv03bv03SMoKE
{
      meta:
		author="malware-lu"
		description = "Packer EXEShieldv01bv03bv03SMoKE"
		weight = 4
strings:
...
rule PEArmor049Hying
{
      meta:
		author="malware-lu"
		description = "Packer PEArmor049Hying"
		weight = 4
strings:
...
rule PECompactv14x
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv14x"
		weight = 4
strings:
...
rule PocketPCSHA
{
      meta:
		author="malware-lu"
		description = "Packer PocketPCSHA"
		weight = 4
strings:
...
rule Thinstall25
{
      meta:
		author="malware-lu"
		description = "Packer Thinstall25"
		weight = 4
strings:
...
rule SuckStopv111
{
      meta:
		author="malware-lu"
		description = "Packer SuckStopv111"
		weight = 4
strings:
...
rule UnnamedScrambler251Beta2252p0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler251Beta2252p0ke"
		weight = 4
strings:
...
rule PrivateEXEProtector18SetiSoft
{
      meta:
		author="malware-lu"
		description = "Packer PrivateEXEProtector18SetiSoft"
		weight = 4
strings:
...
rule PseudoSigner02Armadillo300Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02Armadillo300Anorganix"
		weight = 4
strings:
...
rule hmimyssPEPack01hmimys
{
      meta:
		author="malware-lu"
		description = "Packer hmimyssPEPack01hmimys"
		weight = 4
strings:
...
rule PECompactv146
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv146"
		weight = 4
strings:
...
rule PseudoSigner02XCR011Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02XCR011Anorganix"
		weight = 4
strings:
...
rule EXEPACKLINKv360v364v365or50121
{
      meta:
		author="malware-lu"
		description = "Packer EXEPACKLINKv360v364v365or50121"
		weight = 4
strings:
...
rule SpecialEXEPasswordProtectorv10
{
      meta:
		author="malware-lu"
		description = "Packer SpecialEXEPasswordProtectorv10"
		weight = 4
strings:
...
rule RCryptor15Vaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptor15Vaska"
		weight = 4
strings:
...
rule ExeJoiner10Yoda
{
      meta:
		author="malware-lu"
		description = "Packer ExeJoiner10Yoda"
		weight = 4
strings:
...
rule RLPackV119DllaPlib043ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV119DllaPlib043ap0x"
		weight = 4
strings:
...
rule CrypKeyV56XKenonicControlsLtd
{
      meta:
		author="malware-lu"
		description = "Packer CrypKeyV56XKenonicControlsLtd"
		weight = 4
strings:
...
rule MicrosoftVisualCV80
{
      meta:
		author="malware-lu"
		description = "Packer MicrosoftVisualCV80"
		weight = 4
strings:
...
rule MZ_Crypt10byBrainSt0rm
{
      meta:
		author="malware-lu"
		description = "Packer MZ_Crypt10byBrainSt0rm"
		weight = 4
strings:
...
rule WindofCrypt10byDarkPressure
{
      meta:
		author="malware-lu"
		description = "Packer WindofCrypt10byDarkPressure"
		weight = 4
strings:
...
rule NTKrnlPackerAshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer NTKrnlPackerAshkbizDanehkar"
		weight = 4
strings:
...
rule PseudoSigner01LCCWin321xAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01LCCWin321xAnorganix"
		weight = 4
strings:
...
rule NME11Publicbyredlime
{
      meta:
		author="malware-lu"
		description = "Packer NME11Publicbyredlime"
		weight = 4
strings:
...
rule PECompactv134v140b1
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv134v140b1"
		weight = 4
strings:
...
rule MSLRHv032afakeMSVC70DLLMethod3emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeMSVC70DLLMethod3emadicius"
		weight = 4
strings:
...
rule SoftProtectSoftProtectbyru
{
      meta:
		author="malware-lu"
		description = "Packer SoftProtectSoftProtectbyru"
		weight = 4
strings:
...
rule PseudoSigner02CDCopsIIAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02CDCopsIIAnorganix"
		weight = 4
strings:
...
rule RLPack118LZMA430ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPack118LZMA430ap0x"
		weight = 4
strings:
...
rule ASPackv108xAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv108xAlexeySolodovnikov"
		weight = 4
strings:
...
rule PseudoSigner02BorlandCDLLMethod2Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02BorlandCDLLMethod2Anorganix"
		weight = 4
strings:
...
rule ARMProtector01bySMoKE
{
      meta:
		author="malware-lu"
		description = "Packer ARMProtector01bySMoKE"
		weight = 4
strings:
...
rule tElock099cPrivateECLIPSEtE
{
      meta:
		author="malware-lu"
		description = "Packer tElock099cPrivateECLIPSEtE"
		weight = 4
strings:
...
rule XPack152164
{
      meta:
		author="malware-lu"
		description = "Packer XPack152164"
		weight = 4
strings:
...
rule ASProtectv123RC4build0807dllAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv123RC4build0807dllAlexeySolodovnikov"
		weight = 4
strings:
...
rule Armadillov253b3
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov253b3"
		weight = 4
strings:
...
rule Imploderv104BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer Imploderv104BoBBobSoft"
		weight = 4
strings:
...
rule PEiDBundlev100v101BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PEiDBundlev100v101BoBBobSoft"
		weight = 4
strings:
...
rule JExeCompressor10byArashVeyskarami
{
      meta:
		author="malware-lu"
		description = "Packer JExeCompressor10byArashVeyskarami"
		weight = 4
strings:
...
rule Alloy4xPGWareLLC
{
      meta:
		author="malware-lu"
		description = "Packer Alloy4xPGWareLLC"
		weight = 4
strings:
...
rule ThinstallV2403Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallV2403Jitit"
		weight = 4
strings:
...
rule FakeNinjav28AntiDebugSpirit
{
      meta:
		author="malware-lu"
		description = "Packer FakeNinjav28AntiDebugSpirit"
		weight = 4
strings:
...
rule ExeLockv100
{
      meta:
		author="malware-lu"
		description = "Packer ExeLockv100"
		weight = 4
strings:
...
rule EnigmaProtector10XSukhovVladimir
{
      meta:
		author="malware-lu"
		description = "Packer EnigmaProtector10XSukhovVladimir"
		weight = 4
strings:
...
rule ThinstallEmbedded27172719Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded27172719Jitit"
		weight = 4
strings:
...
rule ASPackv102bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv102bAlexeySolodovnikov"
		weight = 4
strings:
...
rule PEProtect09byCristophGabler1998
{
      meta:
		author="malware-lu"
		description = "Packer PEProtect09byCristophGabler1998"
		weight = 4
strings:
...
rule VxPredator2448
{
      meta:
		author="malware-lu"
		description = "Packer VxPredator2448"
		weight = 4
strings:
...
rule MSLRHv032afakeMSVC60DLLemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeMSVC60DLLemadicius"
		weight = 4
strings:
...
rule Enigmaprotector112VladimirSukhov
{
      meta:
		author="malware-lu"
		description = "Packer Enigmaprotector112VladimirSukhov"
		weight = 4
strings:
...
rule hyingsPEArmorV076hying
{
      meta:
		author="malware-lu"
		description = "Packer hyingsPEArmorV076hying"
		weight = 4
strings:
...
rule JDPackV200JDPack
{
      meta:
		author="malware-lu"
		description = "Packer JDPackV200JDPack"
		weight = 4
strings:
...
rule Upackv01xv02xDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv01xv02xDwing"
		weight = 4
strings:
...
rule VcasmProtectorV1Xvcasm
{
      meta:
		author="malware-lu"
		description = "Packer VcasmProtectorV1Xvcasm"
		weight = 4
strings:
...
rule kkrunchy023alpha2Ryd
{
      meta:
		author="malware-lu"
		description = "Packer kkrunchy023alpha2Ryd"
		weight = 4
strings:
...
rule PolyEnEV001LennartHedlund
{
      meta:
		author="malware-lu"
		description = "Packer PolyEnEV001LennartHedlund"
		weight = 4
strings:
...
rule Winkriptv10
{
      meta:
		author="malware-lu"
		description = "Packer Winkriptv10"
		weight = 4
strings:
...
rule TrainerCreationKitv5Trainer
{
      meta:
		author="malware-lu"
		description = "Packer TrainerCreationKitv5Trainer"
		weight = 4
strings:
...
rule EXEStealthv272
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv272"
		weight = 4
strings:
...
rule EXEStealthv273
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv273"
		weight = 4
strings:
...
rule PseudoSigner02DEF10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02DEF10Anorganix"
		weight = 4
strings:
...
rule EXEStealthv274
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv274"
		weight = 4
strings:
...
rule ThinstallEmbedded22X2308Jitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallEmbedded22X2308Jitit"
		weight = 4
strings:
...
rule PolyCryptorbySMTVersionv3v4
{
      meta:
		author="malware-lu"
		description = "Packer PolyCryptorbySMTVersionv3v4"
		weight = 4
strings:
...
rule ProtectSharewareV11eCompservCMS
{
      meta:
		author="malware-lu"
		description = "Packer ProtectSharewareV11eCompservCMS"
		weight = 4
strings:
...
rule Upackv035alphaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv035alphaDwing"
		weight = 4
strings:
...
rule ASPackv10801AlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv10801AlexeySolodovnikov"
		weight = 4
strings:
...
rule ENIGMAProtectorV11SukhovVladimir
{
      meta:
		author="malware-lu"
		description = "Packer ENIGMAProtectorV11SukhovVladimir"
		weight = 4
strings:
...
rule PEncrypt20junkcode
{
      meta:
		author="malware-lu"
		description = "Packer PEncrypt20junkcode"
		weight = 4
strings:
...
rule SimbiOZExtranger
{
      meta:
		author="malware-lu"
		description = "Packer SimbiOZExtranger"
		weight = 4
strings:
...
rule InnoSetupModulev304betav306v307
{
      meta:
		author="malware-lu"
		description = "Packer InnoSetupModulev304betav306v307"
		weight = 4
strings:
...
rule ASPackv107bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv107bAlexeySolodovnikov"
		weight = 4
strings:
...
rule PROPACKv208emphasisonpackedsizelocked
{
      meta:
		author="malware-lu"
		description = "Packer PROPACKv208emphasisonpackedsizelocked"
		weight = 4
strings:
...
rule HACKSTOPv110p1
{
      meta:
		author="malware-lu"
		description = "Packer HACKSTOPv110p1"
		weight = 4
strings:
...
rule AdysGlue110
{
      meta:
		author="malware-lu"
		description = "Packer AdysGlue110"
		weight = 4
strings:
...
rule VxEddiebased1745
{
      meta:
		author="malware-lu"
		description = "Packer VxEddiebased1745"
		weight = 4
strings:
...
rule ASDPackv10asd
{
      meta:
		author="malware-lu"
		description = "Packer ASDPackv10asd"
		weight = 4
strings:
...
rule ORiENV1XV2XFisunAV
{
      meta:
		author="malware-lu"
		description = "Packer ORiENV1XV2XFisunAV"
		weight = 4
strings:
...
rule StonesPEEncryptorv113
{
      meta:
		author="malware-lu"
		description = "Packer StonesPEEncryptorv113"
		weight = 4
strings:
...
rule WWPACKv302v302aExtractable
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv302v302aExtractable"
		weight = 4
strings:
...
rule ARMProtector03bySMoKE
{
      meta:
		author="malware-lu"
		description = "Packer ARMProtector03bySMoKE"
		weight = 4
strings:
...
rule AntiDote10BetaSISTeam
{
      meta:
		author="malware-lu"
		description = "Packer AntiDote10BetaSISTeam"
		weight = 4
strings:
...
rule DzAPatcherv13Loader
{
      meta:
		author="malware-lu"
		description = "Packer DzAPatcherv13Loader"
		weight = 4
strings:
...
rule CDSSS10beta1CyberDoom
{
      meta:
		author="malware-lu"
		description = "Packer CDSSS10beta1CyberDoom"
		weight = 4
strings:
...
rule y0dasCrypterv10
{
      meta:
		author="malware-lu"
		description = "Packer y0dasCrypterv10"
		weight = 4
strings:
...
rule y0dasCrypterv11
{
      meta:
		author="malware-lu"
		description = "Packer y0dasCrypterv11"
		weight = 4
strings:
...
rule ExeBundlev30smallloader
{
      meta:
		author="malware-lu"
		description = "Packer ExeBundlev30smallloader"
		weight = 4
strings:
...
rule UPXAlternativestub
{
      meta:
		author="malware-lu"
		description = "Packer UPXAlternativestub"
		weight = 4
strings:
...
rule EmbedPE113cyclotron
{
      meta:
		author="malware-lu"
		description = "Packer EmbedPE113cyclotron"
		weight = 4
strings:
...
rule EXECryptor2223protectedIAT
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor2223protectedIAT"
		weight = 4
strings:
...
rule PseudoSigner01Armadillo300Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01Armadillo300Anorganix"
		weight = 4
strings:
...
rule EXECryptorvxxxx
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptorvxxxx"
		weight = 4
strings:
...
rule Morphinev33SilentSoftwareSilentShieldc2005
{
      meta:
		author="malware-lu"
		description = "Packer Morphinev33SilentSoftwareSilentShieldc2005"
		weight = 4
strings:
...
rule DEF10bartxt
{
      meta:
		author="malware-lu"
		description = "Packer DEF10bartxt"
		weight = 4
strings:
...
rule PECompactv0971v0976
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv0971v0976"
		weight = 4
strings:
...
rule PCShrinkv040b
{
      meta:
		author="malware-lu"
		description = "Packer PCShrinkv040b"
		weight = 4
strings:
...
rule MSLRHv032afakePECrypt102emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakePECrypt102emadicius"
		weight = 4
strings:
...
rule ORiENv211212FisunAlexander
{
      meta:
		author="malware-lu"
		description = "Packer ORiENv211212FisunAlexander"
		weight = 4
strings:
...
rule StonesPEEncruptorv113
{
      meta:
		author="malware-lu"
		description = "Packer StonesPEEncruptorv113"
		weight = 4
strings:
...
rule ASProtectv11MTEc
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv11MTEc"
		weight = 4
strings:
...
rule CreateInstallStubvxx
{
      meta:
		author="malware-lu"
		description = "Packer CreateInstallStubvxx"
		weight = 4
strings:
...
rule WinZip32bitSFXv8xmodule
{
      meta:
		author="malware-lu"
		description = "Packer WinZip32bitSFXv8xmodule"
		weight = 4
strings:
...
rule Upxv12MarcusLazlo
{
      meta:
		author="malware-lu"
		description = "Packer Upxv12MarcusLazlo"
		weight = 4
strings:
...
rule PEPACKv10byANAKiN1998
{
      meta:
		author="malware-lu"
		description = "Packer PEPACKv10byANAKiN1998"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakeSpalsher1x3xFEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakeSpalsher1x3xFEUERRADER"
		weight = 4
strings:
...
rule ASPackv10803AlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv10803AlexeySolodovnikov"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 at pe.entry_point or $a1 at pe.entry_point or $a2 at pe.entry_point or $a3 at pe.entry_point
}
...
rule VMProtect07x08PolyTech
{
      meta:
		author="malware-lu"
		description = "Packer VMProtect07x08PolyTech"
		weight = 4
strings:
...
rule ExeShieldProtectorV36wwwexeshieldcom
{
      meta:
		author="malware-lu"
		description = "Packer ExeShieldProtectorV36wwwexeshieldcom"
		weight = 4
strings:
...
rule WerusCrypter10Kas
{
      meta:
		author="malware-lu"
		description = "Packer WerusCrypter10Kas"
		weight = 4
strings:
...
rule Themida10xx1800compressedengineOreansTechnologies
{
      meta:
		author="malware-lu"
		description = "Packer Themida10xx1800compressedengineOreansTechnologies"
		weight = 4
strings:
...
rule CHECKPRGc1992
{
      meta:
		author="malware-lu"
		description = "Packer CHECKPRGc1992"
		weight = 4
strings:
...
rule eXPressor11CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressor11CGSoftLabs"
		weight = 4
strings:
...
rule VxEddie1028
{
      meta:
		author="malware-lu"
		description = "Packer VxEddie1028"
		weight = 4
strings:
...
rule PEQuakev006byfORGAT
{
      meta:
		author="malware-lu"
		description = "Packer PEQuakev006byfORGAT"
		weight = 4
strings:
...
rule tElockv071b7
{
      meta:
		author="malware-lu"
		description = "Packer tElockv071b7"
		weight = 4
strings:
...
rule tElockv071b2
{
      meta:
		author="malware-lu"
		description = "Packer tElockv071b2"
		weight = 4
strings:
...
rule UnknownJoinersignfrompinch260320070212
{
      meta:
		author="malware-lu"
		description = "Packer UnknownJoinersignfrompinch260320070212"
		weight = 4
strings:
...
rule DIETv100v100d
{
      meta:
		author="malware-lu"
		description = "Packer DIETv100v100d"
		weight = 4
strings:
...
rule APEX_CBLTApex40500mhz
{
      meta:
		author="malware-lu"
		description = "Packer APEX_CBLTApex40500mhz"
		weight = 4
strings:
...
rule StealthPEv11
{
      meta:
		author="malware-lu"
		description = "Packer StealthPEv11"
		weight = 4
strings:
...
rule RLPackFullEdition117DLLAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEdition117DLLAp0x"
		weight = 4
strings:
...
rule Anti007V26LiuXingPing
{
      meta:
		author="malware-lu"
		description = "Packer Anti007V26LiuXingPing"
		weight = 4
strings:
...
rule AppEncryptorSilentTeam
{
      meta:
		author="malware-lu"
		description = "Packer AppEncryptorSilentTeam"
		weight = 4
strings:
...
rule VirogenCryptv075
{
      meta:
		author="malware-lu"
		description = "Packer VirogenCryptv075"
		weight = 4
strings:
...
rule Armadillov300a
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov300a"
		weight = 4
strings:
...
rule WWPACKv300v301Extractable
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv300v301Extractable"
		weight = 4
strings:
...
rule PLINK8619841985
{
      meta:
		author="malware-lu"
		description = "Packer PLINK8619841985"
		weight = 4
strings:
...
rule ASPackv10804AlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv10804AlexeySolodovnikov"
		weight = 4
strings:
...
rule BamBamv001Bedrock
{
      meta:
		author="malware-lu"
		description = "Packer BamBamv001Bedrock"
		weight = 4
strings:
...
rule PESHiELDv02v02bv02b2
{
      meta:
		author="malware-lu"
		description = "Packer PESHiELDv02v02bv02b2"
		weight = 4
strings:
...
rule EXEStealthv27
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv27"
		weight = 4
strings:
...
rule EXEStealthv25
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv25"
		weight = 4
strings:
...
rule ASPRStripperv2xunpacked
{
      meta:
		author="malware-lu"
		description = "Packer ASPRStripperv2xunpacked"
		weight = 4
strings:
...
rule PseudoSigner01UPX06Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01UPX06Anorganix"
		weight = 4
strings:
...
rule PESPinv13Cyberbob
{
      meta:
		author="malware-lu"
		description = "Packer PESPinv13Cyberbob"
		weight = 4
strings:
...
rule PECompactv160v165
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv160v165"
		weight = 4
strings:
...
rule eXPressorv120b
{
      meta:
		author="malware-lu"
		description = "Packer eXPressorv120b"
		weight = 4
strings:
...
rule ASProtectv12x
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv12x"
		weight = 4
strings:
...
rule Packanoidv1Arkanoid
{
      meta:
		author="malware-lu"
		description = "Packer Packanoidv1Arkanoid"
		weight = 4
strings:
...
rule EscargotV01Meat
{
      meta:
		author="malware-lu"
		description = "Packer EscargotV01Meat"
		weight = 4
strings:
...
rule EXEStealth275WebtoolMaster
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealth275WebtoolMaster"
		weight = 4
strings:
...
rule PasswordProtectorcMiniSoft1992
{
      meta:
		author="malware-lu"
		description = "Packer PasswordProtectorcMiniSoft1992"
		weight = 4
strings:
...
rule VxEddie2000
{
      meta:
		author="malware-lu"
		description = "Packer VxEddie2000"
		weight = 4
strings:
...
rule VideoLanClientUnknownCompiler
{
      meta:
		author="malware-lu"
		description = "Packer VideoLanClientUnknownCompiler"
		weight = 4
strings:
...
rule eXPressorv14CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressorv14CGSoftLabs"
		weight = 4
strings:
...
rule SkDUndetectablerPro20NoUPXMethodSkD
{
      meta:
		author="malware-lu"
		description = "Packer SkDUndetectablerPro20NoUPXMethodSkD"
		weight = 4
strings:
...
rule RJcrushv100
{
      meta:
		author="malware-lu"
		description = "Packer RJcrushv100"
		weight = 4
strings:
...
rule ExeShieldv27
{
      meta:
		author="malware-lu"
		description = "Packer ExeShieldv27"
		weight = 4
strings:
...
rule ExeShieldv29
{
      meta:
		author="malware-lu"
		description = "Packer ExeShieldv29"
		weight = 4
strings:
...
rule PEiDBundlev102v103BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer PEiDBundlev102v103BoBBobSoft"
		weight = 4
strings:
...
rule FSGv110EngdulekxtMicrosoftVisualC5060
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtMicrosoftVisualC5060"
		weight = 4
strings:
...
rule PUNiSHERV15FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer PUNiSHERV15FEUERRADER"
		weight = 4
strings:
...
rule ExcaliburV103forgot
{
      meta:
		author="malware-lu"
		description = "Packer ExcaliburV103forgot"
		weight = 4
strings:
...
rule RLPack10betaap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPack10betaap0x"
		weight = 4
strings:
...
rule nMacrorecorder10
{
      meta:
		author="malware-lu"
		description = "Packer nMacrorecorder10"
		weight = 4
strings:
...
rule PrivateEXEv20a
{
      meta:
		author="malware-lu"
		description = "Packer PrivateEXEv20a"
		weight = 4
strings:
...
rule PseudoSigner01PEX099Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PEX099Anorganix"
		weight = 4
strings:
...
rule PAKSFXArchive
{
      meta:
		author="malware-lu"
		description = "Packer PAKSFXArchive"
		weight = 4
strings:
...
rule ASPackv2xxAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv2xxAlexeySolodovnikov"
		weight = 4
strings:
...
rule SimbiOZ13Extranger
{
      meta:
		author="malware-lu"
		description = "Packer SimbiOZ13Extranger"
		weight = 4
strings:
...
rule muckisprotectorImucki
{
      meta:
		author="malware-lu"
		description = "Packer muckisprotectorImucki"
		weight = 4
strings:
...
rule Obsidium1339ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1339ObsidiumSoftware"
		weight = 4
strings:
...
rule LOCK98V10028keenvim
{
      meta:
		author="malware-lu"
		description = "Packer LOCK98V10028keenvim"
		weight = 4
strings:
...
rule iPBProtectv013
{
      meta:
		author="malware-lu"
		description = "Packer iPBProtectv013"
		weight = 4
strings:
...
rule PrivateEXEProtector197SetiSoft
{
      meta:
		author="malware-lu"
		description = "Packer PrivateEXEProtector197SetiSoft"
		weight = 4
strings:
...
rule ASPackv21AlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv21AlexeySolodovnikov"
		weight = 4
strings:
...
rule ASPackv103bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv103bAlexeySolodovnikov"
		weight = 4
strings:
...
rule PseudoSigner01PEIntro10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PEIntro10Anorganix"
		weight = 4
strings:
...
rule tElockv099SpecialBuildheXerforgot
{
      meta:
		author="malware-lu"
		description = "Packer tElockv099SpecialBuildheXerforgot"
		weight = 4
strings:
...
rule VxBackfont900
{
      meta:
		author="malware-lu"
		description = "Packer VxBackfont900"
		weight = 4
strings:
...
rule CrunchPEv20xx
{
      meta:
		author="malware-lu"
		description = "Packer CrunchPEv20xx"
		weight = 4
strings:
...
rule SimplePack1XMethod2bagie
{
      meta:
		author="malware-lu"
		description = "Packer SimplePack1XMethod2bagie"
		weight = 4
strings:
...
rule PEncryptv10
{
      meta:
		author="malware-lu"
		description = "Packer PEncryptv10"
		weight = 4
strings:
...
rule FishPEShield112116HellFish
{
      meta:
		author="malware-lu"
		description = "Packer FishPEShield112116HellFish"
		weight = 4
strings:
...
rule CodeCryptv016bv0163b
{
      meta:
		author="malware-lu"
		description = "Packer CodeCryptv016bv0163b"
		weight = 4
strings:
...
rule VOBProtectCD
{
      meta:
		author="malware-lu"
		description = "Packer VOBProtectCD"
		weight = 4
strings:
...
rule diProtectorV1XdiProtectorSoftware
{
      meta:
		author="malware-lu"
		description = "Packer diProtectorV1XdiProtectorSoftware"
		weight = 4
strings:
...
rule PrivateexeProtector20SetiSoftTeam
{
      meta:
		author="malware-lu"
		description = "Packer PrivateexeProtector20SetiSoftTeam"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakekkryptor9kryptoraFEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakekkryptor9kryptoraFEUERRADER"
		weight = 4
strings:
...
rule PEBundlev310
{
      meta:
		author="malware-lu"
		description = "Packer PEBundlev310"
		weight = 4
strings:
...
rule NsPack34NorthStar
{
      meta:
		author="malware-lu"
		description = "Packer NsPack34NorthStar"
		weight = 4
strings:
...
rule PellesC280290EXEX86CRTLIB
{
      meta:
		author="malware-lu"
		description = "Packer PellesC280290EXEX86CRTLIB"
		weight = 4
strings:
...
rule RLPackV115V117Dllap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV115V117Dllap0x"
		weight = 4
strings:
...
rule PellesC28x45xPelleOrinius
{
      meta:
		author="malware-lu"
		description = "Packer PellesC28x45xPelleOrinius"
		weight = 4
strings:
...
rule Thinstallv2460Jitit
{
      meta:
		author="malware-lu"
		description = "Packer Thinstallv2460Jitit"
		weight = 4
strings:
...
rule FSGv110Engdulekxt
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110Engdulekxt"
		weight = 4
strings:
...
rule PECompactv2xx
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv2xx"
		weight = 4
strings:
...
rule ASPackv10802AlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv10802AlexeySolodovnikov"
		weight = 4
strings:
...
rule Armadillo440SiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillo440SiliconRealmsToolworks"
		weight = 4
strings:
...
rule Armadillov1xxv2xx
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov1xxv2xx"
		weight = 4
strings:
...
rule HACKSTOPv111c
{
      meta:
		author="malware-lu"
		description = "Packer HACKSTOPv111c"
		weight = 4
strings:
...
rule EXEStealth276UnregisteredWebtoolMaster
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealth276UnregisteredWebtoolMaster"
		weight = 4
strings:
...
rule PseudoSigner02LCCWin32DLLAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02LCCWin32DLLAnorganix"
		weight = 4
strings:
...
rule CDSSSv10Beta1CyberDoomTeamX
{
      meta:
		author="malware-lu"
		description = "Packer CDSSSv10Beta1CyberDoomTeamX"
		weight = 4
strings:
...
rule tElockv041x
{
      meta:
		author="malware-lu"
		description = "Packer tElockv041x"
		weight = 4
strings:
...
rule ZCodeWin32PEProtectorv101
{
      meta:
		author="malware-lu"
		description = "Packer ZCodeWin32PEProtectorv101"
		weight = 4
strings:
...
rule ABCCryptor10byZloY
{
      meta:
		author="malware-lu"
		description = "Packer ABCCryptor10byZloY"
		weight = 4
strings:
...
rule FSGv120EngdulekxtMicrosoftVisualC60
{
      meta:
		author="malware-lu"
		description = "Packer FSGv120EngdulekxtMicrosoftVisualC60"
		weight = 4
strings:
...
rule SLVc0deProtectorv061SLV
{
      meta:
		author="malware-lu"
		description = "Packer SLVc0deProtectorv061SLV"
		weight = 4
strings:
...
rule FSG131dulekxt
{
      meta:
		author="malware-lu"
		description = "Packer FSG131dulekxt"
		weight = 4
strings:
...
rule RLPackV112V114aPlib043ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV112V114aPlib043ap0x"
		weight = 4
strings:
...
rule Crypter31SLESH
{
      meta:
		author="malware-lu"
		description = "Packer Crypter31SLESH"
		weight = 4
strings:
...
rule PseudoSigner01VBOX43MTEAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01VBOX43MTEAnorganix"
		weight = 4
strings:
...
rule MSLRHv032afakeBJFNT13emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeBJFNT13emadicius"
		weight = 4
strings:
...
rule FreeCryptor02build002GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeCryptor02build002GlOFF"
		weight = 4
strings:
...
rule PackItBitchV10archphase
{
      meta:
		author="malware-lu"
		description = "Packer PackItBitchV10archphase"
		weight = 4
strings:
...
rule nPackv11250BetaNEOx
{
      meta:
		author="malware-lu"
		description = "Packer nPackv11250BetaNEOx"
		weight = 4
strings:
...
rule UnpackedBSSFXArchivev19
{
      meta:
		author="malware-lu"
		description = "Packer UnpackedBSSFXArchivev19"
		weight = 4
strings:
...
rule PseudoSigner01VideoLanClientAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01VideoLanClientAnorganix"
		weight = 4
strings:
...
rule PseudoSigner01PECompact14Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01PECompact14Anorganix"
		weight = 4
strings:
...
rule PseudoSigner01DxPack10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01DxPack10Anorganix"
		weight = 4
strings:
...
rule Splice11byTw1stedL0gic
{
      meta:
		author="malware-lu"
		description = "Packer Splice11byTw1stedL0gic"
		weight = 4
strings:
...
rule PECompactv140v145
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv140v145"
		weight = 4
strings:
...
rule Armadillo300aSiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillo300aSiliconRealmsToolworks"
		weight = 4
strings:
...
rule NullsoftInstallSystemv20b4
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftInstallSystemv20b4"
		weight = 4
strings:
...
rule PESHiELDv01bMTE
{
      meta:
		author="malware-lu"
		description = "Packer PESHiELDv01bMTE"
		weight = 4
strings:
...
rule BeRoEXEPackerV100BeRo
{
      meta:
		author="malware-lu"
		description = "Packer BeRoEXEPackerV100BeRo"
		weight = 4
strings:
...
rule MSLRHv32aemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv32aemadicius"
		weight = 4
strings:
...
rule PECompactv166
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv166"
		weight = 4
strings:
...
rule PECompactv167
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv167"
		weight = 4
strings:
...
rule VIRUSIWormHybris
{
      meta:
		author="malware-lu"
		description = "Packer VIRUSIWormHybris"
		weight = 4
strings:
...
rule GPInstallv50332
{
      meta:
		author="malware-lu"
		description = "Packer GPInstallv50332"
		weight = 4
strings:
...
rule PseudoSigner02PEIntro10Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02PEIntro10Anorganix"
		weight = 4
strings:
...
rule Armadillov410SiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov410SiliconRealmsToolworks"
		weight = 4
strings:
...
rule AverCryptor102betaos1r1s
{
      meta:
		author="malware-lu"
		description = "Packer AverCryptor102betaos1r1s"
		weight = 4
strings:
...
rule HidePE101BGCorp
{
      meta:
		author="malware-lu"
		description = "Packer HidePE101BGCorp"
		weight = 4
strings:
...
rule EXEStealthv11
{
      meta:
		author="malware-lu"
		description = "Packer EXEStealthv11"
		weight = 4
strings:
...
rule Thinstallvxx
{
      meta:
		author="malware-lu"
		description = "Packer Thinstallvxx"
		weight = 4
strings:
...
rule Obsidium1200ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1200ObsidiumSoftware"
		weight = 4
strings:
...
rule PrivatePersonalPackerPPP103ConquestOfTroycom
{
      meta:
		author="malware-lu"
		description = "Packer PrivatePersonalPackerPPP103ConquestOfTroycom"
		weight = 4
strings:
...
rule VIRUSIWormBagle
{
      meta:
		author="malware-lu"
		description = "Packer VIRUSIWormBagle"
		weight = 4
strings:
...
rule RLPackv118BasicLZMAAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackv118BasicLZMAAp0x"
		weight = 4
strings:
...
rule StonesPEEncryptorv20
{
      meta:
		author="malware-lu"
		description = "Packer StonesPEEncryptorv20"
		weight = 4
strings:
...
rule Upackv029betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv029betaDwing"
		weight = 4
strings:
...
rule PseudoSigner02BJFNT11bAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02BJFNT11bAnorganix"
		weight = 4
strings:
...
rule UPXScramblerRCv1x
{
      meta:
		author="malware-lu"
		description = "Packer UPXScramblerRCv1x"
		weight = 4
strings:
...
rule PECrypt15BitShapeSoftware
{
      meta:
		author="malware-lu"
		description = "Packer PECrypt15BitShapeSoftware"
		weight = 4
strings:
...
rule Upackv021BetaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv021BetaDwing"
		weight = 4
strings:
...
rule UPXFreakV01HMX0101
{
      meta:
		author="malware-lu"
		description = "Packer UPXFreakV01HMX0101"
		weight = 4
strings:
...
rule UnnamedScrambler20p0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler20p0ke"
		weight = 4
strings:
...
rule HACKSTOPv100
{
      meta:
		author="malware-lu"
		description = "Packer HACKSTOPv100"
		weight = 4
strings:
...
rule ExeShield36wwwexeshieldcom
{
      meta:
		author="malware-lu"
		description = "Packer ExeShield36wwwexeshieldcom"
		weight = 4
strings:
...
rule Pe123v200644
{
      meta:
		author="malware-lu"
		description = "Packer Pe123v200644"
		weight = 4
strings:
...
rule SDProtectorV11xRandyLi
{
      meta:
		author="malware-lu"
		description = "Packer SDProtectorV11xRandyLi"
		weight = 4
strings:
...
rule BobPackv100BoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer BobPackv100BoBBobSoft"
		weight = 4
strings:
...
rule NsPackv31NorthStar
{
      meta:
		author="malware-lu"
		description = "Packer NsPackv31NorthStar"
		weight = 4
strings:
...
rule SVKProtectorV13XPavolCerven
{
      meta:
		author="malware-lu"
		description = "Packer SVKProtectorV13XPavolCerven"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakePECrypt102FEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakePECrypt102FEUERRADER"
		weight = 4
strings:
...
rule PseudoSigner02WATCOMCCEXEAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02WATCOMCCEXEAnorganix"
		weight = 4
strings:
...
rule UpackV036Dwing
{
      meta:
		author="malware-lu"
		description = "Packer UpackV036Dwing"
		weight = 4
strings:
...
rule VxVCLencrypted
{
      meta:
		author="malware-lu"
		description = "Packer VxVCLencrypted"
		weight = 4
strings:
...
rule RLPackv118BasicDLLaPLibAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackv118BasicDLLaPLibAp0x"
		weight = 4
strings:
...
rule PellesC290300400DLLX86CRTLIB
{
      meta:
		author="malware-lu"
		description = "Packer PellesC290300400DLLX86CRTLIB"
		weight = 4
strings:
...
rule UnnamedScrambler13Bp0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler13Bp0ke"
		weight = 4
strings:
...
rule HyingsPEArmor075exeHyingCCG
{
      meta:
		author="malware-lu"
		description = "Packer HyingsPEArmor075exeHyingCCG"
		weight = 4
strings:
...
rule SimbiOZPolyCryptorvxxExtranger
{
      meta:
		author="malware-lu"
		description = "Packer SimbiOZPolyCryptorvxxExtranger"
		weight = 4
strings:
...
rule Armadillov220
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov220"
		weight = 4
strings:
...
rule NullsoftInstallSystemv1xx
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftInstallSystemv1xx"
		weight = 4
strings:
...
rule BobSoftMiniDelphiBoBBobSoft
{
      meta:
		author="malware-lu"
		description = "Packer BobSoftMiniDelphiBoBBobSoft"
		weight = 4
strings:
...
rule UltraProV10SafeNet
{
      meta:
		author="malware-lu"
		description = "Packer UltraProV10SafeNet"
		weight = 4
strings:
...
rule PECompactv1242v1243
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv1242v1243"
		weight = 4
strings:
...
rule SimplePack121build0909Method2bagie
{
      meta:
		author="malware-lu"
		description = "Packer SimplePack121build0909Method2bagie"
		weight = 4
strings:
...
rule Obsidium13037ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium13037ObsidiumSoftware"
		weight = 4
strings:
...
rule VxPhoenix927
{
      meta:
		author="malware-lu"
		description = "Packer VxPhoenix927"
		weight = 4
strings:
...
rule Petite14c199899IanLuck
{
      meta:
		author="malware-lu"
		description = "Packer Petite14c199899IanLuck"
		weight = 4
strings:
...
rule eXPressorV10CGSoftLabs
{
      meta:
		author="malware-lu"
		description = "Packer eXPressorV10CGSoftLabs"
		weight = 4
strings:
...
rule RECryptv07xCruddRETh2
{
      meta:
		author="malware-lu"
		description = "Packer RECryptv07xCruddRETh2"
		weight = 4
strings:
...
rule RECryptv07xCruddRETh1
{
      meta:
		author="malware-lu"
		description = "Packer RECryptv07xCruddRETh1"
		weight = 4
strings:
...
rule WIBUKeyV410Ahttpwibucomus
{
      meta:
		author="malware-lu"
		description = "Packer WIBUKeyV410Ahttpwibucomus"
		weight = 4
strings:
...
rule Mew501NorthFoxHCC
{
      meta:
		author="malware-lu"
		description = "Packer Mew501NorthFoxHCC"
		weight = 4
strings:
...
rule PseudoSigner01ExeSmasherAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01ExeSmasherAnorganix"
		weight = 4
strings:
...
rule UnnamedScrambler12C12Dp0ke
{
      meta:
		author="malware-lu"
		description = "Packer UnnamedScrambler12C12Dp0ke"
		weight = 4
strings:
...
rule AlexProtectorv04beta1byAlex
{
      meta:
		author="malware-lu"
		description = "Packer AlexProtectorv04beta1byAlex"
		weight = 4
strings:
...
rule UG2002Cruncherv03b3
{
      meta:
		author="malware-lu"
		description = "Packer UG2002Cruncherv03b3"
		weight = 4
strings:
...
rule FishPEShield101HellFish
{
      meta:
		author="malware-lu"
		description = "Packer FishPEShield101HellFish"
		weight = 4
strings:
...
rule PseudoSigner01Neolite20Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01Neolite20Anorganix"
		weight = 4
strings:
...
rule Obsidiumv1250ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidiumv1250ObsidiumSoftware"
		weight = 4
strings:
...
rule DevC4992BloodshedSoftware
{
      meta:
		author="malware-lu"
		description = "Packer DevC4992BloodshedSoftware"
		weight = 4
strings:
...
rule RLPackV119DllLZMA430ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackV119DllLZMA430ap0x"
		weight = 4
strings:
...
rule XJXPALLiNSoN
{
      meta:
		author="malware-lu"
		description = "Packer XJXPALLiNSoN"
		weight = 4
strings:
...
rule Armadillov220b1
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov220b1"
		weight = 4
strings:
...
rule RCryptor20Vaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptor20Vaska"
		weight = 4
strings:
...
rule SentinelSuperProAutomaticProtectionv641Safenet
{
      meta:
		author="malware-lu"
		description = "Packer SentinelSuperProAutomaticProtectionv641Safenet"
		weight = 4
strings:
...
rule TMTPascalv040
{
      meta:
		author="malware-lu"
		description = "Packer TMTPascalv040"
		weight = 4
strings:
...
rule PseudoSigner02CrunchPEHeuristicAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02CrunchPEHeuristicAnorganix"
		weight = 4
strings:
...
rule MSLRHv032afakeMSVCDLLMethod4emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeMSVCDLLMethod4emadicius"
		weight = 4
strings:
...
rule VcAsmProtectorV10XVcAsm
{
      meta:
		author="malware-lu"
		description = "Packer VcAsmProtectorV10XVcAsm"
		weight = 4
strings:
...
rule MSLRHv032afakeUPX0896102105124emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeUPX0896102105124emadicius"
		weight = 4
strings:
...
rule FSGv110EngdulekxtBorlandDelphiMicrosoftVisualC
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtBorlandDelphiMicrosoftVisualC"
		weight = 4
strings:
...
rule RLPackFullEdition117LZMAAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEdition117LZMAAp0x"
		weight = 4
strings:
...
rule PseudoSigner01LTC13Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01LTC13Anorganix"
		weight = 4
strings:
...
rule ACProtectv141
{
      meta:
		author="malware-lu"
		description = "Packer ACProtectv141"
		weight = 4
strings:
...
rule yodasProtectorV1031AshkbizDanehkar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtectorV1031AshkbizDanehkar"
		weight = 4
strings:
...
rule tElock096tE
{
      meta:
		author="malware-lu"
		description = "Packer tElock096tE"
		weight = 4
strings:
...
rule WerusCrypter10byKas
{
      meta:
		author="malware-lu"
		description = "Packer WerusCrypter10byKas"
		weight = 4
strings:
...
rule HEALTHv51byMuslimMPolyak
{
      meta:
		author="malware-lu"
		description = "Packer HEALTHv51byMuslimMPolyak"
		weight = 4
strings:
...
rule PCGuardv303dv305d
{
      meta:
		author="malware-lu"
		description = "Packer PCGuardv303dv305d"
		weight = 4
strings:
...
rule VxNovember17768
{
      meta:
		author="malware-lu"
		description = "Packer VxNovember17768"
		weight = 4
strings:
...
rule BeRoTinyPascalBeRo
{
      meta:
		author="malware-lu"
		description = "Packer BeRoTinyPascalBeRo"
		weight = 4
strings:
...
rule PrivateexeProtector21522XSetiSoftTeam
{
      meta:
		author="malware-lu"
		description = "Packer PrivateexeProtector21522XSetiSoftTeam"
		weight = 4
strings:
...
rule Protectorv1111DDeMPEEnginev09DDeMCIv092
{
      meta:
		author="malware-lu"
		description = "Packer Protectorv1111DDeMPEEnginev09DDeMCIv092"
		weight = 4
strings:
...
rule PseudoSigner01XCR011Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01XCR011Anorganix"
		weight = 4
strings:
...
rule Trivial173bySMTSMF
{
      meta:
		author="malware-lu"
		description = "Packer Trivial173bySMTSMF"
		weight = 4
strings:
...
rule ASProtectv11MTE
{
      meta:
		author="malware-lu"
		description = "Packer ASProtectv11MTE"
		weight = 4
strings:
...
rule WARNINGTROJANRobinPE
{
      meta:
		author="malware-lu"
		description = "Packer WARNINGTROJANRobinPE"
		weight = 4
strings:
...
rule PiCryptor10byScofield
{
      meta:
		author="malware-lu"
		description = "Packer PiCryptor10byScofield"
		weight = 4
strings:
...
condition:
		check_packer_bool and $a0 or $a1 at pe.entry_point or $a2
}
...
rule PseudoSigner02MacromediaFlashProjector60Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02MacromediaFlashProjector60Anorganix"
		weight = 4
strings:
...
rule MSLRHv032afakeWWPack321xemadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeWWPack321xemadicius"
		weight = 4
strings:
...
rule PEArmor07600765hying
{
      meta:
		author="malware-lu"
		description = "Packer PEArmor07600765hying"
		weight = 4
strings:
...
rule PECryptv102
{
      meta:
		author="malware-lu"
		description = "Packer PECryptv102"
		weight = 4
strings:
...
rule ILUCRYPTv4015exe
{
      meta:
		author="malware-lu"
		description = "Packer ILUCRYPTv4015exe"
		weight = 4
strings:
...
rule CodeLockvxx
{
      meta:
		author="malware-lu"
		description = "Packer CodeLockvxx"
		weight = 4
strings:
...
rule CipherWallSelfExtratorDecryptorGUIv15
{
      meta:
		author="malware-lu"
		description = "Packer CipherWallSelfExtratorDecryptorGUIv15"
		weight = 4
strings:
...
rule ARMProtectorv01bySMoKE
{
      meta:
		author="malware-lu"
		description = "Packer ARMProtectorv01bySMoKE"
		weight = 4
strings:
...
rule Upackv037betaDwing
{
      meta:
		author="malware-lu"
		description = "Packer Upackv037betaDwing"
		weight = 4
strings:
...
rule PrivateExeProtector1xsetisoft
{
      meta:
		author="malware-lu"
		description = "Packer PrivateExeProtector1xsetisoft"
		weight = 4
strings:
...
rule NullsoftInstallSystemv20a0
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftInstallSystemv20a0"
		weight = 4
strings:
...
rule Obsidium1332ObsidiumSoftware
{
      meta:
		author="malware-lu"
		description = "Packer Obsidium1332ObsidiumSoftware"
		weight = 4
strings:
...
rule modifiedHACKSTOPv111f
{
      meta:
		author="malware-lu"
		description = "Packer modifiedHACKSTOPv111f"
		weight = 4
strings:
...
rule VxCIHVersion12TTITWIN95CIH
{
      meta:
		author="malware-lu"
		description = "Packer VxCIHVersion12TTITWIN95CIH"
		weight = 4
strings:
...
rule ShegerdDongleV478MSCo
{
      meta:
		author="malware-lu"
		description = "Packer ShegerdDongleV478MSCo"
		weight = 4
strings:
...
rule SDProtectRandyLi
{
      meta:
		author="malware-lu"
		description = "Packer SDProtectRandyLi"
		weight = 4
strings:
...
rule SmokesCryptv12
{
      meta:
		author="malware-lu"
		description = "Packer SmokesCryptv12"
		weight = 4
strings:
...
rule PEncryptv31
{
      meta:
		author="malware-lu"
		description = "Packer PEncryptv31"
		weight = 4
strings:
		$a0 = { E9 [3] 00 F0 0F C6 }
...
rule PEncryptv30
{
      meta:
		author="malware-lu"
		description = "Packer PEncryptv30"
		weight = 4
strings:
...
rule RJoiner12byVaska250320071658
{
      meta:
		author="malware-lu"
		description = "Packer RJoiner12byVaska250320071658"
		weight = 4
strings:
...
rule Minke101byCodius
{
      meta:
		author="malware-lu"
		description = "Packer Minke101byCodius"
		weight = 4
strings:
...
rule CrypWrapvxx
{
      meta:
		author="malware-lu"
		description = "Packer CrypWrapvxx"
		weight = 4
strings:
...
rule WarningmaybeSimbyOZpolycryptorby3xpl01tver2xx250320072200
{
      meta:
		author="malware-lu"
		description = "Packer WarningmaybeSimbyOZpolycryptorby3xpl01tver2xx250320072200"
		weight = 4
strings:
...
rule WARNINGTROJANHuiGeZi
{
      meta:
		author="malware-lu"
		description = "Packer WARNINGTROJANHuiGeZi"
		weight = 4
strings:
...
rule MSLRHv032afakeyodascryptor12emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeyodascryptor12emadicius"
		weight = 4
strings:
...
rule D1S1Gv11betaD1N
{
      meta:
		author="malware-lu"
		description = "Packer D1S1Gv11betaD1N"
		weight = 4
strings:
...
rule PROPACKv208
{
      meta:
		author="malware-lu"
		description = "Packer PROPACKv208"
		weight = 4
strings:
...
rule BlackEnergyDDoSBotCrypter
{
      meta:
		author="malware-lu"
		description = "Packer BlackEnergyDDoSBotCrypter"
		weight = 4
strings:
...
rule HACKSTOPv113
{
      meta:
		author="malware-lu"
		description = "Packer HACKSTOPv113"
		weight = 4
strings:
...
rule FreeJoiner151GlOFF
{
      meta:
		author="malware-lu"
		description = "Packer FreeJoiner151GlOFF"
		weight = 4
strings:
...
rule PeXv099EngbartCrackPl
{
      meta:
		author="malware-lu"
		description = "Packer PeXv099EngbartCrackPl"
		weight = 4
strings:
...
rule HACKSTOPv119
{
      meta:
		author="malware-lu"
		description = "Packer HACKSTOPv119"
		weight = 4
strings:
...
rule HACKSTOPv118
{
      meta:
		author="malware-lu"
		description = "Packer HACKSTOPv118"
		weight = 4
strings:
...
rule PKLITEv200b
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv200b"
		weight = 4
strings:
...
rule PKLITEv200c
{
      meta:
		author="malware-lu"
		description = "Packer PKLITEv200c"
		weight = 4
strings:
...
rule MSLRHv032afakeNeolite20emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv032afakeNeolite20emadicius"
		weight = 4
strings:
...
rule WWPACKv300v301Relocationspack
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv300v301Relocationspack"
		weight = 4
strings:
...
rule PseudoSigner02CodeSafe20Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02CodeSafe20Anorganix"
		weight = 4
strings:
...
rule PseudoSigner02ZCode101Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner02ZCode101Anorganix"
		weight = 4
strings:
...
rule ZealPack10Zeal
{
      meta:
		author="malware-lu"
		description = "Packer ZealPack10Zeal"
		weight = 4
strings:
...
rule RLPackFullEdition117iBoxLZMAAp0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEdition117iBoxLZMAAp0x"
		weight = 4
strings:
...
rule INCrypter03INinYbyz3e_NiFe
{
      meta:
		author="malware-lu"
		description = "Packer INCrypter03INinYbyz3e_NiFe"
		weight = 4
strings:
...
rule nBinderv361
{
      meta:
		author="malware-lu"
		description = "Packer nBinderv361"
		weight = 4
strings:
...
rule MatrixDongleTDiGmbH
{
      meta:
		author="malware-lu"
		description = "Packer MatrixDongleTDiGmbH"
		weight = 4
strings:
...
rule NullsoftInstallSystemv20RC2
{
      meta:
		author="malware-lu"
		description = "Packer NullsoftInstallSystemv20RC2"
		weight = 4
strings:
...
rule UnoPiX075BaGiE
{
      meta:
		author="malware-lu"
		description = "Packer UnoPiX075BaGiE"
		weight = 4
strings:
...
rule WWPACKv305c4UnextractablePasswordchecking
{
      meta:
		author="malware-lu"
		description = "Packer WWPACKv305c4UnextractablePasswordchecking"
		weight = 4
strings:
...
rule FSGv110EngdulekxtBorlandDelphi20
{
      meta:
		author="malware-lu"
		description = "Packer FSGv110EngdulekxtBorlandDelphi20"
		weight = 4
strings:
...
rule Reg2Exe225byJanVorel
{
      meta:
		author="malware-lu"
		description = "Packer Reg2Exe225byJanVorel"
		weight = 4
strings:
...
rule Armadillov420SiliconRealmsToolworks
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov420SiliconRealmsToolworks"
		weight = 4
strings:
...
rule DalKrypt10byDalKiT
{
      meta:
		author="malware-lu"
		description = "Packer DalKrypt10byDalKiT"
		weight = 4
strings:
...
rule RCryptorv15Vaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv15Vaska"
		weight = 4
strings:
...
rule EXECryptor239compressedresources
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor239compressedresources"
		weight = 4
strings:
...
rule GameGuardv20065xxexesignbyhot_UNP
{
      meta:
		author="malware-lu"
		description = "Packer GameGuardv20065xxexesignbyhot_UNP"
		weight = 4
strings:
...
rule EnigmaProtectorv112LITE
{
      meta:
		author="malware-lu"
		description = "Packer EnigmaProtectorv112LITE"
		weight = 4
strings:
...
rule MSLRHv01emadicius
{
      meta:
		author="malware-lu"
		description = "Packer MSLRHv01emadicius"
		weight = 4
strings:
...
rule Apex_cbeta500mhz
{
      meta:
		author="malware-lu"
		description = "Packer Apex_cbeta500mhz"
		weight = 4
strings:
...
rule VProtector11A12vcasm
{
      meta:
		author="malware-lu"
		description = "Packer VProtector11A12vcasm"
		weight = 4
strings:
...
rule codeCrypter031
{
      meta:
		author="malware-lu"
		description = "Packer codeCrypter031"
		weight = 4
strings:
...
rule PKTINYv10withTINYPROGv38
{
      meta:
		author="malware-lu"
		description = "Packer PKTINYv10withTINYPROGv38"
		weight = 4
strings:
...
rule AHTeamEPProtector03fakePESHiELD2xFEUERRADER
{
      meta:
		author="malware-lu"
		description = "Packer AHTeamEPProtector03fakePESHiELD2xFEUERRADER"
		weight = 4
strings:
...
rule RLPackFullEditionV11Xap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPackFullEditionV11Xap0x"
		weight = 4
strings:
...
rule Excalibur103forgot
{
      meta:
		author="malware-lu"
		description = "Packer Excalibur103forgot"
		weight = 4
strings:
...
rule RLPack118DllaPlib043ap0x
{
      meta:
		author="malware-lu"
		description = "Packer RLPack118DllaPlib043ap0x"
		weight = 4
strings:
...
rule PseudoSigner01MicrosoftVisualC50MFCAnorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01MicrosoftVisualC50MFCAnorganix"
		weight = 4
strings:
...
rule Pohernah101byKas
{
      meta:
		author="malware-lu"
		description = "Packer Pohernah101byKas"
		weight = 4
strings:
...
rule Armadillov25xv26x
{
      meta:
		author="malware-lu"
		description = "Packer Armadillov25xv26x"
		weight = 4
strings:
...
rule Escargot01byueMeat
{
      meta:
		author="malware-lu"
		description = "Packer Escargot01byueMeat"
		weight = 4
strings:
...
rule EncryptPE2200461622006630WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPE2200461622006630WFS"
		weight = 4
strings:
...
rule PseudoSigner01BorlandDelphi30Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01BorlandDelphi30Anorganix"
		weight = 4
strings:
...
rule ActiveMARKTMR5311140Trymedia
{
      meta:
		author="malware-lu"
		description = "Packer ActiveMARKTMR5311140Trymedia"
		weight = 4
strings:
...
rule PEBundlev244
{
      meta:
		author="malware-lu"
		description = "Packer PEBundlev244"
		weight = 4
strings:
...
rule PECompactv120v1201
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv120v1201"
		weight = 4
strings:
...
rule ASPackv104bAlexeySolodovnikov
{
      meta:
		author="malware-lu"
		description = "Packer ASPackv104bAlexeySolodovnikov"
		weight = 4
strings:
...
rule RCryptorv13v14Vaska
{
      meta:
		author="malware-lu"
		description = "Packer RCryptorv13v14Vaska"
		weight = 4
strings:
...
rule ThinstallV27XJitit
{
      meta:
		author="malware-lu"
		description = "Packer ThinstallV27XJitit"
		weight = 4
strings:
...
rule eXPressor120BetaPEPacker
{
      meta:
		author="malware-lu"
		description = "Packer eXPressor120BetaPEPacker"
		weight = 4
strings:
...
rule Packanoid10ackanoid
{
      meta:
		author="malware-lu"
		description = "Packer Packanoid10ackanoid"
		weight = 4
strings:
...
rule EncryptPE1200331812003518WFS
{
      meta:
		author="malware-lu"
		description = "Packer EncryptPE1200331812003518WFS"
		weight = 4
strings:
...
rule PECompactv09781
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv09781"
		weight = 4
strings:
...
rule PECompactv09782
{
      meta:
		author="malware-lu"
		description = "Packer PECompactv09782"
		weight = 4
strings:
...
rule PseudoSigner01Gleam100Anorganix
{
      meta:
		author="malware-lu"
		description = "Packer PseudoSigner01Gleam100Anorganix"
		weight = 4
strings:
...
rule UPackAltStubDwing
{
      meta:
		author="malware-lu"
		description = "Packer UPackAltStubDwing"
		weight = 4
strings:
...
rule VxModificationofHi924
{
      meta:
		author="malware-lu"
		description = "Packer VxModificationofHi924"
		weight = 4
strings:
...
rule EXECryptor226DLLminimumprotection
{
      meta:
		author="malware-lu"
		description = "Packer EXECryptor226DLLminimumprotection"
		weight = 4
strings:
...
rule yodasProtector102AshkibizDanehlar
{
      meta:
		author="malware-lu"
		description = "Packer yodasProtector102AshkibizDanehlar"
		weight = 4
strings:
...
rule ACProtectv135riscosoftwareIncAnticrackSoftware
{
      meta:
		author="malware-lu"
		description = "Packer ACProtectv135riscosoftwareIncAnticrackSoftware"
		weight = 4
strings:
...
rule upx_0_80_to_1_24 : Packer
{
	...
	condition:
		check_packer_bool and $str1 at pe.entry_point
}
...
rule winrar_sfx : Packer
{
	...
	condition:
		check_packer_bool and $signature1
}
...
rule mpress_2_xx_x86 : Packer
{
	...
	condition:
		check_packer_bool and $signature1 at pe.entry_point
}
...
rule rpx_1_xx : Packer
{
	...
	condition:
		check_packer_bool and $signature1 and $signature2
}
