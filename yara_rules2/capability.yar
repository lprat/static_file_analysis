...
rule inject_thread {
    ...
    strings:
        ...
        $c7 = "OpenProcess"
    condition:
        check_cap_bool and $c1 and $c2 and ( $c3 or $c4 ) and ( $c5 or $c6 or $c7 )
}
...
rule create_process {
    ...
    strings:
        ...
        $c4 = "CreateThread"
    condition:
        check_cap_bool and ($f1 and $c1 ) or $f2 and ($c2 or $c3 or $c4)
}
...
rule persistence {
    ...
    condition:
        check_cap_bool and any of them
}
...
rule create_service {
    ...
    condition:
        check_cap_bool and all of them
}
...
rule network_udp_sock {
	...
	$f2 = "System.Net" nocase
        ...
        $c5 = "UdpClient"
    condition:
        check_cap_bool and (($f1 or $f3) and 2 of ($c*)) or ($f2 and $c5)
}
...
rule network_tcp_listen {
    ...
    strings:
        ...
        $c10 = "listen"
    condition:
        check_cap_bool and 1 of ($f*) and 2 of ($c*)
}
...
rule network_http {
    ...
    strings:
        ...
        $c8 = "IdHTTPHeaderInfo"
    condition:
        check_cap_bool and $f1 and $c1 and ($c2 or $c3) and ($c4 or $c5 or $c6 or $c7 or $c8)
}
...
rule network_dropper {
    ...
    condition:
        check_cap_bool and $f1 and 1 of ($c*)
}
...
rule network_ftp {
    ...
    strings:
        ...
        $c13 = "FtpGetDirectory"
    condition:
        check_cap_bool and $f1 and (4 of ($c*))
}
...
rule network_dns {
    ...
    strings:
	    ...
	    $c6 = "DnsQuery"
    condition:
        check_cap_bool and 1 of ($f*) and  1 of ($c*)
}
...
rule network_dga {
    ...
    strings:
        ...
        $net4 = "getaddrinfo"
    condition:
        check_cap_bool and all of ($dll*) and 1 of ($time*) and 1 of ($hash*) and 1 of ($net*)
}
...
rule bitcoin {
    ...
    strings:
	    ...
	    $s5 = "stratum" nocase
    condition:
        check_cap_bool and 1 of ($f*) and 1 of ($s*)
}
...
rule escalate_priv {
    ...
    condition:
        check_cap_bool and 1 of ($d*) and 1 of ($c*)
}
...
rule sniff_audio {
    ...
    strings:
        ...
        $c5 = "waveInClose"
    condition:
        check_cap_bool and $f1 and 2 of ($c*)
}
...
rule win_files_operation {
    ...
    condition:
        check_cap_bool and $f1 and 3 of ($c*)
}
...
rule Str_Win32_Winsock2_Library
{
    ...
    condition:
        check_cap_bool and (any of ($ws2_lib, $wsock2_lib))
}
...
rule Str_Win32_Wininet_Library
{
    ...
    condition:
        check_cap_bool and (all of ($wininet*))
}
...
rule Str_Win32_Internet_API
{
    ...
    condition:
        check_cap_bool and (any of ($wininet_call*))
}
...
rule Str_Win32_Http_API
{
    ...
    strings:
     ...
     condition:
        check_cap_bool and (any of ($wininet_call_http*))
}
